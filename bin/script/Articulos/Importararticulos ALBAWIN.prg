   ...
   while ::nFilaInicioImportacion < 1995
      ...
      if ( ::filaValida() )
         ...
         if !Empty( ::getCodigoArticulo() )
            ...
            MsgWait( "Artículo: " + AllTrim( ::getExcelString( "C" ) ), "Procesando" , 1 )
...
METHOD importarArticulo()
   ...
   do case
      case ::getExcelNumeric( "E" ) == 21
         ( D():Articulos( ::nView ) )->TIPOIVA           := "G"
      case ::getExcelNumeric( "E" ) == 10
   ...
   */
   ...
   if !Empty( ::getExcelString( "B" ) )
      ...
      ( D():ArticulosCodigosBarras( ::nView ) )->cCodArt           := ::getCodigoArticulo()
      ( D():ArticulosCodigosBarras( ::nView ) )->cCodBar           := ::getExcelString( "B" )
