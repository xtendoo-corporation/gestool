...
METHOD procesaFicheroExcel()
   ...
   while ( ::filaValida() )
      ...
      if !Empty( ::getCodigoArticulo() )
         ...
         MsgWait( "Artículo: " + AllTrim( ::getCodigoArticulo() ) + " - " + ::getExcelString( "C" ), "Procesando" , 0.2 )

         if !( D():ArticulosCodigosBarras( ::nView ) )->( dbSeek( ::getCodigoArticulo() ) ) .and.;
            !ArticulosModel():exist( ::getCodigoArticulo() )
