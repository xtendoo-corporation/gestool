...
*/
   ...
   DATA hVendedores                             INIT  {  { "Delegacion" => "02", "Vendedor" => "027", "CodigoVendedor" => "V1", "NombreVendedor" => "CARLOS CONDE",                 "IdCliente" => "C1" },;
                                                         ...
                                                         { "Delegacion" => "36", "Vendedor" => "035", "CodigoVendedor" => "V4", "NombreVendedor" => "ENRIQUE FERNANDEZ ZOYO",       "IdCliente" => "C3" },;
							                                    { "Delegacion" => "M3", "Vendedor" => "035", "CodigoVendedor" => "V4", "NombreVendedor" => "ENRIQUE FERNANDEZ ZOYO",       "IdCliente" => "C3" },;					
                                                         ...
                                                         { "Delegacion" => "00", "Vendedor" => "003", "CodigoVendedor" => "V9", "NombreVendedor" => "ZAMUDIO",                      "IdCliente" => "GE" },;
                                                         ...
                                                         { "Delegacion" => "05", "Vendedor" => "005", "CodigoVendedor" => "V50", "NombreVendedor" => "JUAN",                        "IdCliente" => "GE" },;
                                                         ...
                                                         { "Delegacion" => "51", "Vendedor" => "051", "CodigoVendedor" => "V23","NombreVendedor" => "ADRIAN ORELLANA",              "IdCliente" => "C17" },;
							                                    { "Delegacion" => "50", "Vendedor" => "051", "CodigoVendedor" => "V23","NombreVendedor" => "ADRIAN ORELLANA",              "IdCliente" => "C17" },;
...
METHOD deleteInvoiceByReference()
   ...
   if D():seekInOrd( D():FacturasClientes( ::nView ), ::calculateInvoice, "cNumPed" )
