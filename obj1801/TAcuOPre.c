 ...
 * Generated C source from ".\.\Prg\TAcuOPre.prg"
 */
...
HB_FUNC_STATIC( TACUOPRE_CREATE );
HB_FUNC_STATIC( TACUOPRE_OPENFILES );
HB_FUNC_STATIC( TACUOPRE_CLOSEFILES );
HB_FUNC_STATIC( TACUOPRE_LRESOURCE );
HB_FUNC_STATIC( TACUOPRE_LGENERATE );
...
HB_INIT_SYMBOLS_BEGIN( hb_vm_SymbolInit_TACUOPRE )
{ "TACUOPRE", {HB_FS_PUBLIC | HB_FS_FIRST | HB_FS_LOCAL}, {HB_FUNCNAME( TACUOPRE )}, NULL },
...
{ "TACUOPRE_CREATE", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TACUOPRE_CREATE )}, NULL },
{ "TACUOPRE_OPENFILES", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TACUOPRE_OPENFILES )}, NULL },
{ "TACUOPRE_CLOSEFILES", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TACUOPRE_CLOSEFILES )}, NULL },
{ "TACUOPRE_LRESOURCE", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TACUOPRE_LRESOURCE )}, NULL },
{ "TACUOPRE_LGENERATE", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TACUOPRE_LGENERATE )}, NULL },
...
HB_INIT_SYMBOLS_EX_END( hb_vm_SymbolInit_TACUOPRE, ".\\.\\Prg\\TAcuOPre.prg", 0x0, 0x0003 )

#if defined( HB_PRAGMA_STARTUP )
   #pragma startup hb_vm_SymbolInit_TACUOPRE
#elif defined( HB_DATASEG_STARTUP )
   #define HB_DATASEG_BODY    HB_DATASEG_FUNC( hb_vm_SymbolInit_TACUOPRE )
   #include "hbiniseg.h"
#endif
...
HB_FUNC( TACUOPRE )
{
	static const HB_BYTE pcode[] =
	{
		...
		0,106,9,84,65,99,117,79,80,114,101,0,108,4,
...
HB_FUNC_STATIC( TACUOPRE_LGENERATE )
{
	static const HB_BYTE pcode[] =
	{
		...
		22,0,95,1,112,0,106,8,100,70,101,99,80,114,
		101,0,112,1,73,36,131,0,48,63,0,48,30,0,
		95,1,112,0,106,8,110,78,117,109,80,114,101,0,
		112,1,73,36,133,0,106,19,100,70,101,99,80,114,
		...
		0,95,1,112,0,73,36,188,0,48,50,0,48,49,
