...
HB_FUNC_STATIC( TCOMENTARIOS_DELRECCOMENTARIO )
{
	static const HB_BYTE pcode[] =
	{
		...
		83,0,176,84,0,12,0,48,85,0,176,86,0,12,
		0,112,0,112,1,31,81,176,87,0,106,49,191,32,
		...
		28,22,36,32,1,48,88,0,48,64,0,48,32,0,
		102,112,0,112,0,112,0,73,36,35,1,48,89,0,
		95,1,112,0,73,36,37,1,102,110,7
	};
...
HB_FUNC_STATIC( TCOMENTARIOS_REINDEXA )
{
	static const HB_BYTE pcode[] =
	{
		...
		0,112,1,73,36,51,1,48,90,0,48,25,0,102,
		112,0,112,0,73,36,53,1,48,91,0,102,120,112,
		1,28,17,36,54,1,48,92,0,48,25,0,102,112,
