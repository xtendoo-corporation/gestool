 ...
 * Generated C source from ".\.\Prg\TGenMailDatabaseRecibosClientes.prg"
 */
...
HB_FUNC( TGENMAILINGDATABASERECIBOSCLIENTES );
HB_FUNC_EXTERN( __CLSLOCKDEF );
HB_FUNC_EXTERN( HBCLASS );
HB_FUNC_EXTERN( TGENMAILINGDATABASE );
HB_FUNC_STATIC( TGENMAILINGDATABASERECIBOSCLIENTES_NEW );
HB_FUNC_EXTERN( MAILREPORTRECCLI );
...
HB_INIT_SYMBOLS_BEGIN( hb_vm_SymbolInit_TGENMAILDATABASERECIBOSCLIENTES )
{ "TGENMAILINGDATABASERECIBOSCLIENTES", {HB_FS_PUBLIC | HB_FS_FIRST | HB_FS_LOCAL}, {HB_FUNCNAME( TGENMAILINGDATABASERECIBOSCLIENTES )}, NULL },
{ "__CLSLOCKDEF", {HB_FS_PUBLIC}, {HB_FUNCNAME( __CLSLOCKDEF )}, NULL },
{ "NEW", {HB_FS_PUBLIC | HB_FS_MESSAGE}, {NULL}, NULL },
{ "HBCLASS", {HB_FS_PUBLIC}, {HB_FUNCNAME( HBCLASS )}, NULL },
{ "TGENMAILINGDATABASE", {HB_FS_PUBLIC}, {HB_FUNCNAME( TGENMAILINGDATABASE )}, NULL },
{ "ADDMETHOD", {HB_FS_PUBLIC | HB_FS_MESSAGE}, {NULL}, NULL },
{ "TGENMAILINGDATABASERECIBOSCLIENTES_NEW", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TGENMAILINGDATABASERECIBOSCLIENTES_NEW )}, NULL },
{ "ADDINLINE", {HB_FS_PUBLIC | HB_FS_MESSAGE}, {NULL}, NULL },
{ "MAILREPORTRECCLI", {HB_FS_PUBLIC}, {HB_FUNCNAME( MAILREPORTRECCLI )}, NULL },
...
HB_INIT_SYMBOLS_EX_END( hb_vm_SymbolInit_TGENMAILDATABASERECIBOSCLIENTES, ".\\.\\Prg\\TGenMailDatabaseRecibosClientes.prg", 0x0, 0x0003 )

#if defined( HB_PRAGMA_STARTUP )
   #pragma startup hb_vm_SymbolInit_TGENMAILDATABASERECIBOSCLIENTES
#elif defined( HB_DATASEG_STARTUP )
   #define HB_DATASEG_BODY    HB_DATASEG_FUNC( hb_vm_SymbolInit_TGENMAILDATABASERECIBOSCLIENTES )
   #include "hbiniseg.h"
#endif
...
HB_FUNC( TGENMAILINGDATABASERECIBOSCLIENTES )
{
	static const HB_BYTE pcode[] =
	{
		...
		68,97,116,97,98,97,115,101,82,101,99,105,98,111,
...
HB_FUNC_STATIC( TGENMAILINGDATABASERECIBOSCLIENTES_NEW )
{
	static const HB_BYTE pcode[] =
	{
		...
		2,106,8,110,82,101,99,67,108,105,0,112,1,73,
		36,28,0,48,22,0,95,2,106,3,82,70,0,112,
		1,73,36,30,0,48,23,0,95,2,176,24,0,106,
		3,82,70,0,48,25,0,176,20,0,12,0,95,1,
		112,1,12,2,112,1,73,36,32,0,48,26,0,95,
		2,106,13,103,99,95,109,111,110,101,121,50,95,52,
		56,0,112,1,73,36,34,0,48,27,0,95,2,106,
		113,69,110,118,237,111,32,100,101,32,114,101,99,105,
		98,111,32,100,101,32,99,108,105,101,110,116,101,32,
		110,250,109,101,114,111,32,123,83,101,114,105,101,32,
		100,101,32,102,97,99,116,117,114,97,125,47,123,78,
		250,109,101,114,111,32,100,101,32,102,97,99,116,117,
		114,97,125,47,123,83,117,102,105,106,111,32,100,101,
		32,102,97,99,116,117,114,97,125,45,123,78,250,109,
		101,114,111,32,100,101,108,32,114,101,99,105,98,111,
		125,0,112,1,73,36,36,0,48,28,0,95,2,89,
		64,0,0,0,2,0,1,0,2,0,176,29,0,176,
		30,0,48,19,0,176,20,0,12,0,95,255,112,1,
		88,31,0,48,32,0,176,20,0,12,0,48,33,0,
		95,254,112,0,112,1,106,8,99,77,101,105,73,110,
		116,0,12,3,12,1,6,112,1,73,36,38,0,95,
		2,110,7
	};
