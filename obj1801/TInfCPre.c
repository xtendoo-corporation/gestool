 ...
 * Generated C source from ".\.\Prg\TInfCPre.prg"
 */
...
HB_FUNC_STATIC( TINFCPRE_CREATE );
HB_FUNC_STATIC( TINFCPRE_OPENFILES );
HB_FUNC_STATIC( TINFCPRE_CLOSEFILES );
HB_FUNC_STATIC( TINFCPRE_LRESOURCE );
HB_FUNC_STATIC( TINFCPRE_LGENERATE );
...
HB_INIT_SYMBOLS_BEGIN( hb_vm_SymbolInit_TINFCPRE )
{ "TINFCPRE", {HB_FS_PUBLIC | HB_FS_FIRST | HB_FS_LOCAL}, {HB_FUNCNAME( TINFCPRE )}, NULL },
...
{ "TINFCPRE_CREATE", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TINFCPRE_CREATE )}, NULL },
{ "TINFCPRE_OPENFILES", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TINFCPRE_OPENFILES )}, NULL },
{ "TINFCPRE_CLOSEFILES", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TINFCPRE_CLOSEFILES )}, NULL },
{ "TINFCPRE_LRESOURCE", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TINFCPRE_LRESOURCE )}, NULL },
{ "TINFCPRE_LGENERATE", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TINFCPRE_LGENERATE )}, NULL },
...
HB_INIT_SYMBOLS_EX_END( hb_vm_SymbolInit_TINFCPRE, ".\\.\\Prg\\TInfCPre.prg", 0x0, 0x0003 )

#if defined( HB_PRAGMA_STARTUP )
   #pragma startup hb_vm_SymbolInit_TINFCPRE
#elif defined( HB_DATASEG_STARTUP )
   #define HB_DATASEG_BODY    HB_DATASEG_FUNC( hb_vm_SymbolInit_TINFCPRE )
   #include "hbiniseg.h"
#endif
...
HB_FUNC( TINFCPRE )
{
	static const HB_BYTE pcode[] =
	{
		...
		0,106,9,84,73,110,102,67,80,114,101,0,108,4,
...
HB_FUNC_STATIC( TINFCPRE_LGENERATE )
{
	static const HB_BYTE pcode[] =
	{
		...
		99,80,114,101,0,112,1,73,36,150,0,48,88,0,
		48,38,0,95,1,112,0,106,8,110,78,117,109,80,
		114,101,0,112,1,73,36,153,0,48,86,0,48,87,
		...
		41,0,72,80,2,26,241,0,36,155,0,48,86,0,
		48,87,0,95,1,112,0,112,0,92,2,8,28,109,
