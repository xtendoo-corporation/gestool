 ...
 * Generated C source from ".\.\Prg\oacubalb.prg"
 */
...
HB_FUNC_STATIC( OACUBALB_CREATE );
HB_FUNC_STATIC( OACUBALB_OPENFILES );
HB_FUNC_STATIC( OACUBALB_CLOSEFILES );
HB_FUNC_STATIC( OACUBALB_LRESOURCE );
HB_FUNC_STATIC( OACUBALB_LGENERATE );
...
HB_INIT_SYMBOLS_BEGIN( hb_vm_SymbolInit_OACUBALB )
{ "OACUBALB", {HB_FS_PUBLIC | HB_FS_FIRST | HB_FS_LOCAL}, {HB_FUNCNAME( OACUBALB )}, NULL },
...
{ "OACUBALB_CREATE", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( OACUBALB_CREATE )}, NULL },
{ "OACUBALB_OPENFILES", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( OACUBALB_OPENFILES )}, NULL },
{ "OACUBALB_CLOSEFILES", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( OACUBALB_CLOSEFILES )}, NULL },
{ "OACUBALB_LRESOURCE", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( OACUBALB_LRESOURCE )}, NULL },
{ "OACUBALB_LGENERATE", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( OACUBALB_LGENERATE )}, NULL },
...
HB_INIT_SYMBOLS_EX_END( hb_vm_SymbolInit_OACUBALB, ".\\.\\Prg\\oacubalb.prg", 0x0, 0x0003 )

#if defined( HB_PRAGMA_STARTUP )
   #pragma startup hb_vm_SymbolInit_OACUBALB
#elif defined( HB_DATASEG_STARTUP )
   #define HB_DATASEG_BODY    HB_DATASEG_FUNC( hb_vm_SymbolInit_OACUBALB )
   #include "hbiniseg.h"
#endif
...
HB_FUNC( OACUBALB )
{
	static const HB_BYTE pcode[] =
	{
		...
		0,106,9,79,65,99,117,66,65,108,98,0,108,4,
...
HB_FUNC_STATIC( OACUBALB_CREATE )
{
	static const HB_BYTE pcode[] =
	{
		...
		8,99,67,111,100,80,114,118,0,112,2,73,36,35,
		0,102,110,7
	};
...
HB_FUNC_STATIC( OACUBALB_LRESOURCE )
{
	static const HB_BYTE pcode[] =
	{
		...
		70,65,67,85,80,82,86,0,112,1,31,8,36,89,
		0,9,110,7,36,96,0,48,39,0,102,92,70,92,
		80,92,90,92,100,93,132,3,112,5,31,8,36,97,
...
HB_FUNC_STATIC( OACUBALB_LGENERATE )
{
	static const HB_BYTE pcode[] =
	{
		...
		32,32,32,58,32,0,176,54,0,176,55,0,12,0,
		12,1,72,6,89,58,0,0,0,1,0,1,0,106,
		13,80,101,114,105,111,100,111,32,32,32,58,32,0,
		176,54,0,48,56,0,95,255,112,0,12,1,72,106,
		4,32,62,32,0,72,176,54,0,48,57,0,95,255,
		112,0,12,1,72,6,89,77,0,0,0,1,0,1,
		0,106,13,80,114,111,118,101,101,100,111,114,32,58,
		32,0,48,58,0,95,255,112,0,28,12,106,6,84,
		111,100,111,115,0,25,34,176,59,0,48,60,0,95,
		255,112,0,12,1,106,4,32,62,32,0,72,176,59,
		0,48,61,0,95,255,112,0,12,1,72,72,6,4,
		3,0,112,1,73,36,129,0,48,62,0,48,27,0,
		95,1,112,0,106,8,100,70,101,99,65,108,98,0,
		112,1,73,36,131,0,106,19,100,70,101,99,65,108,
		...
		58,0,95,1,112,0,31,76,36,134,0,96,2,0,
		106,20,32,46,97,110,100,46,32,99,67,111,100,80,
		114,118,32,62,61,32,34,0,48,60,0,95,1,112,
