...
CLASS AgendaModel FROM ADSBaseModel

   METHOD getTableName()                     INLINE ::getDatosTableName( "Agenda" )
...
METHOD InsertFromHashSql( hHash ) CLASS AgendaModel
...
METHOD lExisteUuid( uuid ) CLASS AgendaModel
