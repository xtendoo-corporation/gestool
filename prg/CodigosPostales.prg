...
CLASS CodigosPostales FROM TMant
   ...
   DATA cName                                         INIT "Codigos postales"
...
METHOD New( cPath, cDriver, oWndParent, oMenuItem ) CLASS CodigosPostales
   ...
   if oMenuItem != nil
      ...
      ::nLevel          := Auth():Level( "codigos_postales" )
   end if
...
METHOD DefineFiles( cPath, cDriver ) CLASS CodigosPostales
   ...
   DEFINE DATABASE ::oDbf FILE "CODPOSTAL.DBF" CLASS "CODPOSTAL" ALIAS "CODPOSTAL" PATH ( cPath ) VIA ( cDriver ) COMMENT "Codigos postales"
