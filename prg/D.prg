...
CLASS D
   ...
   METHOD AlbaranesClientes( nView, cSelect )               INLINE ( if( Empty( cSelect ), ::Get( "AlbCliT", nView ), ::AlbaranesClientesSQL( nView, cSelect ) ) )
   METHOD AlbaranesClientesSQL( nView, cSelect )            INLINE ( ::getSQL( ::AlbaranesClientesTableName(), cSelect, nView ) ) 
   METHOD getSqlSentenceAlbaranesClientes()                 INLINE ( "SELECT * FROM " + cPatEmp() + ::AlbaranesClientesTableName() )
   ...
   METHOD setArticuloTablaPropiedades( id, idCodigoPrimeraPropiedad, idCodigoSegundaPropiedad, idValorPrimeraPropiedad, idValorSegundaPropiedad, nUnidades, aPropertiesTable )
      ...
      METHOD ArticuloDocumentos( nView )                          INLINE ( ::Get( "ArtDoc", nView ) )
   ...
   METHOD Asociado( nView )                                       INLINE ( ::Get( "ArtAsc", nView ) )

   METHOD ParKit( nView )                                         INLINE ( ::Get( "ParKit", nView ) )
   ...
   METHOD CajasL( nView )                                         INLINE ( ::Get( "CajL", nView ) )
   ...
   METHOD getStatusAlmacen( nView )                               INLINE ( ::aStatus := aGetStatus( ::Almacen( nView ) ) )
      METHOD setStatusAlmacen( nView )                            INLINE ( SetStatus( ::Almacen( nView ), ::aStatus ) ) 
      METHOD setFocusAlmacen( cTag, nView )                       INLINE ( ::cTag   := ( ::Almacen( nView )  )->( ordSetFocus( cTag ) ) )
