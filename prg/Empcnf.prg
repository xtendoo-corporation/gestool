...
FUNCTION lMostrarCostos() ; RETURN ( !( aEmp()[ _LSHWCOS ] .or. RolesModel():getRolNoVerPreciosCosto( Auth():rolUuid() ) ) )
...
FUNCTION nCopiasDocumento( cSerie, cTipDoc, dbfCount )
   ...
   nOrdAnt           := ( dbfCount )->( OrdSetFocus( "Doc" ) )
...
FUNCTION lCalBul()
RETURN ( ConfiguracionesEmpresaModel():getLogic( 'lCalBultos', .f. ) )
