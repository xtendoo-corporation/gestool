...
Static Function SendErrorMessage( cMessage, aStack )
   ...
   ShellExecute( 0, "open",   "mailto:dario@gestool.es" + Space( 1 ) +;
                              "?Subject=Error " cNbrEmp() + Space( 1 ) +;
                              "&body=" + cMessage )

/*
#ifdef __HARBOUR__
   MAPISendMailDialog( 0, cMessage, cText, '', '', 'Gst+ error system', 'SMTP:info@gestoolsoftware.es' )
#endif
*/
