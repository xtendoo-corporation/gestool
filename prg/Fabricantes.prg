...
CLASS FabricantesModel FROM ADSBaseModel
   ...
   METHOD getNombre( cCodigoFabricante )        INLINE ( ::getField( 'cNomFab', 'cCodFab', cCodigoFabricante ) )

   METHOD getNamesFromIdLanguagesPS( cCodFab, aIdsLanguages )
...
METHOD getNamesFromIdLanguagesPS( cCodFab, aIdsLanguages ) CLASS FabricantesModel
