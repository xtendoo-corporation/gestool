...
/*COMENTARIO DE PRUEBAS DE SUBIDA*/
...
#define _CDIRCLI            11      //,"C", 60, 0, "Direcci�n del cliente" },;
#define _CPOBCLI            12      //,"C", 25, 0, "Poblaci�n del cliente" },;
#define _CPRVCLI            13      //,"C", 20, 0, "Provincia del cliente" },;
#define _NCODPROV           14      //,"N",  2, 0, "N�mero de provincia cliente" },;
#define _CPOSCLI            15      //,"C",  5, 0, "Codigos postal del cliente" },;
#define _CDNICLI            16      //,"C", 15, 0, "DNI/CIF del cliente" },;
#define _LMODCLI            17
#define _LMAYOR             18      //,"L",  1, 0, "L�gico de mayorista" },;
#define _NTARIFA            19      //,"L",  1, 0, "L�gico de mayorista" },;
...
#define _CCODOBR            23      //,"C",  3, 0, "Codigo de la Direcci�n" },;
#define _NPCTCOMAGE         24      //,"N",  6, 2, "Porcentaje de Comisi�n del agente" },;
#define _LLIQUIDADA         25      //,"L",  1, 0, "L�gico de la liquidaci�n" },;
#define _LCONTAB            26      //,"L",  1, 0, "L�gico de la contabilizaci-n" },;
#define _CCONGUID           27 
#define _DFECENT            28      //,"D",  8, 0, "Fecha de entrega" },;
#define _CSUFAC             29      //,"C", 10, 0, "Su factura" },;
#define _LIMPALB            30      //,"L", 10, 0, "Su pedido" },;
#define _CCONDENT           31      //,"C", 20, 0, "Condici�n de entrada" },;
...
#define _NBULTOS            35      //,"N",  3, 0, "N�mero de bultos" },;
#define _NPORTES            36      //,"N",  6, 0, "Valor de los portes" },;
#define _NIVAMAN            37      //,"N",  6, 0, "IvaValor de la mano de Direcci�n" },;
#define _NMANOBR            38      //,"N",  6, 0, "Valor de la mano de Direcci�n" },;
#define _CNUMALB            39      //,"C", 12, 0, "N�mero de albaran" },;
#define _CNUMPED            40      //,"C", 12, 0, "N�mero de pedido
#define _CNUMPRE            41      //,"C", 12, 0, "N�mero de presupuesto
#define _CNUMSAT            42      //,"C", 12, 0, "N�mero de presupuesto
#define _NTIPOFAC           43      //,"N",  1, 0, "N�mero del tipo de factura" },;
...
#define _CDTOUNO            48      //,"C", 25, 0, "Descripci�n de porcentaje de descuento personalizado"
#define _NDTOUNO            49      //,"N",  4, 1, "Porcentaje de descuento por descuento personalizado"
#define _CDTODOS            50      //,"C", 25, 0, "Descripci�n de porcentaje de descuento personalizado"
...
#define _NTIPOIVA           57      //,"N",  1, 0, "N�mero del tipo de " + cImp() },;
#define _NPORCIVA           58      //,"N",  4, 1, "Porcentaje de " + cImp() },;
#define _LRECARGO           59      //,"L",  1, 0, "L�gico para recargo" },;
#define _CREMITIDO          60      //,"C", 50, 0, "Campo de remitido" },;
#define _LIVAINC            61      //,"N",  1, 0, "Selecci�n de " + cImp() },;
#define _LSNDDOC            62      //,"L",  1, 0, "L�gico para documento enviado" },;
...
#define _CCODPRO            69
#define _CDOCORG            70
#define _NNUMLIQ            71     //"N",  9, 0, "N�mero liquidaci�n" }                                  "",                   "", "( cDbf )"} )
#define _CSUFLIQ            72     //"C",  2, 0, "Sufijo liquidaci�n" }                                  "",                   "", "( cDbf )"} )
#define _NIMPLIQ            73     //"N", 16, 6, "Importe liquidaci�n" }                                 "",                   "", "( cDbf )"} )
...
#define _CABNFAC            78     //"C", 12, 0, "N�mero de presupuesto
#define _CANTFAC            79     //"C", 12, 0, "N�mero de presupuesto
#define _NTIPRET            80
#define _NPCTRET            81
#define _CCODUSR            82
#define _DFECCRE            83
...
#define _CCODDLG            89
#define _NDTOATP            90      //   N      6     2     Porcentaje de descuento at�pico
#define _NSBRATP            91      //   N      1     0     Lugar donde aplicar dto at�pico
#define _DFECENTR           92
#define _DFECSAL            93
...
#define _LVALIDADO		   109	
#define _UUID 			   110
#define _PARUUID		   111
#define _CIDPARKIT 		   112
...
FUNCTION FactCli( oMenuItem, oWnd, hHash )
   ...
   */
   ...
   DEFINE SHELL oWndBrw FROM 0, 0 TO 22, 80 ;
      ...
      with object ( oWndBrw:AddXCol() )
         :cHeader          := "Exportado a Facturae 3.2 [Factura electr�nica]"
         :nHeadBmpNo       := 3
         :bStrData         := {|| "" }
   ...
   DEFINE BTNSHELL RESOURCE "BUS" OF oWndBrw ;
      ...
      DEFINE BTNSHELL RESOURCE "GC_MAIL_EARTH_" OF oWndBrw ;
         ...
         TOOLTIP  "Correo electr�nico series";
         LEVEL    ACC_IMPR 
      ...
      DEFINE BTNSHELL RESOURCE "BMPCONTA" OF oWndBrw ;
         NOBORDER ;
         ACTION   ( aGetSelRec( oWndBrw, {|lChk1, lChk2, oTree| actionContabilidad( lChk1, lChk2, oTree ) }, "Contabilizar facturas", lHideCheck1Contabilidad(), "Simular resultados", lHideCheck2Contabilidad(), "Contabilizar recibos", , {|| postActionContabilidad() } ) ) ;
   ...
   if RolesModel():getRolCambiarEstado( Auth():rolUuid() )
      ...
      DEFINE BTNSHELL RESOURCE "gc_document_text_earth_" OF oWndBrw ;
         NOBORDER ;
         ACTION   ( aGetSelRec( oWndBrw, {|lChk1, lChk2, oTree| CreateFileFacturae( oTree, lChk1, lChk2 ) }, "Exportar facturas electr�nicas a Facturae v 3.2", .t., "Firmar digitalmente (necesita runtime de Java)", .t., "Enviar por correo electr�nico" ) ) ;
   ...
   if RolesModel():getRolCambiarCampos( Auth():rolUuid() )
      ...
      DEFINE BTNSHELL RESOURCE "GC_DOCUMENT_EMPTY_" OF oWndBrw ;
         NOBORDER ;
         ACTION   ( if( !empty( ( D():FacturasClientes( nView ) )->cNumAlb ), ZooAlbCli( ( D():FacturasClientes( nView ) )->cNumAlb ), MsgStop( "No hay albar�n asociado" ) ) );
         TOOLTIP  "Visualizar albar�n" ;
         FROM     oRotor ;
...
FUNCTION imprimeFacturaCliente( cNumeroFactura, cFormatoDocumento )
   ...
   if OpenFiles()
      ...
      if dbSeekInOrd( cNumeroFactura, "nNumFac", D():FacturasClientes( nView ) )
         ...
         msgStop( "N�mero de factura " + alltrim( cNumeroFactura ) + " no encontrado.", "Stop! " + str( len( cNumeroFactura ) ) )
...
STATIC FUNCTION OpenFiles()
   ...
   BEGIN SEQUENCE
      ...
      */
      ...
      public aTotIva	:= { { 	"porcentajeiva" => 0,;
								"logrecargo"	=> .f.,;
								"porcentajere"	=> 0,;
								"bruto"			=> 0,;
								"neto"			=> 0,;
...
STATIC FUNCTION EdtRec( aTmp, aGet, dbf, oBrw, hHash, bValid, nMode )
   ...
   */
   ...
   case nMode == EDIT_MODE
      ...
      if aTmp[ _LCONTAB ] .and.;
         !ApoloMsgNoYes(  "La modificaci�n de esta factura puede provocar descuadres contables." + CRLF + "� Desea continuar ?", "Factura ya contabilizada" )
         return .f.
      end if
   ...
   */
   ...
   cSay[ 11]               := UsuariosModel():getNombreWhereCodigo( aTmp[ _CCODUSR ] )
   ...
   */
   ...
   DEFINE DIALOG oDlg RESOURCE "FACCLI" TITLE LblTitle( nMode ) + "facturas a clientes"
      ...
      */
      ...
      REDEFINE BTNBMP;
         ID       175 ;
         OF       oFld:aDialogs[1] ;
         RESOURCE "gc_symbol_percent_16" ;
         NOBORDER ;
         ACTION   ( HistoricoVentas():New():Historico() );
      ...
      */
      ...
      REDEFINE BTNBMP oBtnPrecio ;
         ...
         WHEN     ( nMode != ZOOM_MODE .and. ( RolesModel():getRolCambiarPrecios( Auth():rolUuid() ) ) )
      ...
      */
      ...
      REDEFINE GET aGet[ _CCODUSR ] VAR aTmp[ _CCODUSR ];
         ID       125 ;
         WHEN     ( .f. ) ;
         VALID    ( oSay[ 11 ]:cText( UsuariosModel():getNombreWhereCodigo( aTmp[ _CCODUSR ] ) ), .t.  ) ;
         OF       fldData
      ...
      */
      ...
      REDEFINE GET aGet[ _CENTBNC ] VAR aTmp[ _CENTBNC ];
         ID       420 ;
         WHEN     ( lWhen .and. !lRecibosPagadosTmp( dbfTmpPgo ) );
         VALID    (  lCalcDC( aTmp[ _CENTBNC ], aTmp[ _CSUCBNC ], aTmp[ _CDIGBNC ], aTmp[ _CCTABNC ], aGet[ _CDIGBNC ], aTmp[ _CPAISIBAN ] ),;
      ...
      */
      ...
      with object ( oBrwLin:AddCol() )
         :cHeader             := "Punto verde"
         :bEditValue          := {|| nPntUFacCli( dbfTmpLin, nDpvDiv, , aTmp[ _LOPERPV ] ) }
     ...
     */
      ...
      */
      ...
      with object ( oBrwIva:AddCol() )
         :cHeader          := "% R.E."
         :bStrData         := {|| if( len( aTotIva ) > 0, if( ( hhaskey( aTotIva[ oBrwIva:nArrayAt ], "porcentajere" ) .and. hGet( aTotIva[ oBrwIva:nArrayAt ], "porcentajere" ) != nil .and. aTmp[ _LRECARGO ] ), Trans( hGet( aTotIva[ oBrwIva:nArrayAt ], "porcentajere" ), cPicReq() ), "" ), "" ) }
         :nWidth           := 44
         :nDataStrAlign    := 1
         :nHeadStrAlign    := 1
      end with
      ...
      with object ( oBrwIva:AddCol() )
         :cHeader          := "R.E."
         :bStrData         := {|| if( len( aTotIva ) > 0, if( ( hhaskey( aTotIva[ oBrwIva:nArrayAt ], "impre" ) .and. hGet( aTotIva[ oBrwIva:nArrayAt ], "impre" ) != nil .and. aTmp[ _LRECARGO ] ), Trans( hGet( aTotIva[ oBrwIva:nArrayAt ], "impre" ), cPorDiv ), "" ), "" ) }
         :nWidth           := 76
         :nDataStrAlign    := 1
         :nHeadStrAlign    := 1
      end with
      ...
      */
	  ...
	  REDEFINE GET aGet[ _DINIPER ] VAR aTmp[ _DINIPER ] ;
         ID       320 ;
         SPINNER ;
         WHEN     ( lWhen ) ;
         OF       fldData

      REDEFINE GET aGet[ _DFINPER ] VAR aTmp[ _DFINPER ] ;
         ID       330 ;
         SPINNER ;
         WHEN     ( lWhen ) ;
         OF       fldData
      ...
      */
      ...
      /*Exportacion a EDI ( informa de si est� exportado o no y de cuando se export- )*/
   ...
   ACTIVATE DIALOG oDlg ;
      ON INIT     ( initDialog( aTmp, oDlg, oBrwLin, oBrwInc, oBrwPgo ), SetDialog( aGet, oSayDias, oSayGetRnt, oGetRnt ) );
...
Static Function StartEdtRec( aTmp, aGet, oDlg, nMode, hHash, oBrwLin )
   ...
   if nMode == APPD_MODE
      ...
      if IsHash( hHash )
         ...
         do case
            case HGetKeyAt( hHash, 1 ) == "art�culo"
   ...
   for each aRelacion in aRelaciones
      ...
      if isArray( aArticulo ) .and. len( aArticulo ) >= 2 .and. !empty( aArticulo[1] ) .and. !empty( aArticulo[2] ) 
         ...
         if !( oneAppendLine( aCabeceraFactura, aArticulo[1], val( aArticulo[2] ) ) )
            ...
            aadd( oDialog:aErrors, "- Error al a�adir el art�culo " + alltrim( aArticulo[1] ) )
...
STATIC FUNCTION EdtDet( aTmp, aGet, cFacCliL, oBrw, lTotLin, cCodArtEnt, nMode, aTmpFac )
   ...
   case nMode == APPD_MODE
      ...
      aTmp[ __CCODAGE ]       := aTmpFac[ _CCODAGE ]
   ...
   */
   ...
   cGetAge 				:= cNbrAgent( aTmp[ __CCODAGE ] )

   /*
   Caja de dialogo-------------------------------------------------------------
   */

   DEFINE DIALOG oDlg RESOURCE "LFACCLI" TITLE LblTitle( nMode ) + "l�neas de facturas de clientes"
      ...
      REDEFINE GET aGet[ _CREF ] VAR cCodArt;
         ID       100 ;
         WHEN     ( nMode != ZOOM_MODE ) ;
         VALID    ( loaArt( cCodArt, aGet, aTmp, aTmpFac, oStkAct, oSayPr1, oSayPr2, oSayVp1, oSayVp2, bmpImage, nMode, .t., , oSayParKit ) );
         BITMAP   "LUPA" ;
      ...
      */
      ...
      REDEFINE COMBOBOX aGet[ _CIDPARKIT ] ;
         VAR      aTmp[ _CIDPARKIT ] ;
         ITEMS    {""} ;
         ID       210 ;
      ...
      REDEFINE GET aGet[ _CVALPR1 ] VAR aTmp[ _CVALPR1 ];
         ...
         aGet[ _CVALPR1 ]:bChange   := {|| aGet[ _CVALPR1 ]:Assign(), if( !uFieldEmpresa( "lNStkAct" ), StocksModel():lPutStockActual( aTmp[ _CREF ], aTmp[ _CALMLIN ], aTmp[ _CCODPR1 ], aTmp[ _CCODPR2 ], aTmp[ _CVALPR1 ], aTmp[ _CVALPR2 ], aTmp[ _CLOTE ], oStkAct ), .t. ) }
      ...
      REDEFINE GET aGet[ _CVALPR2 ] VAR aTmp[ _CVALPR2 ];
         ...
         aGet[ _CVALPR2 ]:bChange   := {|| aGet[ _CVALPR2 ]:Assign(), if( !uFieldEmpresa( "lNStkAct" ), StocksModel():lPutStockActual( aTmp[ _CREF ], aTmp[ _CALMLIN ], aTmp[ _CCODPR1 ], aTmp[ _CCODPR2 ], aTmp[ _CVALPR1 ], aTmp[ _CVALPR2 ], aTmp[ _CLOTE ], oStkAct ), .t. ) }
      ...
      */
	  ...
	  REDEFINE GET aGet[ __CCODAGE ] VAR aTmp[ __CCODAGE ] ;
         WHEN     ( .f. ) ;
         ID       290;
         OF       fldGeneral
      ...
      */
      ...
      aGet[ _CALMLIN ]:bLostFocus   := {|| if( !uFieldEmpresa( "lNStkAct" ), StocksModel():lPutStockActual( aTmp[ _CREF ], aTmp[ _CALMLIN ], aTmp[ _CCODPR1 ], aTmp[ _CCODPR2 ], aTmp[ _CVALPR1 ], aTmp[ _CVALPR2 ], aTmp[ _CLOTE ], oStkAct ), .t. ) }
      ...
      REDEFINE GET aGet[ _NCOSDIV ] VAR aTmp[ _NCOSDIV ] ;
         ID       320 ;
         WHEN     ( RolesModel():getRolVerPreciosCosto( Auth():rolUuid() ) .AND.  nMode != ZOOM_MODE );
         PICTURE  cPouDiv ;
         OF       fldGeneral ;
         IDSAY    321 ;

      TBtnBmp():ReDefine( 322, "gc_businessman_16",,,,,{|| THistoricoProveedor():run( aTmp[ _CREF ], aGet[ _NCOSDIV ], aGet[ _CCODPRV ] ) }, fldGeneral, .f., , .f.,  )
    ...
    REDEFINE GET aGet[ _CCODPRV ] VAR  aTmp[ _CCODPRV ] ;
      ...
      REDEFINE GET aGet[ __CCODOBR ] VAR aTmp[ __CCODOBR ] ;
         ...
         IDTEXT   331 ;
         WHEN     ( nMode != ZOOM_MODE ) ;
         VALID    ( cObras( aGet[ __CCODOBR ], aGet[ __CCODOBR ]:oHelpText, aTmpFac[ _CCODCLI ] ) ) ;
         BITMAP   "LUPA" ;
    ...
    */
    ...
    REDEFINE BUTTON oBtn;
        ...
        OF       oDlg ;
        WHEN     ( nMode != ZOOM_MODE ) ;
        ACTION   SaveDeta( aTmp, aTmpFac, aGet, oBrw, oDlg, oFld, oSayPr1, oSayPr2, oSayVp1, oSayVp2, bmpImage, nMode, oTotalLinea, oStkAct, nStkAct, cCodArt, oBtn, oBtnSer, , oSayParKit )
   ...
   if nMode != ZOOM_MODE
      if uFieldEmpresa( "lGetLot")
         oDlg:AddFastKey( VK_RETURN,   {|| if( !Empty( aGet[ _CREF ] ), ( aGet[ _CVALPR1 ]:lValid(), aGet[ _CVALPR2 ]:lValid() ), ), oBtn:SetFocus(), oBtn:Click() } )
      end if 
   ...
   oDlg:bStart    := {||   SetDlgMode( aTmp, aGet, oFld, oSayPr1, oSayPr2, oSayVp1, oSayVp2, oStkAct, nMode, oTotalLinea, aTmpFac, oRentabilidadLinea, , oSayParKit ),;
...
Static Function EdtEst( aTmp, aGet, dbf, oBrw, bWhen, bValid, nMode, aTmpFac )
      ...
      DEFINE DIALOG oDlg RESOURCE "SITUACION_ESTADO" TITLE LblTitle( nMode ) + "Situaci�n del documento del cliente"
         ...
         REDEFINE COMBOBOX aGet[ (D():FacturasClientesSituaciones( nView ))->(fieldpos("cSitua")) ] ;
            ...
            ID       200 ;
            WHEN     ( nMode != ZOOM_MODE );
            ITEMS    ( SituacionesModel():getArrayNombres() ) ;
            OF       oDlg
...
STATIC FUNCTION lLiquida( oBrw, cFactura )
   ...
   if ( D():FacturasClientes( nView ) )->lLiquidada
      msgStop( "Factura ya cobrada", "Imposible a�adir cobros" )
      return .f.
   end if
   ...
   if ( dbfAlbCliT )->( dbSeek( cAlbaran ) )
      ...
      if lFacturado( dbfAlbCliT )
         ...
         if ( dbfAlbCliL )->( dbSeek( cAlbaran ) )
            ...
            */
            ...
            while ( ( dbfAlbCliL )->cSerAlb + str( ( dbfAlbCliL )->nNumAlb ) + ( dbfAlbCliL )->cSufAlb == cAlbaran .and. !( dbfAlbCliL )->( eof() ) )
            	...
            	if !( dbfAlbCliL )->lFacturado //.and. !( dbfAlbCliL )->lKitChl
            ...
            */
            ...
            MsgStop( "albar�n no contiene lineas de detalle." )
         ...
         */
         ...
         /*
         Pasamos las incidencias del albar�n
         */
      ...
      MsgStop( "albar�n : " + cAlbaran + " no encontrado" )
...
STATIC FUNCTION cFacPrv( cFacPrv, aGet, aTmp, oBrw, nMode )
   ...
   if ( dbfFacPrvT )->( dbSeek( cFacPrv ) )
      ...
      */
      ...
      /*
      Recalculamos los precios de los art�culos y refrescamos el browse--------
      */
      ...
      if ( dbfPedCliT )->nEstado == 3
         ...
         */
         ...
         if ( dbfPedCliL )->( dbSeek( cPedido ) )
            ...
            (dbfTmpLin)->( dbAppend() )
            cDesAlb                    := ""
            cDesAlb                    += "Pedido N� " + ( dbfPedCliT )->cSerPed + "/" + AllTrim( str( ( dbfPedCliT )->NNUMPED ) ) + "/" + ( dbfPedCliT )->CSUFPED
      ...
      if ( dbfPreCliT )->lEstado
         ...
         */
         ...
         if (dbfPreCliL)->( dbSeek( cPedido ) )
            ...
            (dbfTmpLin)->( dbAppend() )
            cDesAlb              := ""
            cDesAlb              += "Presupuesto N� " + ( dbfPreCliT )->cSerPre + "/" + AllTrim( str( ( dbfPreCliT )->nNumPre ) ) + "/" + ( dbfPreCliT )->cSufPre
      ...
      */
      ...
      if ( D():Articulos( nView ) )->( dbSeek( ( dbfTmpLin )->cRef ) )
         ...
         */
         ...
         ( dbfTmpLin )->nCosDiv  := nCosto( nil, D():Articulos( nView ), dbfKit, , , , aTmpFac[ _CCODCLI ] )
         ...
         */
         ...
         if !empty( hAtipica )
            ...
            if hhaskey( hAtipica, "nTarifaFamilia" ) .and. hAtipica[ "nTarifaFamilia" ] > 0
               ( dbfTmpLin )->nPreUnit := nRetPreArt( hAtipica[ "nTarifaFamilia" ], aTmpFac[ _CDIVFAC ], aTmpFac[ _LIVAINC ], D():Articulos( nView ), dbfDiv, dbfKit, dbfIva, , , oNewImp )
            end if
         ...
         if ( dbfAlbCliL )->( dbSeek( aFacturas[ nItem, 2 ] ) ) .and. aFacturas[ nItem, 1 ]
            ...
            */
            ...
            if RetFld( cCodCli, D():Clientes( nView ), "lTotAlb" )
               ...
               ( dbfTmpLin )->nNumLin     := ++nOffSet
               ( dbfTmpLin )->nPosPrint   := nOffSet
               ( dbfTmpLin )->mLngDes     := "Total albar�n..."
               ( dbfTmpLin )->lTotLin     := .t.
            end if
   ...
   MENU oMenu 2015 
      ...
      MENUITEM    "&1. Rotor"
         ...
         MENU
            ...
            MENUITEM    "&4. Visualizar albar�n";
               MESSAGE  "Visualiza el albar�n del que proviene" ;
               RESOURCE "gc_document_empty_16" ;
               ACTION   ( if( !empty( aTmp[ _CNUMALB ] ), ZooAlbCli( aTmp[ _CNUMALB ] ), MsgStop( "No hay albar�n asociado" ) ) );
            ...
            MENUITEM    "&8. Modificar Direcci�n";
               MESSAGE  "Modifica ficha de la Direcci�n" ;
...
Static Function FacCliNotas()
   ...
   if ( D():Clientes( nView ) )->( dbSeek( ( D():FacturasClientes( nView ) )->cCodCli ) )
      ...
      if !empty( ( D():Clientes( nView ) )->Telefono )
         cObserv  += "T�lefono : " + Rtrim( ( D():Clientes( nView ) )->Telefono ) + Space( 1 )
      end if

      if !empty( ( D():Clientes( nView ) )->Movil )
         cObserv  += "M�vil : " + Rtrim( ( D():Clientes( nView ) )->Movil ) + Space( 1 )
      end if
...
STATIC FUNCTION ValidaMedicion( aTmp, aGet )
   ...
   if !empty( aGet ) .and. !empty( aGet[ _CUNIDAD ] )
...
Static Function ChangeTarifa( aTmp, aGet, aTmpFac )
   ...
   if !empty( aTmpFac[ _CCODTAR ] )
      nPrePro  := RetPrcTar( aTmp[ _CREF ], aTmpFac[ _CCODTAR ], aTmp[ _CCODPR1 ], aTmp[ _CCODPR2 ], aTmp[ _CVALPR1 ], aTmp[ _CVALPR2 ], dbfTarPreL, aTmp[ _NTARLIN ] )
   end if
...
Static Function DataReport( oFr )
   ...
   */
   ...
   oFr:SetWorkArea(     "Tipo art�culo", oTipArt:Select() )
   oFr:SetFieldAliases( "Tipo art�culo", cObjectsToReport( oTipArt:oDbf ) )
   ...
   oFr:setUserDataSet( "Impuestos factura",;
                        "porcentajeiva;logrecargo;porcentajere;bruto;neto;impiva;impre;nivmh;ntransporte;npntver",;
                        {||np := 1},;
                     	{||np := np + 1},;
                     	{||np := np - 1},;
                     	{||np > Len( aTotIva )},;
                        {|key| hGet( aTotIva[np], key ) } )
   ...
   oFr:SetMasterDetail( "Facturas", "Pa�s",                                   {|| retFld( ( D():FacturasClientes( nView ) )->cCodCli, D():Clientes( nView ), "cCodPai" ) } )
   oFr:SetMasterDetail( "Facturas", "Transportistas",                  	      {|| ( D():FacturasClientes( nView ) )->cCodTrn } )

   oFr:SetMasterDetail( "Lineas de facturas", "Art�culos",                    {|| SynchronizeDetails() } )
   oFr:SetMasterDetail( "Lineas de facturas", "Familia",                      {|| ( D():FacturasClientesLineas( nView ) )->cCodFam } )
   oFr:SetMasterDetail( "Lineas de facturas", "Tipo art�culo",                {|| ( D():FacturasClientesLineas( nView ) )->cCodTip } )
   oFr:SetMasterDetail( "Lineas de facturas", "Ofertas",                      {|| ( D():FacturasClientesLineas( nView ) )->cRef } )
   oFr:SetMasterDetail( "Lineas de facturas", "Unidades de medici�n",         {|| ( D():FacturasClientesLineas( nView ) )->cUnidad } )
   ...
   oFr:SetResyncPair(   "Facturas", "Pa�s" )
   oFr:SetResyncPair(   "Facturas", "Transportistas" )

   oFr:SetResyncPair(   "Lineas de facturas", "Art�culos" )
   oFr:SetResyncPair(   "Lineas de facturas", "Familia" )
   oFr:SetResyncPair(   "Lineas de facturas", "Tipo art�culo" )
   oFr:SetResyncPair(   "Lineas de facturas", "Ofertas" )
   oFr:SetResyncPair(   "Lineas de facturas", "Unidades de medici�n" )
...
Static Function VariableReport( oFr )
   ...
   */
   ...
   oFr:AddVariable(     "Facturas",             "Total p�gina",                        "GetHbVar('nTotPag')" )
   oFr:AddVariable(     "Facturas",             "Total retenci�n",                     "GetHbVar('nTotRet')" )
   ...
   oFr:AddVariable(     "Facturas",             "Total art�culos",                     "GetHbVar('nTotArt')" )
   ...
   oFr:AddVariable(     "Lineas de facturas",   "Detalle del art�culo",                            "CallHbFunc('cDesFacCli')" )
   oFr:AddVariable(     "Lineas de facturas",   "Detalle del art�culo otro lenguaje",              "CallHbFunc('cDesFacCliLeng')" )
   oFr:AddVariable(     "Lineas de facturas",   "Total unidades art�culo",                         "CallHbFunc('nTotNFacCli')" )
   oFr:AddVariable(     "Lineas de facturas",   "Precio unitario del art�culo",                    "CallHbFunc('nTotUFacCli')" )
   oFr:AddVariable(     "Lineas de facturas",   "Precio unitario con descuentos",                  "CallHbFunc('nTotPFacCli')" )
   oFr:AddVariable(     "Lineas de facturas",   "Punto verde del art�culo",                        "CallHbFunc('nPntUFacCli')" )
   oFr:AddVariable(     "Lineas de facturas",   "Total l�nea de factura",                          "CallHbFunc('nTotLFacCli')" )
   oFr:AddVariable(     "Lineas de facturas",   "Total peso por l�nea",                            "CallHbFunc('nPesLFacCli')" )
   oFr:AddVariable(     "Lineas de facturas",   "Total final l�nea del factura",                   "CallHbFunc('nTotFFacCli')" )
   oFr:AddVariable(     "Lineas de facturas",   "Importe descuento l�nea del factura",             "CallHbFunc('nDtoLFacCli')" )
   oFr:AddVariable(     "Lineas de facturas",   "Importe impuestos especiales l�nea del factura",  "CallHbFunc('nTotIFacCli')" )
   oFr:AddVariable(     "Lineas de facturas",   "Total descuento l�nea del factura",               "CallHbFunc('nTotDtoLFacCli')" )
   ...
   oFr:AddVariable(     "Lineas de facturas",   "Direcci�n del SAT",                               "CallHbFunc('cFacturaClienteDireccionSAT')" )
   oFr:AddVariable(     "Lineas de facturas",   "Stock actual en almac�n",                         "CallHbFunc('nStockLineaFasCli')" )
   oFr:AddVariable(     "Lineas de facturas",   "Cambia orden",                                    "CallHbFunc('FacturaClienteLineaOrdSetFocus')" )
   oFr:AddVariable(     "Lineas de facturas",   "Total l�nea "+ cImp() + " incluido",              "CallHbFunc('nIncLFacCli')" )
...
Return ( printReportFacCli( IS_MAIL, 1, ImpresoraDefectoUsuario(), cCodigoDocumento ) )
...
Function printReportFacCli( nDevice, nCopies, cPrinter, cCodigoDocumento )
   ...
   if empty( cCodigoDocumento )
      msgStop( "El C�digo del documento esta vacio" )
      Return ( nil )
   end if 
...
/*
Comienza la edici�n de la factura
*/
...
STATIC FUNCTION BeginTrans( aTmp, nMode )
   ...
   */
   ...
   /*if !lStkMinimo
      MsgStop( "No se puede duplicar la factura por tener productos sin stock." )
      Return .t.
   end if*/
...
STATIC FUNCTION AppDeta( oBrwDet, bEdtDet, aTmp, lTot, cCodArt, aNumDoc )
   ...
   if !( "TABLET" $ appParamsMain() )
      ...
      if lRecibosPagadosTmp( dbfTmpPgo )
         MsgStop( "No se pueden a�adir registros a una factura con recibos cobrados" )
         return .f.
      end if
   ...
   if ( empty( aNumDoc ) ) .or. lTot // .and. !aTmp[ _LIMPALB ] )
      ...
      MsgStop( "No se pueden a�adir registros a una factura que" + CRLF + ;
...
STATIC FUNCTION SetDlgMode( aTmp, aGet, oFld, oSayPr1, oSayPr2, oSayVp1, oSayVp2, oStkAct, nMode, oTotal, aTmpFac, oRentLin, oSayLote, oSayParKit )
   ...
   case nMode == APPD_MODE
      ...
      if !empty( aGet ) .and. empty( aGet[ _CREF ]:varGet() )
      ...
      if !empty( aGet ) .and. !empty( aGet[ _NCANENT ] )
         aGet[ _NCANENT ]:refresh()
      end if 

      if !empty( aGet ) .and. !empty( aGet[ _NUNICAJA ] )
         aGet[ _NUNICAJA]:refresh()
      end if 

      aTmp[ _NNUMLIN ]  := nLastNum( dbfTmpLin )

      if !empty( aGet ) .and. !empty( aGet[ _NPOSPRINT  ] )
         aGet[ _NPOSPRINT  ]:cText( nLastNum( dbfTmpLin, "nPosPrint" ) )
      else
         aTmp[ _NPOSPRINT  ] := nLastNum( dbfTmpLin, "nPosPrint" )
      end if

      if !empty( aGet ) .and. !empty( aGet[ _CALMLIN ] )
         aGet[ _CALMLIN ]:cText( aTmpFac[ _CCODALM ] )
      else
         aTmp[ _CALMLIN ]  := aTmpFac[ _CCODALM ]
      end if   

      if !empty( aGet ) .and. !empty( aGet[ _CDETALLE] )
         aGet[ _CDETALLE]:Show()
      end if

      if !empty( aGet ) .and. !empty( aGet[ _MLNGDES ] )
         aGet[ _MLNGDES ]:Hide()
      end if   

      if aTmpFac[ _NREGIVA ] <= 2
         if !empty( aGet ) .and. !empty( aGet[ _NIVA ] )
      ...
      if !empty( aGet ) .and. !empty( aGet[ __CCENTROCOSTE ] )
   ...
   case ( nMode == EDIT_MODE .OR. nMode == ZOOM_MODE )
      ...
      StocksModel():lPutStockActual( cCodArt, aTmp[ _CALMLIN ], aTmp[ _CCODPR1 ], aTmp[ _CCODPR2 ], aTmp[ _CVALPR1 ], aTmp[ _CVALPR2 ], aTmp[ _CLOTE ], oStkAct )
      ...
      if !empty( aGet ) .and. !empty( aGet[ __CCENTROCOSTE ] )
   	...
   	if !empty( aGet ) .and. !empty( aGet[ _CIDPARKIT ] )
		aGet[ _CIDPARKIT ]:Hide()
	end if
	...
	if !Empty( oSayParKit )
      ...
      if !empty( aGet ) .and. !empty( aGet[ _CVALPR1 ] )
         aGet[ _CVALPR1 ]:Show()
   ...
   if !empty( aTmp[_CCODPR2 ] )
      ...
      if !empty( aGet ) .and. !empty( aGet[ _CVALPR2 ] )
         aGet[ _CVALPR2 ]:Show()
      ...
      */
      ...
      if !empty( aGet ) .and. !empty( aGet[ _CTIPMOV ] )
         aGet[ _CTIPMOV ]:lValid()
      end if

      if !empty( aGet ) .and. !empty( aGet[ _CCODTIP ] )
   ...
   */
   ...
   if ( empty( aTmp[ _NPREUNIT ] ) .or. RolesModel():getRolCambiarPrecios( Auth():rolUuid() ) ) .and. nMode != ZOOM_MODE

      if !empty( aGet ) .and. !empty( aGet[ _NPREUNIT ] )
         aGet[ _NPREUNIT ]:HardEnable()
      end if

      if !empty( aGet ) .and. !empty( aGet[ _NIMPTRN  ] )
         aGet[ _NIMPTRN  ]:HardEnable()
      end if            

      if !empty( aGet ) .and. !empty( aGet[ _NPNTVER ] )
...
STATIC FUNCTION LoaArt( cCodArt, aGet, aTmp, aTmpFac, oStkAct, oSayPr1, oSayPr2, oSayVp1, oSayVp2, bmpImage, nMode, lFocused, oSayLote, oSayParKit )
   ...
   local hLoteAct
   	...
   	if cOldLotArt == nil .or. aTmp[ _CLOTE ] == nil
		lChgLotArt         := .f.
	else 
   		lChgLotArt         := ( cOldLotArt != rtrim( aTmp[ _CLOTE ] ) )
   	end if
   ...
   if !empty( aGet ) .and. !empty( aGet[ _NIVA ] ) .and. !aTmp[ _LGASSUP ]
   ...
   */
   ...
   if aSeekProp( @cCodArt, @cValPr1, @cValPr2, D():Articulos( nView ), D():PropiedadesLineas( nView ) )
   		...
   		if uFieldEmpresa( "lGetLot")
   			MsgWait( cCodArt + cValPr1 + cValPr2, "Propiedades", 0.0001 )  //Para las propiedades seguidas
   		end if
      ...
      */
      ...
      if ( lChgCodArt )
         ...
         */
         ...
         aGet[ _CVALPR1 ]:cText( space( 20 ) )
         aGet[ _CVALPR2 ]:cText( space( 20 ) )

         if !empty( aTmp[ _CCODPR1 ] ) .and. !empty( aGet ) .and. !empty( aGet[ _CVALPR1 ] )
         ...
         if !empty( aTmp[ _CCODPR2 ] ) .and. !empty( aGet ) .and. !empty( aGet[ _CVALPR2 ] )
         ...
         */
         ...
         if !empty( aGet ) .and. !empty( aGet[ _CIMAGEN ] )
         ...
         if !empty( aGet ) .and. !empty( aGet[ _CCODPRV ] )
         ...
         aTmp[ _CREFPRV ]  := Padr( cRefPrvArt( aTmp[ _CREF ], ( D():Articulos( nView ) )->cPrvHab , D():ProveedorArticulo( nView ) ), 18 )
         ...
         if !empty( aGet ) .and. !empty( aGet[ _CVOLUMEN ] )
         ...
         */
         ...
         if !empty( cCodFam )
            ...
            if !empty( aGet ) .and. aGet[ _CCODFAM ] != nil
            ...
            if !empty( aGet ) .and. aGet[ _CGRPFAM ] != nil
            ...
            if !empty( aGet ) .and. aGet[ __CCODPRY ] != nil
         ...
         */
         ...
         if ( D():Articulos( nView ) )->lKitArt
            ...
            if lStockCompuestos( ( D():Articulos( nView ) )->Codigo, D():Articulos( nView ) )
               ...
               if !empty( aGet ) .and. aGet[ _NCTLSTK ] != nil
            ...
            /*
			Comprobamos que tenga varios kits-------------------------------------
	        */
	        ...
	        if Len( aListaKits ) > 0
	         	...
	         	if !empty( aGet ) .and. !empty( aGet[ _CIDPARKIT ] )
		            ...
		            aGet[ _CIDPARKIT ]:Show()

		            if !Empty( oSayParKit )
		            	oSayParKit:Show()
		           	end if
		            
		            aGet[ _CIDPARKIT ]:SetItems( aListaKits )
		            aGet[ _CIDPARKIT ]:Set( aListaKits[1] )
		            aGet[ _CIDPARKIT ]:Refresh()
         ...
         */
         ...
         if ( D():Articulos( nView ) )->nBulEnt != 0
            if !empty( aGet ) 
               aGet[ __NBULTOS ]:cText( ( D():Articulos( nView ) )->nBulEnt )
            else 
               aTmp[ __NBULTOS ]  := ( D():Articulos( nView ) )->nBulEnt 
            end if
         end if 
         ...
         */
         ...
         if !empty( aGet ) .and. !empty( aGet[ _DESCRIP ] )
         ...
         */
         ...
         if ( !empty( aTmp[ _CCODPR1 ] ) .or. !empty( aTmp[ _CCODPR2 ] ) ) .and. ( uFieldEmpresa( "lUseTbl" ) .and. ( nMode == APPD_MODE ) )
            ...
            if !empty( aTmp[ _CCODPR1 ] )
               ...
               if !empty( aGet ) .and. aGet[ _CVALPR1 ] != nil
                  aGet[ _CVALPR1 ]:show()
                  if lFocused
            ...
            if !empty( aTmp[ _CCODPR2 ] )
               ...
               if !empty( aGet ) .and. aGet[ _CVALPR2 ] != nil
                  aGet[ _CVALPR2 ]:show()
               end if
      ...
      */
      ...
      if ( lChgCodArt ) .or. ( cPrpArt != cOldPrpArt )
         ...
         /*
         Guardamos el C�digo de la familia
         */
        ...
        /*
		Cargamos el descuento general del cliente------------------------------ 
        */

        if uFieldempresa( "lDtoCliLin" )

			if !empty( aGet ) .and. !empty( aGet[ _NDTO ] )
             	aGet[ _NDTO ]:cText( retFld( aTmpFac[ _CCODCLI ], D():Clientes( nView ), "nDtoEsp" ) )
             	aTmp[ _NDTO ]     := retFld( aTmpFac[ _CCODCLI ], D():Clientes( nView ), "nDtoEsp" )
          	else
             	aTmp[ _NDTO ]     := retFld( aTmpFac[ _CCODCLI ], D():Clientes( nView ), "nDtoEsp" )
          	end if        	
         ...
         */
         ...
         /*
         Guardamos el precio del art�culo dependiendo de las propiedades--//
         */
         ...
         if nPrePro == 0
            nPrePro        := nRetPreArt( aTmp[ _NTARLIN ], aTmpFac[ _CDIVFAC ], aTmpFac[ _LIVAINC ], D():Articulos( nView ), dbfDiv, dbfKit, dbfIva, , if( !empty( aGet ), aGet[ _NTARLIN ], nil ), oNewImp )
         end if 
         ...
         ValidaMedicion( aTmp, aGet )
	      ...
	      //if Empty( aTmpFac[ _CNUMPED ] ) .and. Empty( aTmpFac[ _CNUMALB ] ) //Para que no modifique cuando venga de un pedido (TEFESA)
		      ...
		      */
		      ...
		      if !empty( hAtipica )
		      	...
		      	if hhaskey( hAtipica, "nTarifaFamilia" ) .and. hAtipica[ "nTarifaFamilia" ] > 0
                  	...
                  	aTmp[ _NPREUNIT ] := nRetPreArt( hAtipica[ "nTarifaFamilia" ], aTmpFac[ _CDIVFAC ], aTmpFac[ _LIVAINC ], D():Articulos( nView ), dbfDiv, dbfKit, dbfIva, , if( !empty( aGet ), aGet[ _NTARLIN ], nil ), oNewImp )
      ...
      */
         ...
         if ( D():Articulos( nView ) )->lLote
            ...
            //hLoteAct          := loteForCaducidad( aTmp[ _CREF ], aTmp[ _CALMLIN ] )

            if empty( cLote ) .and. uFieldempresa( "lLoaUltLot" )
               cLote          := ( D():Articulos( nView ) )->cLote
               //cLote             := hGet( hLoteAct, "lote" )
            //else
               //cLote 		  := Space( 64 )
            end if

            if !empty( aGet ) .and. !empty( aGet[ _CLOTE ] )
            ...
            if empty( dFechaCaducidad )
               dFechaCaducidad      := StocksModel():getFechaCaducidad( aTmp[ _CREF ], aTmp[ _CCODPR1 ], aTmp[ _CCODPR2 ], aTmp[ _CVALPR1 ], aTmp[ _CVALPR2 ], aTmp[ _CLOTE ] )
               //dFechaCaducidad      := hGet( hLoteAct, "caducidad" )
            end if 

            /*if empty( dFechaCaducidad )
              if ValType( hGet( hLoteAct, "caducidad" ) ) == "D"
	             dFechaCaducidad      := hGet( hLoteAct, "caducidad" )
	          else
	             dFechaCaducidad      := cTod( hGet( hLoteAct, "caducidad" ) )
	          end if
	        end if*/
            
            if !empty( aGet ) .and. !empty( aGet[ _DFECCAD ] )

               aGet[ _DFECCAD ]:Show()
               aGet[ _DFECCAD ]:cText( cTod( "" ) )

               if empty( aGet[ _DFECCAD ]:VarGet() ) .or. ( dFechaCaducidad != dOldFecCad )
                  if aTmp[ _LLOTE ] .and. !Empty( aGet[ _CLOTE ]:VarGet() )
                  	aGet[ _DFECCAD ]:cText( dFechaCaducidad )
                  	aGet[ _DFECCAD ]:lValid()
                  end if
                  aGet[ _DFECCAD ]:lValid()
               end if 
               ...
               if empty( aTmp[ _DFECCAD ] ) .and. uFieldempresa( "lLoaUltLot" )
            ...
            if !empty( aGet ) .and. !empty( aGet[ _CLOTE ] )
               aTmp[ _CLOTE ]    := Space( 14 )
               aGet[ _CLOTE ]:cText( Space( 14 ) )
               aGet[ _CLOTE ]:Hide()
            end if
         ...
         */
         ...
         do case
           case uFieldEmpresa( "nCosVta" ) < 2
              ...
              if nCosPro == 0
                 nCosPro        := nCosto( aTmp[ _CREF ], D():Articulos( nView ), dbfKit, .f., , D():Get( "Divisas", nView ), aTmpFac[ _CCODCLI ] )
              end if
           ...
           case uFieldEmpresa( "nCosVta" ) == 3
              ...
              nCosPro           := MaterialesProducidosLineasModel():getCosto(  aTmp[ _CREF ], aTmp[ _CCODPR1 ], aTmp[ _CCODPR2 ], aTmp[ _CVALPR1 ], aTmp[ _CVALPR2 ], aTmp[ _CLOTE ] )
         ...
         if aTmp[ _NCOSDIV ] == 0
         	...
         	if !empty( aGet ) .and. aGet[ _NCOSDIV ] != nil
            	aGet[ _NCOSDIV ]:Refresh()
         	end if
      ...
      */
      ...
      if ( lChgCodArt ) .or. ( lChgPrpArt ) .or. ( lChgLotArt )
         ...
         if !uFieldEmpresa( "lNStkAct" ) .and. oStkAct != nil .and. aTmp[ _NCTLSTK ] <= 1
            StocksModel():lPutStockActual( aTmp[ _CREF ], aTmp[ _CALMLIN ], aTmp[ _CCODPR1 ], aTmp[ _CCODPR2 ], aTmp[ _CVALPR1 ], aTmp[ _CVALPR2 ], aTmp[ _CLOTE ], oStkAct )
            oStkAct:Refresh()
         end if
      ...
      */
      ...
      if empty( aTmp[ _NPREUNIT ] ) .or. RolesModel():getRolCambiarPrecios( Auth():rolUuid() )
...
STATIC FUNCTION SaveDeta( aTmp, aTmpFac, aGet, oBrw, oDlg, oFld, oSayPr1, oSayPr2, oSayVp1, oSayVp2, bmpImage, nMode, oTotal, oStkAct, nStkAct, cCodArt, oBtn, oBtnSer, oSayLote, oSayParKit )
   ...
   /*
   Fin de modo de edici�n multiple
   */
   ...
   /*
   Nos aseguramos que la marca de impuestos incluidos est� igual que la de la cabecera
   */

   aTmp[ _LIVALIN ]  := aTmpFac[ _LIVAINC ]

   if empty( aTmp[ _CALMLIN ] ) .and. !empty( aGet ) .and. !empty( aGet[ _CALMLIN ] )
      MsgStop( "C�digo de almacen no puede estar vacio" )
      aGet[ _CALMLIN ]:SetFocus()
      return .f.
   end if

   if !empty( aGet ) .and. !empty( aGet[ _CALMLIN ] ) .and. !cAlmacen( aGet[ _CALMLIN ], dbfAlm )
      return .f.
   end if   
   ...
   if lPrecioMinimo( aTmp[ _CREF ], aTmp[ _NPREUNIT ], nMode, D():Articulos( nView ) )
      msgStop( "El precio de venta es inferior al precio m�nimo.")
      return .f.
   ...
   */
   ...
   // Modo de edici�n multiple los cambios afectan a todos los registros seleccionados
      ...
      /*if nTotUnd != 0 .and. !empty( oStkAct )
         ...
         do case
            case oStkAct:VarGet() - nTotUnd < 0
               ...
               if aTmp[ _LNOTVTA ]
                  MsgStop( "No hay stock suficiente, tenemos " + Alltrim( Trans( oStkAct:VarGet(), MasUnd() ) ) + " unidad(es) disponible(s)," + CRLF + "en Almac�n " + aTmp[ _CALMLIN ] + "." )
                  RETURN nil
               end if

               if aTmp[ _LMSGVTA ]
                  if !ApoloMsgNoYes( "No hay stock suficiente, tenemos " + Alltrim( Trans( oStkAct:VarGet(), MasUnd() ) ) + " unidad(es) disponible(s)," + CRLF + " en Almac�n " + aTmp[ _CALMLIN ] + ".", "�Desea continuar?" )
                     RETURN nil
                  end if
               end if
   ...
   do case
      case ValType( uTmpLin ) == "A"
         ...
         if empty( nStockActual )
            nStockActual   := StocksModel():nStockArticulo( uTmpLin[ _CREF ], uTmpLin[ _CALMLIN ], uTmpLin[ _CCODPR1 ], uTmpLin[ _CCODPR2 ], uTmpLin[ _CVALPR1 ], uTmpLin[ _CVALPR2 ], uTmpLin[ _CLOTE ] )
         end if

         nStockAct   		:= StocksModel():nGlobalStockArticulo( uTmpLin[ _CREF ] )
   ...
   if nTotalUnidades != 0
      ...
      do case
         case ( nStockActual - nTotalUnidades ) < 0
            ...
            if lNotVta
               if lMsg
                  msgStop( "No hay stock suficiente, tenemos " + Alltrim( Trans( nStockActual, MasUnd() ) ) + " unidad(es) disponible(s)," + CRLF + "en almac�n " + AllTrim( cCodigoAlmacen ) + " de este lote o propiedades." + CRLF + " Hay " + AllTrim( Trans( nStockAct, MasUnd() ) ) + " unidades totales seleccionando otras opciones."  )
               end if
               return .f.
            end if
            ...
            if lMsgVta
               if lMsg
                  Return ApoloMsgNoYes( "No hay stock suficiente, tenemos " + Alltrim( Trans( nStockActual, MasUnd() ) ) + " unidad(es) disponible(s)," + CRLF + " en almac�n " + AllTrim( cCodigoAlmacen ) + " de este lote o propiedades." + CRLF + " Hay " + AllTrim( Trans( nStockAct, MasUnd() ) ) + " unidades totales seleccionando otras opciones." , "�Desea continuar?" )
               else
                  Return .f.
               end if
            end if
         ...
         case ( nStockAct - nTotalUnidades ) < nStockMinimo( cCodigoArticulo, cCodigoAlmacen, nView )
            ...
            if lMsgVta
               if lMsg
                  Return ApoloMsgNoYes( "El stock est� por debajo del m�nimo.", "�Desea continuar?" )
               else
                  Return .f.
               end if
            end if
...
STATIC FUNCTION lMoreIva( nCodIva )
   ...
   MsgStop( "Factura con m�s de 3 tipos de " + cImp() )
...
/*
Finaliza la transacci�n de datos
*/
...
STATIC FUNCTION EndTrans( aTmp, aGet, oBrw, oBrwDet, oBrwPgo, aNumAlb, nMode, oDlg )
   ...
   */
   ...
   if empty( aTmp[ _CDNICLI ] )
      msgStop( "D.N.I. / C.I.F. de cliente no puede estar vac�o." )
      if !empty( aGet[ _CDNICLI ] )
   ...
   if empty( aTmp[ _CDIRCLI ] )
      msgStop( "Domicilio de cliente no puede estar vac�o." )
      if !empty( aGet[ _CDIRCLI ] )
   ...
   if nTotFac > 0 
	...
	if lLimitDaysPendiente( aTmp[ _CCODCLI ] ) .and. ( aTmp[ _CCODPAGO ] != "00" .and. aTmp[ _CCODPAGO ] != "CO" )
		msgStop( "Este cliente supera el limite de d�as de facturas pendientes." )
		if !empty( aGet[ _CCODCLI ] )
	        aGet[ _CCODCLI ]:SetFocus()
	    end if   
	    return .f.
   ...
   if empty( aTmp[ _CCODOBR ] ) .and. lObras() .and. ( ClientesDireccionesModel():nCount( aTmp[ _CCODCLI ] ) > 0 )
   ...
   if lPasNil() .and. ( nMode == APPD_MODE .or. nMode == DUPL_MODE )
      ...
      while !( dbfTmpLin )->( eof() )
         ...
         if !( dbfTmpLin )->lControl .and. ( dbfTmpLin )->nPreUnit == 0 .and. !( dbfTmpLin )->lKitPrc
            if !ApoloMsgNoYes( "El art�culo " + Rtrim( ( dbfTmpLin )->cRef ) + " - " + Rtrim( Descrip( dbfTmpLin ) ) + " no esta valorado.", "� Desea continuar archivando la factura ?" )
               return .f.
            end if
         end if
   ...
   BEGIN SEQUENCE*/
      ...
      */
      ...
      /*
	   Comprobamos articulos que no esten en las atipicas para incluirlos----------
	   */
	   ...
	   if uFieldempresa( "lAddAtp" )
	      ...
	      while !( dbfTmpLin )->( Eof() )
	        ...
	        if !Empty( ( dbfTmpLin )->cRef )
		         ...
		         AtipicasModel():AddArticulo( {   "cCodCli"   => cCodCli,;
		                                          "cCodArt"   => ( dbfTmpLin )->cRef,;
		                                          "cNomArt"   => ( dbfTmpLin )->cDetalle,;
		                                          "nPreUnit"  => ( dbfTmpLin )->nPreUnit } )
      ...
      */
      ...
      oMsgText( "Finalizamos la transacci�n" )
...
Static Function ExportaEDICabecera( hFicheroFactura )
   ...
   cCabecera         += Padr( ( D():FacturasClientes( nView ) )->cPobCli, 35 )                                                                      // 425. Poblaci�n del receptor de la factura
   ...
   cCabecera         += Padr( uFieldEmpresa( "cPoblacion" ), 35 )                                                                // 556. Poblaci�n del emisor de la factura
...
Static Function ExportaEDILinea( nNumeroLinea, hFicheroFactura )
   ...
   cLinea            += Padr( RetFld( ( D():FacturasClientesLineas( nView ) )->cRef, D():Articulos( nView ), "Codebar" ), 15 ) //Padr( ( D():FacturasClientesLineas( nView ) )->cRef, 15 )    // 76. C�digo articulo / Codigo de barras
   cLinea            += Padr( if( !empty( ( D():FacturasClientesLineas( nView ) )->cDetalle ), ( D():FacturasClientesLineas( nView ) )->cDetalle, ( D():FacturasClientesLineas( nView ) )->mLngDes ), 35 )  // 111. Descripci�n articulo
   ...
   cLinea            += Padr( "", 15 )                                                                                           // 172. Codigo unidad expedici�n
   ...
   cLinea            += Padl( Trans( if( ( D():FacturasClientes( nView ) )->lRecargo, ( D():FacturasClientesLineas( nView ) )->nReq, 0 ), cPicReq() ), 6 )                    // 291. % Recargo de eqivalencia
...
Static Function ExportaEDIRecibo( nNumeroRecibo, hFicheroFactura )
   ...
   cRecibo           += Padr( Dtos( ( D():FacturasClientesCobros( nView ) )->dFecVto ), 8 )                                                               // 76. C�digo articulo
            ...
            if empty( ( D():FacturasClientesCobros( nView ) )->cTipRec )
               ...
               if !empty( cCodigoXmlPago( ( D():FacturasClientesCobros( nView ) )->cCodPgo, D():FormasPago( nView ) ) )
                  ...
                  */
                  ...
                  oTree:Add( "Recibo : " + ( D():FacturasClientesCobros( nView ) )->cSerie + "/" + AllTrim( str( ( D():FacturasClientesCobros( nView ) )->nNumFac ) ) + "/" + ( D():FacturasClientesCobros( nView ) )->cSufFac + "-" + str( ( D():FacturasClientesCobros( nView ) )->nNumRec ) + " no tiene C�digo de facturae." )
...
Static Function FacCliExcelImport()
   ...
   if File( cFileExcel )
      ...
      msgStop( "Proceso de importaci�n finalizazo." )
      ...
      BEGIN SEQUENCE
         ...
         for n := 2 to ( nActiveSheetRows - 1 )
            ...
            if !lCancelImportacion
               ...
               oNode                                        := oTreeImportacion:Add( "Procesando operaci�n " + lTrim( str( n ) ) )
...
static function FacturaImportacion( oTreeImportacion )
   ...
   oTreeImportacion:Select( oTreeImportacion:Add( "Proceso de importaci�n finalizado" ) )
      ...
      if ( dbfSatCliT )->lEstado
         ...
         */
         ...
         if ( dbfSatCliL )->( dbSeek( cNumsat ) )
            ...
            ( dbfTmpLin )->( dbAppend() )
            cDesAlb                    := ""
            cDesAlb                    += "S.A.T. N� " + ( dbfSatCliT )->cSerSat + "/" + AllTrim( str( ( dbfSatCliT )->nNumSat ) ) + "/" + ( dbfSatCliT )->cSufSat
...
//---------------------------------------------------------------------------//
/*
Devuelve el valor del impuestos de un art�culo
*/
...
//---------------------------------------------------------------------------//
/*
Devuelve el valor del Req de un art�culo
*/
...
FUNCTION browseFacturasClientes( oGet, oIva, nView )
   ...
   aCbxOrd        := { "N�mero", "Fecha", "Cliente", "Nombre" }
...
FUNCTION nTotNFacCli( uDbf )
   ...
   do case
      case ValType( uDbf ) == "A"
        ...
        nTotUnd  := NotBulto( uDbf[ __NBULTOS ] )
...
FUNCTION rxFacCli( cPath, cDriver )
   ...
   */
   ...
   if !( cFacCliT )->( neterr() )
      ...
      msgStop( "Imposible abrir en modo exclusivo la tabla de N�meros de series de facturas de clientes" )
   end if
   ...
   if !( cFacCliT )->( neterr() )
      ...
      msgStop( "Imposible abrir en modo exclusivo la tabla de situaci�n de facturas de clientes" )
   end if
...
function aFacCliEst()
   ...
   aAdd( aFacCliEst, { "cSitua",  "C",  140,  0, "Situaci�n" ,                   "",                   "", "( cDbfCol )", nil } )
   aAdd( aFacCliEst, { "dFecSit", "D",    8,  0, "Fecha de la situaci�n" ,       "",                   "", "( cDbfCol )", nil } )
   aAdd( aFacCliEst, { "tFecSit", "C",    6,  0, "Hora de la situaci�n" ,        "",                   "", "( cDbfCol )", nil } )
...
function aIncFacCli()
   ...
   aAdd( aIncFacCli, { "nNumFac", "N",    9,  0, "N�mero de factura" ,             "'999999999'",        "", "( cDbfCol )" } )
   ...
   aAdd( aIncFacCli, { "mDesInc", "M",   10,  0, "Descripci�n de la incidencia" ,  "",                   "", "( cDbfCol )" } )
   aAdd( aIncFacCli, { "lListo",  "L",    1,  0, "L�gico de listo" ,               "",                   "", "( cDbfCol )" } )
   aAdd( aIncFacCli, { "lAviso",  "L",    1,  0, "L�gico de Aviso" ,               "",                   "", "( cDbfCol )" } )
...
function aFacCliDoc()
   ...
   aAdd( aFacCliDoc, { "nNumFac", "N",    9,  0, "N�mero de factura" ,               "'999999999'",        "", "( cDbfCol )" } )
...
function aColFacCli()
   ...
   aAdd( aColFacCli, { "cRef"       ,"C", 18, 0, "Referencia del art�culo"                , "Articulo",                    "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "cDetalle"   ,"C",250, 0, "Detalle del art�culo"                   , "DescripcionArticulo",         "", "( cDbfCol )", nil } )
   ...
   aAdd( aColFacCli, { "lControl"   ,"L",  1, 0, "L�gico linea de control"                , "LineaControl",                "", "( cDbfCol )", nil } )
   ...
   aAdd( aColFacCli, { "cCodAge"    ,"C",  3, 0, "C�digo del agente"                      , "Agente",                      "", "( cDbfCol )", {|| cCodigoAgente() } } )
   aAdd( aColFacCli, { "nComAge"    ,"N",  6, 2, "Comisi�n del agente"                    , "ComisionAgente",              "", "( cDbfCol )", nil } )
   ...
   aAdd( aColFacCli, { "mLngDes"    ,"M", 10, 0, "Descripci�n de art�culo sin codificar"  , "DescripcionAmpliada",         "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "cCodAlb"    ,"C", 12, 0, "N�mero del albar�n de procedencia"      , "",                            "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "dFecAlb"    ,"D",  8, 0, "Fecha del albar�n de procedencia"       , "",                            "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "lTotLin"    ,"L",  1, 0, "Valor L�gico para enviar el documento"  , "LineaTotal",                  "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "lImpLin"    ,"L",  1, 0, "l�nea no imprimible"                    , "LineaNoImprimible",           "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "cCodPr1"    ,"C", 20, 0, "C�digo de primera propiedad"            , "CodigoPropiedad1",            "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "cCodPr2"    ,"C", 20, 0, "C�digo de segunda propiedad"            , "CodigoPropiedad2",            "", "( cDbfCol )", nil } )
   ...
   aAdd( aColFacCli, { "nFacCnv"    ,"N", 16, 6, "Factor de conversi�n de la compra"      , "FactorConversion",            "", "( cDbfCol )", nil } )
   ...
   aAdd( aColFacCli, { "nNumLin"    ,"N",  4, 0, "N�mero de la l�nea"                     , "NumeroLinea",                 "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "nCtlStk"    ,"N",  1, 0, "Tipo de stock de la l�nea"              , "TipoStock",                   "", "( cDbfCol )", nil } )
   ...
   aAdd( aColFacCli, { "cAlmLin"    ,"C", 16, 0, "C�digo de almac�n"                      , "Almacen",                     "", "( cDbfCol )", {|| Application():codigoAlmacen() } } )
   aAdd( aColFacCli, { "lIvaLin"    ,"L",  1, 0, cImp() + " incluido"                     , "LineaImpuestoIncluido",       "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "cCodImp"    ,"C",  3, 0, "C�digo del impuesto especial"           , "ImpuestoEspecial",            "", "( cDbfCol )", nil } )
   ...
   aAdd( aColFacCli, { "cLote"      ,"C", 64, 0, "N�mero de lote"                         , "Lote",                        "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "dFecCad"    ,"D",  8, 0, "Fecha de caducidad"                     , "FechaCaducidad",              "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "lKitArt"    ,"L",  1, 0, "l�nea con escandallo"                   , "LineaEscandallo",             "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "lKitChl"    ,"L",  1, 0, "l�nea pertenciente a escandallo"        , "LineaPerteneceEscandallo",    "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "lKitPrc"    ,"L",  1, 0, ""                                       , "LineaEscandalloPrecio",       "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "nMesGrt"    ,"N",  2, 0, "Meses de garant�a"                      , "MesesGarantia",               "", "( cDbfCol )", nil } )
   ...
   aAdd( aColFacCli, { "cCodTip"    ,"C",  4, 0, "C�digo del tipo de art�culo"            , "TipoArticulo",                "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "mNumSer"    ,"M", 10, 0, ""                                       , "",                            "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "cCodFam"    ,"C", 16, 0, "C�digo de familia"                      , "Familia",                     "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "cGrpFam"    ,"C",  3, 0, "C�digo del grupo de familia"            , "GrupoFamilia",                "", "( cDbfCol )", nil } )
   ...
   aAdd( aColFacCli, { "cCodPrv"    ,"C", 12, 0, "C�digo del proveedor"                   , "Proveedor",                   "", "( cDbfCol )", nil } )
   ...
   aAdd( aColFacCli, { "nPuntos"    ,"N", 15, 6, "Puntos del art�culo"                    , "",                            "", "( cDbfCol )", nil } )
   ...
   aAdd( aColFacCli, { "lAlquiler"  ,"L",  1, 0, "L�gico de l�nea de alquiler"            , "Alquiler",                    "", "( cDbfCol )", nil } )
   ...
   aAdd( aColFacCli, { "nNumMed"    ,"N",  1, 0, "N�mero de mediciones"                   , "NumeroMedidiones",            "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "nMedUno"    ,"N", 16, 6, "Primera unidad de medici�n"             , "Medicion1",                   "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "nMedDos"    ,"N", 16, 6, "Segunda unidad de medici�n"             , "Medicion2",                   "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "nMedTre"    ,"N", 16, 6, "Tercera unidad de medici�n"             , "Medicion3",                   "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "nTarLin"    ,"N",  1, 0, "Tarifa de precio aplicada"              , "NumeroTarifa",                "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "lImpFra",   "L",   1, 0, "L�gico de imprimir frase publicitaria"  , "",                            "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "cCodPry",   "C",   4, 0, "C�digo del proyecto"                    , "Proyecto",                    "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "cTxtFra",   "C", 250, 0, "Texto de la frase publicitaria"         , "",                            "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "Descrip",   "M",  10, 0, "Descripci�n larga"                      , "DescripcionTecnica",          "", "( cDbfCol )", nil } )
   ...
   aAdd( aColFacCli, { "cNumPed"   ,"C",  12, 0, "N�mero del pedido"                      , "NumeroPedido",                "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "dFecFac"   ,"D",   8, 0, "Fecha de factura"                       , "Fecha",                       "", "( cDbfCol )", {|| GetSysDate() } } )
   aAdd( aColFacCli, { "cSuPed"    ,"C",  50, 0, "Su pedido (desde albar�n)"              , "",                            "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "cNumSat"   ,"C",  12, 0, "N�mero del SAT"                         , "NumeroSAT",                   "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "dFecUltCom","D",   8, 0, "Fecha �ltima compra"                    , "FechaUltimaVenta",            "", "( cDbfCol )", nil } ) 
   aAdd( aColFacCli, { "cCodCli"   ,"C",  12, 0, "C�digo del cliente"                     , "Cliente",                     "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "lFromAtp"  ,"L",   1, 0, ""                                       , "",                            "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "nUniUltCom","N",  16, 6, "Unidades �ltima compra"                 , "UnidadesUltimaVenta",         "", "( cDbfCol )", nil } ) 
   aAdd( aColFacCli, { "nBultos",   "N",  16, 6, "Numero de bultos en l�neas"             , "Bultos",                      "", "( cDbfCol )", nil } )
   ...
   aAdd( aColFacCli, { "cCtrCoste", "C",   9, 0, "C�digo del centro de coste"             , "",                            "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "lLabel"   , "L",   1, 0, "L�gico para marca de etiqueta"          , "LogicoEtiqueta",              "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "nLabel"   , "N",   6, 0, "Unidades de etiquetas a imprimir"       , "NumeroEtiqueta",              "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "cCodObr"  , "C",  10, 0, "C�digo de la direcci�n"                 , "Direccion",                   "", "( cDbfCol )", nil } )
   ...
   aAdd( aColFacCli, { "nPosPrint", "N",   4, 0, "Posici�n de impresi�n"                  , "PosicionImpresion",           "", "( cDbfCol )", nil } )
   ...
   aAdd( aColFacCli, { "nNumKit",   "N",   4, 0, "N�mero de l�nea de escandallo"          , "",                            "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "id_tipo_v", "N",  16, 0, "Identificador tipo de venta"            , "IdentificadorTipoVenta",      "", "( cDbfCol )", nil } )
   aAdd( aColFacCli, { "nRegIva",   "N",   1, 0, "R�gimen de " + cImp()                   , "TipoImpuesto",                "", "( cDbfCol )", nil } ) 
   aAdd( aColFacCli, { "nPrcUltCom","N",  16, 6, "Precio �ltima compra"                   , "PrecioUltimaVenta",           "", "( cDbfCol )", nil } ) 
   aAdd( aColFacCli, { "lValidado", "L",   1, 0, "L�gico validado con consolidaci�n" 	  , "LogicoValidado",              "", "( cDbfCol )", .f. } )
   aAdd( aColFacCli, { "Uuid", 		"C",  40, 0, "Identificador �nico" 	  				  , "Uuid",              		   "", "( cDbfCol )", {|| win_uuidcreatestring() } } )
...
function aItmFacCli()
   ...
   aAdd( aItmFacCli, {"nNumFac"     ,"N",  9, 0, "N�mero de la factura" ,                                      "Numero",                      "", "( cDbf )", nil } )
   ...
   aAdd( aItmFacCli, {"cTurFac"     ,"C",  6, 0, "Sesi�n de la factura" ,                                      "Turno",                       "", "( cDbf )", {|| cCurSesion( nil, .f.) } } )
   aAdd( aItmFacCli, {"dFecFac"     ,"D",  8, 0, "Fecha de la factura" ,                                       "Fecha",                       "", "( cDbf )", {|| GetSysDate() } } )
   aAdd( aItmFacCli, {"cCodCli"     ,"C", 12, 0, "C�digo del cliente" ,                                        "Cliente",                     "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"cCodAlm"     ,"C", 16, 0, "C�digo de almac�n" ,                                         "Almacen",                     "", "( cDbf )", {|| Application():codigoAlmacen() } } )
   aAdd( aItmFacCli, {"cCodCaj"     ,"C",  3, 0, "C�digo de caja" ,                                            "Caja",                        "", "( cDbf )", {|| Application():CodigoCaja() } } )
   ...
   aAdd( aItmFacCli, {"cPobCli"     ,"C",200, 0, "Poblaci�n del cliente" ,                                     "PoblacionCliente",            "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"cPrvCli"     ,"C",100, 0, "Provincia del cliente" ,                                     "ProvinciaCliente",            "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"nCodProV"    ,"N",  2, 0, "N�mero de provincia cliente" ,                               "",                            "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"cPosCli"     ,"C", 15, 0, "C�digo postal del cliente" ,                                 "CodigoPostalCliente",         "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"cDniCli"     ,"C", 30, 0, "NIF del cliente" ,                                           "DniCliente",                  "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"lModCli"     ,"L",  1, 0, "L�gico de modificar datos del cliente" ,                     "ModificarDatosCliente",       "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"lMayor"      ,"L",  1, 0, "L�gico de mayorista" ,                                       "",                            "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"nTarifa"     ,"N",  1, 0, "Tarifa de precio aplicada" ,                                 "NumeroTarifa",                "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"cCodAge"     ,"C",  3, 0, "C�digo del agente" ,                                         "Agente",                      "", "( cDbf )", {|| AccessCode():cAgente } } )
   aAdd( aItmFacCli, {"cCodRut"     ,"C",  4, 0, "C�digo de la ruta" ,                                         "Ruta",                        "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"cCodTar"     ,"C",  5, 0, "C�digo de la tarifa" ,                                       "Tarifa",                      "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"cCodObr"     ,"C", 10, 0, "C�digo de la Direcci�n" ,                                    "Direccion",                   "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"nPctComAge"  ,"N",  6, 2, "Porcentaje de Comisi�n del agente" ,                         "ComisionAgente",              "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"lLiquidada"  ,"L",  1, 0, "L�gico de la factura pagada" ,                               "Pagada",                      "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"lContab"     ,"L",  1, 0, "L�gico de la factura contabilizada" ,                        "Contabilizada",               "", "( cDbf )", nil } )
   ...
   aAdd( aItmFacCli, {"lImpAlb"     ,"L",  1, 0, "L�gico si la factura se importe de facturas" ,               "ImportadaAlbaran",            "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"cCondent"    ,"C",100, 0, "Condici�n de entrada" ,                                      "CondicionEntrada",            "", "( cDbf )", nil } )
   ...
   aAdd( aItmFacCli, {"cCodPago"    ,"C",  2, 0, "C�digo del tipo de pago" ,                                   "Pago",                        "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"nBultos"     ,"N",  5, 0, "N�mero de bultos" ,                                          "Bultos",                      "", "( cDbf )", nil } )
   ...
   aAdd( aItmFacCli, {"cNumAlb"     ,"C", 12, 0, "N�mero de albar�n" ,                                         "NumeroAlbaran",               "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"cNumPed"     ,"C", 12, 0, "N�mero de pedido" ,                                          "NumeroPedido",                "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"cNumPre"     ,"C", 12, 0, "N�mero de presupuesto" ,                                     "NumeroPresupuesto",           "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"cNumSat"     ,"C", 12, 0, "N�mero de S.A.T." ,                                          "NumeroSAT",                   "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"nTipoFac"    ,"N",  1, 0, "" ,                                                          "",                            "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"cDtoEsp"     ,"C", 50, 0, "Descripci�n de porcentaje de descuento especial" ,           "DescripcionDescuento1",       "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"nDtoEsp"     ,"N", 10, 6, "Porcentaje de descuento especial" ,                          "PorcentajeDescuento1",        "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"cDpp"        ,"C", 50, 0, "Descripci�n de porcentaje de descuento por pronto pago",     "DescripcionDescuento2",       "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"nDpp"        ,"N", 10, 6, "Porcentaje de descuento por pronto pago" ,                   "PorcentajeDescuento2",        "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"cDtoUno"     ,"C", 25, 0, "Descripci�n de porcentaje de descuento personalizado",       "DescripcionDescuento3",       "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"nDtoUno"     ,"N", 10, 6, "Porcentaje de descuento por descuento personalizado" ,       "PorcentajeDescuento3",        "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"cDtoDos"     ,"C", 25, 0, "Descripci�n de porcentaje de descuento personalizado" ,      "DescripcionDescuento4",       "", "( cDbf )", nil } )
   ...
   aAdd( aItmFacCli, {"lRecargo"    ,"L",  1, 0, "L�gico para recargo" ,                                       "RecargoEquivalencia",         "", "( cDbf )", nil } )  
   aAdd( aItmFacCli, {"cRemitido"   ,"C", 50, 0, "Campo de remitido" ,                                         "Remitido",                    "", "( cDbf )", nil } )  
   aAdd( aItmFacCli, {"lIvaInc"     ,"L",  1, 0, "L�gico " + cImp() + " incluido" ,                            "ImpuestosIncluidos",          "", "( cDbf )", {|| uFieldEmpresa( "lIvaInc" ) } } )
   aAdd( aItmFacCli, {"lSndDoc"     ,"L",  1, 0, "L�gico para documento enviado" ,                             "Envio",                       "", "( cDbf )", {|| .t. } } )                       
   aAdd( aItmFacCli, {"cDivFac"     ,"C",  3, 0, "C�digo de la divisa" ,                                       "Divisa",                      "", "( cDbf )", {|| cDivEmp() } } )
   ...
   aAdd( aItmFacCli, {"cRetMat"     ,"C", 20, 0, "Matr�cula" ,                                                 "Matricula",                   "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"cNumDoc"     ,"C", 13, 0, "" ,                                                          "",                            "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"nRegIva"     ,"N",  1, 0, "R�gimen de " + cImp() ,                                      "TipoImpuesto",                "", "( cDbf )", nil } ) 
   aAdd( aItmFacCli, {"cCodPro"     ,"C",  9, 0, "C�digo de proyecto en contabilidad" ,                        "ProyectoContable",            "", "( cDbf )", nil } ) 
   aAdd( aItmFacCli, {"cDocOrg"     ,"C", 10, 0, "N�mero del documento origen" ,                               "",                            "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"nNumLiq"     ,"N",  9, 0, "N�mero liquidaci�n",                                         "NumeroLiquidacion",           "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"cSufLiq"     ,"C",  2, 0, "Sufijo de la liquidaci�n",                                   "SufijoLiquidacion",           "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"nImpLiq"     ,"N", 16, 6, "Importe liquidaci�n",                                        "ImporteLiquidacion",          "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"dFecLiq"     ,"D",  8, 0, "Fecha liquidaci�n",                                          "FechaLiquidacion",            "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"cCodTrn"     ,"C",  9, 0, "C�digo del transportista" ,                                  "Transportista",               "", "( cDbf )", nil } )
   ...
   aAdd( aItmFacCli, {"nTipRet"     ,"N",  1, 0, "Tipo de retenci�n ( 1. Base / 2. Base+IVA )",                "TipoRetencion",               "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"nPctRet"     ,"N",  6, 2, "Porcentaje de retenci�n",                                    "PorcentajeRetencion",         "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"cCodUsr"     ,"C",  3, 0, "C�digo de usuario",                                          "Usuario",                     "", "( cDbf )", {|| Auth():Codigo() } } )
   aAdd( aItmFacCli, {"dFecCre"     ,"D",  8, 0, "Fecha de creaci�n/modificaci�n del documento",               "FechaCreacion",               "", "( cDbf )", {|| Date() } } )
   aAdd( aItmFacCli, {"cTimCre"     ,"C",  5, 0, "Hora de creaci�n/modificaci�n del documento",                "HoraCreacion",                "", "( cDbf )", {|| Time() } } )
   aAdd( aItmFacCli, {"cCodGrp"     ,"C",  4, 0, "C�digo de grupo de cliente" ,                                "GrupoCliente",                "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"lImprimido"  ,"L",  1, 0, "L�gico de imprimido" ,                                       "Imprimido",                   "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"dFecImp"     ,"D",  8, 0, "�ltima fecha de impresi�n" ,                                 "FechaImpresion",              "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"cHorImp"     ,"C",  5, 0, "Hora de la �ltima impresi�n" ,                               "HoraImpresion",               "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"cCodDlg"     ,"C",  2, 0, "C�digo Delegaci�n" ,                                         "Delegacion",                  "", "( cDbf )", {|| Application():CodigoDelegacion() } } )
   aAdd( aItmFacCli, {"nDtoAtp"     ,"N",  6, 2, "Porcentaje de descuento at�pico",                            "DescuentoAtipico",            "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"nSbrAtp"     ,"N",  1, 0, "Lugar donde aplicar dto at�pico",                            "LugarAplicarDescuentoAtipico","", "( cDbf )", nil } )
   ...
   aAdd( aItmFacCli, {"lAlquiler"   ,"L",  1,  0, "L�gico de alquiler",                                        "Alquiler",                    "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"lPayCli"     ,"L",  1,  0, "L�gico a pagar por el cliente",                             "",                            "", "( cDbf )", nil } )
   ...
   aAdd( aItmFacCli, {"lExpEdi"     ,"L",  1,  0, "L�gico de factura exportada a EDI",                         "ExportadaEDI",                "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"dFecEdi"     ,"D",  8,  0, "Fecha exportaci�n a EDI",                                   "FechaExportadaEDI",           "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"cHorEdi"     ,"C",  5,  0, "Hora exportaci�n a EDI",                                    "HoraExportadaEDI",            "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"cSuAlb"      ,"C", 25,  0, "Referencia a su albar�n",                                   "",                            "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"lExpFac"     ,"L",  1,  0, "L�gico de factura exportada a Facturae",                    "ExportadoFacturae",           "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"cTlfCli"     ,"C", 20,  0, "Tel�fono del cliente" ,                                     "TelefonoCliente",             "", "( cDbf )", nil } )
   ...
   aAdd( aItmFacCli, {"cNFC"        ,"C", 20,  0, "C�digo NFC" ,                                               "NFC",                         "", "( cDbf )", nil } )
   ...
   aAdd( aItmFacCli, {"cPaisIBAN"   ,"C",  2,  0, "Pa�s IBAN de la cuenta bancaria del cliente",               "CuentaIBAN",                  "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"cCtrlIBAN"   ,"C",  2,  0, "D�gito de control IBAN de la cuenta bancaria del cliente",  "DigitoControlIBAN",           "", "( cDbf )", nil } )
   ...
   aAdd( aItmFacCli, {"cDigBnc"     ,"C",  2,  0, "D�gito de control de la cuenta bancaria del cliente" ,      "DigitoControlCuenta",         "", "( cDbf )", nil } )
   ...
   aAdd( aItmFacCli, {"lOperPV"     ,"L", 1,   0, "L�gico para operar con punto verde" ,                       "OperarPuntoVerde",            "", "( cDbf )", {|| .f. } } )
   aAdd( aItmFacCli, {"lRECC"       ,"L", 1,   0, "Acogida al R�gimen especial del criterio de caja",          "AcogidaRECC",                 "", "( cDbf )", {|| .f. } } )
   aAdd( aItmFacCli, {"cCodPry"     ,"C", 4,   0, "C�digo del proyecto",                                       "Proyecto",                    "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"nDtoTarifa"  ,"N", 6,   2, "Descuentos de tarifa",                                      "DescuentoTarifa",             "", "( cDbf )", nil } )
   aAdd( aItmFacCli, {"lMail"       ,"L", 1,   0, "L�gico para enviar mail" ,                                  "EnviarMail",                  "", "( cDbf )", nil } )
   ...
   aAdd( aItmFacCli, {"cCtrCoste"   ,"C", 9,   0, "C�digo del centro de coste" ,                               "CentroCoste",                 "", "( cDbf )", nil } )
   ...
   aAdd( aItmFacCli, { "lFirma"     ,"L", 1,   0, "Confirmaci�n firma" ,                                       "ConfirmaFirma",           	  "", "( cDbf )", nil } )
...
Function aSerFacCli()
   ...
   aAdd( aColFacCli,  { "nNumLin",     "N",  4,   0, "N�mero de la l�nea",               "'9999'",            "", "( cDbfCol )" } )
   aAdd( aColFacCli,  { "cRef",        "C", 18,   0, "Referencia del art�culo",          "",                  "", "( cDbfCol )" } )
   aAdd( aColFacCli,  { "cAlmLin",     "C", 16,   0, "Almac�n del art�culo",             "",                  "", "( cDbfCol )" } )
   aAdd( aColfacCli,  { "lUndNeg",     "L",  1,   0, "L�gico de unidades en negativo",   "",                  "", "( cDbfCol )" } )
   aAdd( aColFacCli,  { "cNumSer",     "C", 30,   0, "N�mero de serie",                  "",                  "", "( cDbfCol )" } )
...
FUNCTION nTotFacCli( cFactura, cFacCliT, cFacCliL, cIva, cDiv, cFacCliP, aTmp, cDivRet, lPic, lExcCnt, lNeto )
   ...
   */
   ...
   public aTotIva	 := {{ 	"porcentajeiva" => nil,;
							"logrecargo"	=> .f.,;
							"porcentajere"	=> nil,;
							"bruto"			=> nil,;
							"neto"			=> nil,;
...
FUNCTION nPntUFacCli( dbfTmpLin, nDec, nVdv, lPntVer )
   	...
   	DEFAULT nDec      	:= nDouDiv()
   	DEFAULT nVdv      	:= 1
   	DEFAULT lPntVer 	:= FacturasClientesModel():getField( ( dbfTmpLin )->cSerie, ( dbfTmpLin )->nNumFac, ( dbfTmpLin )->cSufFac, "lOperPV" )
...
//---------------------------------------------------------------------------//
/*
Funcion que nos indica si una factura est� rectificada o no--------------------
*/
...
CLASS TFacturasClientesSenderReciver FROM TSenderReciverItem
   ...
   Data cFileNameFacturas 
   Data cFileNameAnticipos
      ...
      if ::oSender:lUnZipData( cPatIn() + aFiles[ m, 1 ] )
         ...
         */
         ...
         if file( cPatSnd() + "FacCliT.Dbf" ) .and. file( cPatSnd() + "FacCliL.Dbf" ) .and. file( cPatSnd() + "FacCliP.Dbf" )
            ...
            USE ( cPatEmp() + "CLIENT.DBF" ) NEW VIA ( cDriver() ) SHARED ALIAS ( cCheckArea( "CLIENT", @dbfCliente ) )
            ...
            while ( tmpFacCliT )->( !eof() )
               ...
               if ::validateRecepcion( tmpFacCliT, dbfFacCliT )
                  ...
                  ::oSender:SetText( "A�adida factura : " + cTextoFactura )
                  ...
                  ::oSender:setText( "A�adidas lineas de facturas : " + cTextoFactura )
            ...
            */
            ...
            while ( tmpFacCliP )->( !eof() )
               ...
               if ::validateRecepcionRecibo( tmpFacCliP, dbfFacCliP )
                  ...
                  ::oSender:SetText( "A�adido recibo : " + cTextoRecibo )
               ...
               while ( tmpAntCliT )->( !eof() )
                  ...
                  */
                  ...
                  if !( dbfAntCliT )->( dbSeek( ( tmpAntCliT )->CSERANT + str( ( tmpAntCliT )->NNUMANT ) + ( tmpAntCliT )->CSUFANT ) )
                     ...
                     ::oSender:SetText( "A�adido : " + ( tmpAntCliT )->cSerAnt + "/" + AllTrim( str( ( tmpAntCliT )->NNUMANT ) ) + "/" + AllTrim( ( tmpAntCliT )->CSUFANT ) + "; " + Dtoc( ( tmpAntCliT )->DFECANT ) + "; " + Alltrim( ( tmpAntCliT )->cCodCli ) + "; " + ( tmpAntCliT )->cNomCli )
...
Method ProcessFrq() CLASS TFacturasClientesSenderReciver
   ...
   if empty( uFieldempresa( "cCodCliFrq" ) )
      ::oSender:SetText( "Debe cumplimentar el c�digo de cliente en la configuraci�n de la empresa." )
      Return .f.
   end if 

   if empty( uFieldempresa( "cCodPrvFrq" ) )
      ::oSender:SetText( "Debe cumplimentar el c�digo de proveedor en la configuraci�n de la empresa." )
      Return .f.
   end if 
...
METHOD validateRecepcion( tmpFacCliT, dbfFacCliT ) CLASS TFacturasClientesSenderReciver
   ...
   ::cErrorRecepcion       := "Pocesando factura de cliente n�mero " + ( dbfFacCliT )->cSerie + "/" + alltrim( Str( ( dbfFacCliT )->nNumFac ) ) + "/" + alltrim( ( dbfFacCliT )->cSufFac ) + " "
   ...
   /*
   Lo hemos condicionado para el caso de Marpicon
   Esto lo quito por problemas en marpicon con las tablets---------------------
   */

   	/*if ConfiguracionesEmpresaModel():getLogic( 'lDesFacExt', .f. )
		...
		if !( ( dbfFacCliT )->( dbSeek( ( tmpFacCliT )->cSerie + Str( ( tmpFacCliT )->nNumFac ) + ( tmpFacCliT )->cSufFac ) ) )
   		...
   		if dtos( ( dbfFacCliT )->dFecCre ) + ( dbfFacCliT )->cTimCre >= dtos( ( tmpFacCliT )->dFecCre ) + ( tmpFacCliT )->cTimCre 
      		...
      		::cErrorRecepcion    += "la fecha en la empresa " + dtoc( ( dbfFacCliT )->dFecCre ) + " " + ( dbfFacCliT )->cTimCre + " es m�s reciente que la recepci�n " + dtoc( ( tmpFacCliT )->dFecCre ) + " " + ( tmpFacCliT )->cTimCre 
...
METHOD validateRecepcionRecibo( tmpFacCliP, dbfFacCliP ) CLASS TFacturasClientesSenderReciver
   ...
   ::cErrorRecepcion       := "Pocesando recibo de cliente n�mero " + ( dbfFacCliP )->cSerie + "/" + alltrim( Str( ( dbfFacCliP )->nNumFac ) ) + "/" + alltrim( ( dbfFacCliP )->cSufFac ) + alltrim( Str( ( dbfFacCliP )->nNumRec ) ) + " "
   ...
   if dtos( ( dbfFacCliP )->dFecCre ) + ( dbfFacCliP )->cHorCre >= dtos( ( tmpFacCliP )->dFecCre ) + ( tmpFacCliP )->cHorCre 
      ...
      ::cErrorRecepcion    += "la fecha en la empresa " + dtoc( ( dbfFacCliP )->dFecCre ) + " " + ( dbfFacCliP )->cHorCre + " es m�s reciente que la recepci�n " + dtoc( ( tmpFacCliP )->dFecCre ) + " " + ( tmpFacCliP )->cHorCre
...
Static Function lNombreVacio( aGet, cNomCli )
   ...
   if empty( cNomCli )
      ...
      if ( "TABLET" $ appParamsMain() )
         apoloMsgStop( "Nombre de cliente no puede estar vac�o.")
      else
         msgStop( "Nombre de cliente no puede estar vac�o." )
      end if
...
Static Function lAlmacenVacio( aGet, cCodAlm )
   ...
   if empty( cCodAlm )
      ...
      if ( "TABLET" $ appParamsMain() )
         apoloMsgStop( "Almac�n no puede estar vac�o.")
      else
...
Static Function lFormaPagoVacia( aGet, cCodPago )
   ...
   if empty( cCodPago )
      ...
      if ( "TABLET" $ appParamsMain() )
         apoloMsgStop( "Forma de pago no puede estar vac�a.")
      else
...
Static Function lDivisaVacia( aGet, cCodDiv )
   ...
   if empty( cCodDiv )
      ...
      if ( "TABLET" $ appParamsMain() )
         apoloMsgStop( "No puede almacenar documento sin C�digo de divisa.")
      else
      ...
      if !( ( dbfTmpLin )->nUniCaja == 0 .and. ( dbfTmpLin )->lFromAtp )
         ...
         */
         ...
         if !( dbfTmpLin )->lKitChl
	         ...
	         AtipicasModel():SaveUltimoPrecioVenta( { 	"cCodCli" => cCodCli ,;
	         									  		"cCodArt" => ( dbfTmpLin )->cRef ,; 
	         									  		"cCodPr1" => ( dbfTmpLin )->cCodPr1 ,;
	         									  		"cCodPr2" => ( dbfTmpLin )->cCodPr2 ,;
	         									  		"cValPr1" => ( dbfTmpLin )->cValPr1 ,;
	         									  		"cValPr2" => ( dbfTmpLin )->cValPr2 ,;
	         									  		"nPrcArt" => ( dbfTmpLin )->nPreUnit,;
	         									  		"nTarifa" => aTmp[ _NTARIFA ] } )
	     end if
   ...
   MENU oDetMenu 2015
      ...
      MENUITEM    "&1. Rotor  " ;
         ...
         MENU
            ...
            MENUITEM    "&2. Modificar art�culo";
               MESSAGE  "Modificar la ficha del art�culo" ;
               RESOURCE "gc_object_cube_16";
               ACTION   ( EdtArticulo( oCodArt:VarGet() ) );

            MENUITEM    "&3. Informe de art�culo";
               MESSAGE  "Abrir el informe del art�culo" ;
               RESOURCE "Info16";
               ACTION   ( if( RolesModel():getRolNoVerPreciosCosto( Auth():rolUuid() ), msgStop( "No tiene permiso para ver los precios de costo" ), InfArticulo( oCodArt:VarGet() ) ) );

            MENUITEM    "&4. Informe de stock";
               MESSAGE  "Abrir el informe del stock" ;
               RESOURCE "Info16";
               ACTION   ( InfStock( oCodArt:VarGet() ) );
...
Function CreateFacCliQrCode()
	...
	cText 		:= "N�mero: " + ( D():FacturasClientes( nView ) )->cSerie + AllTrim( Str( ( D():FacturasClientes( nView ) )->nNumFac ) ) + CRLF
	cText 		+= "Fecha: " + dToc( ( D():FacturasClientes( nView ) )->dFecFac ) + CRLF
	cText 		+= "Cliente: " + AllTrim( ( D():FacturasClientes( nView ) )->cCodCli ) + " - " + AllTrim( ( D():FacturasClientes( nView ) )->cNomCli ) + CRLF
	cText 		+= "Neto: " + Trans( ( D():FacturasClientes( nView ) )->nTotNet, cPorDiv ) + CRLF
	cText 		+= "IVA: " + Trans( ( D():FacturasClientes( nView ) )->nTotIva, cPorDiv ) + CRLF
	cText 		+= "Total: " + Trans( ( D():FacturasClientes( nView ) )->nTotFac, cPorDiv ) + CRLF
...
//---------------------------------------------------------------------------//
//---------------------------------------------------------------------------//
/*CLASE TOTALES DOCUMENTO*/

CLASS nTotalDocumento
	...
	DATA aArrayImpuesto
   	...
   	METHOD setArrayImpuesto()
   	METHOD getArrayImpuesto() 			INLINE ( ::aArrayImpuesto )

   	METHOD setImportesImpuesto()
   	
   	METHOD setGastos( nIvaMan, nBaseGasto, nIvaGasto )

   	METHOD setDescuentoEspecial
   	METHOD setDescuentoProntoPago
   	METHOD setDescuentoUno
   	METHOD setDescuentoDos

   	METHOD getTotalBruto()
   	METHOD getTotalNeto()
   	METHOD getTotalIva()
   	METHOD getTotalRE()
   	METHOD getTotalIvmh()
   	METHOD getTotalTrn()
   	METHOD getTotalPntVer()

END CLASS

//---------------------------------------------------------------------------//

METHOD new( nView ) CLASS nTotalDocumento
...
METHOD setArrayImpuesto( nPctIva, lRecargo, nPctReq, nBruto, nIvm, nTrn, nPntVer ) CLASS nTotalDocumento
	...
	if len( ::aArrayImpuesto ) == 0 .or. nPos == 0
		...
		hLine 	:= 	{ 	"porcentajeiva" => nPctIva,;
						"logrecargo"	=> lRecargo,;
						"porcentajere"	=> nPctReq,;
						"bruto"			=> nBruto,;
						"neto"			=> nBruto + nPntVer,;
						"impiva"		=> 0,;
						"impre"			=> 0,;
...
METHOD setImportesImpuesto( lIvaInc, nRegIva, nRouDiv ) CLASS nTotalDocumento
	      	...
	      	if hGet( hTipoIva, "logrecargo" )
		        ...
		        if hGet( hTipoIva, "porcentajeiva" ) != 0
			        ...
			        if nRegIva <= 1
			            	...
			            	//hSet( hTipoIva, "impiva", Round( nTotalBase * hGet( hTipoIva, "porcentajeiva" ) / 100, nRouDiv ) )
			            	//hSet( hTipoIva, "impre", hGet( hTipoIva, "neto" ) - nTotalBase - hGet( hTipoIva, "impiva" ) )
							...
							//hSet( hTipoIva, "neto", ( hGet( hTipoIva, "neto" ) - ( hGet( hTipoIva, "impiva" ) + hGet( hTipoIva, "impre" ) ) ) )		            
			        end if
...
METHOD setGastos( nIvaMan, nBaseGasto, nIvaGasto ) CLASS nTotalDocumento

	local hTipoIva

	for each hTipoIva in ::aArrayImpuesto
		
		if 	hGet( hTipoIva, "porcentajeiva" ) != nil .and.;
			hGet( hTipoIva, "porcentajeiva" ) == nIvaMan
...
METHOD setDescuentoEspecial( nDtoEsp ) CLASS nTotalDocumento
...
METHOD setDescuentoProntoPago( nDtoPP ) CLASS nTotalDocumento
...
METHOD setDescuentoUno( nDtoUno ) CLASS nTotalDocumento
...
METHOD setDescuentoDos( nDtoDos ) CLASS nTotalDocumento
...
METHOD getTotalBruto() CLASS nTotalDocumento
...
METHOD getTotalNeto() CLASS nTotalDocumento
...
METHOD getTotalIva() CLASS nTotalDocumento
...
METHOD getTotalRE() CLASS nTotalDocumento
...
METHOD getTotalIvmh() CLASS nTotalDocumento
...
METHOD getTotalTrn() CLASS nTotalDocumento
...
METHOD getTotalPntVer() CLASS nTotalDocumento
