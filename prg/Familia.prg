...
#define _CTITSEO                 42      //   C      70    0
#define _CDESSEO                 43      //   C     160    0
#define _CKEYSEO                 44      //   C     160    0
   ...
   BEGIN SEQUENCE
      ...
      REDEFINE FOLDER oFld ;
         ...
         */
         ...
         REDEFINE GET aGet[ _CTITSEO ] ;
            VAR      aTmp[ _CTITSEO ];
            ID       410 ;
            WHEN     ( nMode != ZOOM_MODE ) ;
            OF       oFld:aDialogs[2]

         REDEFINE GET aGet[ _CDESSEO ] ;
            VAR      aTmp[ _CDESSEO ];
            ID       420 ;
            WHEN     ( nMode != ZOOM_MODE ) ;
            OF       oFld:aDialogs[2]

         REDEFINE GET aGet[ _CKEYSEO ] ;
            VAR      aTmp[ _CKEYSEO ];
            ID       440 ;
            WHEN     ( nMode != ZOOM_MODE ) ;
            OF       oFld:aDialogs[2]
...
FUNCTION aItmFam()
   ...
   local aBase := {  {"cCodFam",    "C",    16,    0, "Código de familia" },;
                     {"cNomFam",    "C",   100,    0, "Nombre de familia" },;
                     ...
                     {"cTitSeo",    "C",    70,    0, "Meta-título" },;
                     {"cDesSeo",    "C",   160,    0, "Meta-descripcion" },;
                     {"cKeySeo",    "C",   160,    0, "Meta-keywords" },;
                     {"cIdWP",      "C",    40,    0, "Id relación con WordPress" } }                     
