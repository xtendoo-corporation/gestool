...
METHOD OpenFiles()
   ...
   if !File( alltrim( ::cPathFac ) + "PROVEEDO.DBF" )
      ...
      DATABASE NEW ::oDbfPrvFac PATH ( ::cPathFac ) FILE "PROVEEDO.DBF" VIA ( 'DBFCDX' )CLASS "PRVFAC"
      lOpenCliPrv := .t.
   end if
   ...
   if !File( ::cPathFac + "CLIENTE.DBF" )
      ...
      DATABASE NEW ::oDbfCliFac PATH ( ::cPathFac ) FILE "CLIENTE.DBF"  VIA ( 'DBFCDX' )CLASS "CLIFAC"
      lOpenCliPrv := .t.
   end if
   ...
   if !File( ::cPathFac + "Articulo.DBF" )      
      ...
      DATABASE NEW ::oDbfArtFac PATH ( ::cPathFac ) FILE "ARTICULO.DBF" VIA ( 'DBFCDX' )CLASS "ARTFAC"
   end if
...
//Comprobamos si existe el fichero donde se guardan las lineas de todos los documentos
   ...
   if !File( ::cPathFac + "CONTENI1.DBF" )
      ...
      DATABASE NEW ::oDbfAlbLFac PATH ( ::cPathFac ) FILE "CONTENI1.DBF"   VIA ( 'DBFCDX' )    CLASS "ALBLFAC"
      ...
      if !File( ::cPathFac + "ALBARAN1.DBF" )
         ...
         DATABASE NEW ::oDbfAlbTFac PATH ( ::cPathFac ) FILE "ALBARAN1.DBF"   VIA ( 'DBFCDX' ) CLASS "ALBTFAC"
      ...
      if !File( ::cPathFac + "INGRESO1.DBF" )
         ...
         DATABASE NEW ::oDbfFacTFac PATH ( ::cPathFac ) FILE "INGRESO1.DBF"   VIA ( 'DBFCDX' ) CLASS "FACTFAC"
      ...
      if !File( ::cPathFac + "GASTOS1.DBF" )
         ...
         DATABASE NEW ::oDbfFacPrvTFac PATH ( ::CPathFac() ) FILE "GASTOS1.DBF"  VIA ( 'DBFCDX' ) CLASS "FACPRVTFAC"
      ...
      if !File( ::cPathFac + "PEDIDOS1.DBF" )
         ...
         DATABASE NEW ::oDbfPedPrvTFac PATH ( ::cPathFac )  FILE "PEDIDOS1.DBF"     VIA ( 'DBFCDX' )  CLASS "PEDPRVTFAC"
