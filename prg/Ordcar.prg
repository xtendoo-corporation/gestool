...
CLASS TOrdCarga FROM TMasDet
   ...
   DATA  cBitmap                    INIT clrTopVentas
...
METHOD DefineFiles( cPath, cDriver )
   ...
   FIELD NAME "nNumOrd"    TYPE "N" LEN   9 DEC  0 PICTURE "999999999"  COMMENT "Número"        ALIGN RIGHT          COLSIZE  80      OF oDbf
   FIELD NAME "cSufOrd"    TYPE "C" LEN   2 DEC  0 PICTURE "@!"         COMMENT "Sufijo"                             COLSIZE  20      OF oDbf
   ...
   FIELD NAME "cCodAge"    TYPE "C" LEN   3 DEC  0 PICTURE "@!"         COMMENT "Cod. agente"                        COLSIZE  50      OF oDbf
...
METHOD Resource( nMode )
   ...
   oDlg:bStart    := {|| if( nMode != APPD_MODE, ( oGet:lValid(), oGetAge:lValid() ), ), oGetAge:SetFocus(), ::EdtRotor( oDlg ), ::nPesOrdVir(), ::oBrwDet:Load() }
...
FUNCTION OrdCar( oMenuItem, oWnd )
   ...
   DEFAULT  oMenuItem   := "orden_de_carga"
   DEFAULT  oWnd        := oWnd()
