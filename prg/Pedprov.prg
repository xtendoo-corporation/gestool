...
#define _MENUITEM_                "pedidos_de_proveedores"
...
STATIC FUNCTION EdtRec( aTmp, aGet, dbf, oBrw, cCodPrv, cCodArt, nMode )
   ...
   */
   ...
   cUsr              := UsuariosModel():getNombreWhereCodigo( aTmp[ _CCODUSR ] )
   ...
   DEFINE DIALOG oDlg RESOURCE "PEDPRV" TITLE LblTitle( nMode ) + "pedidos a proveedores"
	...
	REDEFINE FOLDER oFld ;
      ...
      REDEFINE GET   aGet[ _CCODUSR ] ;
         ...
         ID          215 ;
         WHEN        ( .f. ) ;
         VALID       ( oUsr:cText( UsuariosModel():getNombreWhereCodigo( aTmp[ _CCODUSR ] ) ), .t.  ) ;
         OF          oFld:aDialogs[2]
      ...
      */
      ...
      REDEFINE BUTTON oBtnMin;
         ID       527 ;
         OF       oFld:aDialogs[1] ;
         WHEN     ( nMode != ZOOM_MODE ) ;
         ACTION   ( if( GenPedProvFromMinimo():New( nView, aGet[ _CCODPRV ], aGet[ _CNOMPRV ], dbfTmpLin ):Activate(), ( oBtnMin:Hide(), RecalculaTotal( aTmp ), oBrwLin:Refresh() ), ) )
...
static function nTotPdtRecTmp( dbfTmp )
   ...
   nTotRes           := AlbaranesProveedoresLineasModel():nUnidadesRecibidas( ( dbfTmp )->cSerPed + Str( ( dbfTmp )->nNumPed ) + ( dbfTmp )->cSufPed,;
                                                                              ( dbfTmp )->cRef,;
                                                                              ( dbfTmp )->cCodPr1,;
                                                                              ( dbfTmp )->cCodPr2,;
                                                                              ( dbfTmp )->cValPr1,;
...
STATIC FUNCTION EdtDet( aTmp, aGet, dbf, oBrw, aTmpPed, cCodArt, nMode )
   ...
   if nMode == APPD_MODE
      ...
      nGetStk           := StocksModel():nStockArticulo( aTmp[ _CREFPRV ], aTmp[ _CALMLIN ], aTmp[ _CCODPR1 ], aTmp[ _CCODPR2 ], aTmp[ _CVALPR1 ], aTmp[ _CVALPR2 ], aTmp[ _CLOTE ] )

   end if

   nTotRes              := AlbaranesProveedoresLineasModel():nUnidadesRecibidas( aTmp[ _CSERPED ] + Str( aTmp[ _NNUMPED ] ) + aTmp[ _CSUFPED ],;
                                                                              aTmp[ _CREF ],;
                                                                              aTmp[ _CCODPR1 ],;
                                                                              aTmp[ _CCODPR2 ],;
                                                                              aTmp[ _CVALPR1 ],;
   ...
   ( D():AlbaranesProveedoresLineas( nView ) )->( OrdScope( 0, aTmp[ _CSERPED ] + Str( aTmp[ _NNUMPED ] ) + aTmp[ _CSUFPED ] + aTmp[ _CREF ] + aTmp[ _CVALPR1 ] + aTmp[ _CVALPR2 ] ) )
   ( D():AlbaranesProveedoresLineas( nView ) )->( OrdScope( 1, aTmp[ _CSERPED ] + Str( aTmp[ _NNUMPED ] ) + aTmp[ _CSUFPED ] + aTmp[ _CREF ] + aTmp[ _CVALPR1 ] + aTmp[ _CVALPR2 ] ) )
   ...
   DEFINE DIALOG  oDlg ;
      ...
      */
      ...
      REDEFINE GET aGet[ _CLOTE ] VAR aTmp[ _CLOTE ];
         ...
         aGet[ _CLOTE ]:bChange   := {|| aGet[ _CLOTE ]:Assign(), StocksModel():lPutStockActual( aTmp[ _CREF ], aTmp[ _CALMLIN ], aTmp[ _CCODPR1 ], aTmp[ _CCODPR2 ], aTmp[ _CVALPR1 ], aTmp[ _CVALPR2 ], aTmp[ _CLOTE ], oGetStk ) }
      ...
      */
      ...
      REDEFINE GET aGet[ _CVALPR1 ] VAR aTmp[ _CVALPR1 ];
         ...
         aGet[ _CVALPR1 ]:bChange   := {|| aGet[ _CVALPR1 ]:Assign(), StocksModel():lPutStockActual( aTmp[ _CREF ], aTmp[ _CALMLIN ], aTmp[ _CCODPR1 ], aTmp[ _CCODPR2 ], aTmp[ _CVALPR1 ], aTmp[ _CVALPR2 ], aTmp[ _CLOTE ], oGetStk ) }
      ...
      REDEFINE GET aGet[ _CVALPR2 ] VAR aTmp[ _CVALPR2 ];
         ...
         aGet[ _CVALPR2 ]:bChange   := {|| aGet[ _CVALPR2 ]:Assign(), StocksModel():lPutStockActual( aTmp[ _CREF ], aTmp[ _CALMLIN ], aTmp[ _CCODPR1 ], aTmp[ _CCODPR2 ], aTmp[ _CVALPR1 ], aTmp[ _CVALPR2 ], aTmp[ _CLOTE ], oGetStk ) }
      ...
      REDEFINE GET aGet[ _CALMLIN ] VAR aTmp[ _CALMLIN ]  ;
         ...
         VALID    (  cAlmacen( aGet[ _CALMLIN ], , oSay2 ),;
                     StocksModel():lPutStockActual( aTmp[ _CREF ], aTmp[ _CALMLIN ], aTmp[ _CCODPR1 ], aTmp[ _CCODPR2 ], aTmp[ _CVALPR1 ], aTmp[ _CVALPR2 ], aTmp[ _CLOTE ], oGetStk ) ) ;
         BITMAP   "LUPA" ;
      ...
      */
      ...
      REDEFINE SAY   oTotPdt ;
         PROMPT      if( ( nTotRes > nTotNPedPrv( aTmp ) ), 0, nTotNPedPrv( aTmp ) - nTotRes ) ;
         ID          170 ;
         COLOR       "R/W*" ;
         PICTURE     cPicUnd ;
         OF          oFld:aDialogs[2]
         ...
         if ( lChgCodArt )
            ...
            */
            ...
            if oGetStk != nil .and. aTmp[ _NCTLSTK ] <= 1
               StocksModel():lPutStockActual( cCodArt, aTmp[ _CALMLIN ], aTmp[ _CCODPR1 ], aTmp[ _CCODPR2 ], aTmp[ _CVALPR1 ], aTmp[ _CVALPR2 ], aTmp[ _CLOTE ], oGetStk )
            end if
      ...
      for each nRec in ( oBrw:aSelected )
         ...
         */
         ...
         if ( D():PedidosProveedoresLineas( nView ) )->( dbSeek( cNumPed ) )
            ...
            while ( D():PedidosProveedoresLineas( nView ) )->cSerPed + Str( ( D():PedidosProveedoresLineas( nView ) )->nNumPed ) + ( D():PedidosProveedoresLineas( nView )  )->cSufPed == cNumPed .and.;
               ...
               /*
               Cambiamos el estado de pendiente de recibir---------------------
               */

               nTotRec           := AlbaranesProveedoresLineasModel():nUnidadesRecibidas( ( D():PedidosProveedoresLineas( nView ) )->cSerPed + Str( ( D():PedidosProveedoresLineas( nView ) )->nNumPed ) + ( D():PedidosProveedoresLineas( nView ) )->cSufPed,;
...
Static Function nEstadoRecibido( dbfLin )
   ...
   nTotRec           := AlbaranesProveedoresLineasModel():nUnidadesRecibidas( ( dbfLin )->cSerPed + Str( ( dbfLin )->nNumPed ) + ( dbfLin )->cSufPed,;
                                                                              ( dbfLin )->cRef,;
                                                                              ( dbfLin )->cCodPr1,;
                                                                              ( dbfLin )->cCodPr2,;
                                                                              ( dbfLin )->cValPr1,;
...
FUNCTION nTotEPedPrv( uTmp )
   ...
   case ValType( uTmp ) == "O"
      nCalculo    := NotBulto( uTmp:nBultos ) * NotCaja( uTmp:nCanEnt ) * uTmp:nUniEnt
   case ValType( uTmp ) == "A"
      nCalculo    := NotBulto( uTmp[ __NBULTOS ] ) * NotCaja( uTmp[ _NCANENT ] * uTmp[ _NUNIENT ] )
   end case
...
FUNCTION nTotNPedPrv( uTmp )
   ...
   case ValType( uTmp ) == "A"
      ...
      nCalculo    *= NotBulto( uTmp[ __NBULTOS ] )
...
Function SynPedPrv( cPath )
   ...
   while !( dbfPedPrvL )->( eof() )
      ...
      /*
      Vemos el estado de las lineas, dependiendo de la cabecera----------------
      */
      ...
      do case
         ...
         otherwise
            ...
            nEntregado  := AlbaranesProveedoresLineasModel():nUnidadesRecibidas(   ( dbfPedPrvL )->cSerPed + Str( ( dbfPedPrvL )->nNumPed ) + ( dbfPedPrvL )->cSufPed,;
                                                                                          Padr( ( dbfPedPrvL )->cRef, 18 ),;
                                                                                          Padr( ( dbfPedPrvL )->cCodPr1, 20 ),;
                                                                                          Padr( ( dbfPedPrvL )->cCodPr2, 20 ),;
                                                                                          Padr( ( dbfPedPrvL )->cValPr1, 20 ),;
                                                                                          Padr( ( dbfPedPrvL )->cValPr2, 20 ) )



            do case
               case nEntregado == 0
                  ( dbfPedPrvL )->nEstado    := 1

               case nEntregado >= nTotNPedPrv( dbfPedPrvL )
                  ( dbfPedPrvL )->nEstado    := 3

               case nEntregado < nTotNPedPrv( dbfPedPrvL )
                  ( dbfPedPrvL )->nEstado    := 2
...
Return ( printReportPedPrv( IS_MAIL, 1, ImpresoraDefectoUsuario(), cCodigoDocumento ) )
   ...
   do case
      case hb_isArray( aTmp )
         ...
         if !lDel
            ...
            hset( hBuffer, "pendiente_recibir", nTotNPedPrv( aTmp ) - AlbaranesProveedoresLineasModel():nUnidadesRecibidas( aTmp[ _CSERPED ] + Str( aTmp[ _NNUMPED ] ) + aTmp[ _CSUFPED ],;
                                                                              aTmp[ _CREF ],;
                                                                              aTmp[ _CCODPR1 ],;
                                                                              aTmp[ _CCODPR2 ],;
                                                                              aTmp[ _CVALPR1 ],;
      ...
      case hb_isChar( aTmp )
         ...
         if !lDel
            ...
            hset( hBuffer, "pendiente_recibir", nTotNPedPrv( aTmp ) - AlbaranesProveedoresLineasModel():nUnidadesRecibidas( ( aTmp )->cSerPed + Str( ( aTmp )->nNumPed ) + ( aTmp )->cSufPed,;
                                                                              ( aTmp )->cRef,;
                                                                              ( aTmp )->cCodPr1,;
                                                                              ( aTmp )->cCodPr2,;
                                                                              ( aTmp )->cValPr1,;
   ...
   if !Empty( cNumPed )
      ...
      if ( D():PedidosProveedoresLineas( nView ) )->( dbSeek( cNumPed ) )
         ...
         while ( D():PedidosProveedoresLineas( nView ) )->cSerPed + Str( ( D():PedidosProveedoresLineas( nView ) )->nNumPed ) + ( D():PedidosProveedoresLineas( nView ) )->cSufPed == cNumPed .and.;
            ...
            nUndEnt := AlbaranesProveedoresLineasModel():nUnidadesRecibidas(  ( D():PedidosProveedoresLineas( nView ) )->cSerPed + Str( ( D():PedidosProveedoresLineas( nView ) )->nNumPed ) + ( D():PedidosProveedoresLineas( nView ) )->cSufPed,;
                                                                              ( D():PedidosProveedoresLineas( nView ) )->cRef,;
                                                                              ( D():PedidosProveedoresLineas( nView ) )->cCodPr1,;
                                                                              ( D():PedidosProveedoresLineas( nView ) )->cCodPr2,;
                                                                              ( D():PedidosProveedoresLineas( nView ) )->cValPr1,;
