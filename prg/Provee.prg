   ...
   cSubCtaAnt           := aTmp[ ( dbfProvee )->( fieldpos( "SubCta" ) ) ]
	...
	REDEFINE FOLDER oFld;
      ...
      REDEFINE GET aGet[ _CCODPAI ] VAR aTmp[ _CCODPAI ] ;
         ...
         COLOR    CLR_GET ;
         WHEN     ( nMode != ZOOM_MODE ) ;
         VALID    ( oPais:GetPais( aTmp[ _CCODPAI ], oSay[ 2 ] ) ) ;
      ...
      REDEFINE GET aGet[_DFECCHG] VAR aTmp[_DFECCHG];
         ID       192 ;
         COLOR    CLR_GET ;
         WHEN     ( .f. ) ;
         OF       oFld:aDialogs[1]
      ...
      */
      ...
      oBrwPrvArt:bClrSel         := {|| { CLR_BLACK, Rgb( 229, 229, 229 ) } }
      oBrwPrvArt:bClrSelFocus    := {|| { CLR_BLACK, Rgb( 167, 205, 240 ) } }
      ...
      */
      ...
      DEFINE CLIPBOARD oClp OF oFld:aDialogs[ 8 ] FORMAT TEXT
...
static function BeginTrans( aTmp, nMode )
   ...
   if !NetErr()
      ...
      if nMode != APPD_MODE .and. ( D():ProveedorArticulo( nView ) )->( dbSeek( cCodPrv ) )
