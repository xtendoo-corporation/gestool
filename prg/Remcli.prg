...
METHOD InsertDeudorXml()
   ...
   oDebtor:MndtId       := hb_md5( alltrim( ::oClientes:Nif ) + ttos( datetime() ) )   // hb_md5( ::oCuaderno:oCreditor:Id + :id )  // Identificación del mandato, idea: Utilizar NIF Acreedor + NIF Deudor con md5
