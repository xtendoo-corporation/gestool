...
Function Main( cCodEmp, cCodUsr, cInitOptions )
   ...
   Auth( UsuariosModel():getWhereCodigo( cCodUsr ) )
...
Static Function DelFavorito( oTrvArbolGaleria )
   ...
   */
   ...
   if ApoloMsgNoYes( "¿ Desea eliminar el informe " + AllTrim( cNombre ) +"?", "Selecciona una opción" )
...
Static function CreateFavoritoReportGalery( oTrvArbolGaleria )
   ...
   local n              := 0
   local cCodUsr        := AllTrim( Auth():Codigo() )
...
FUNCTION SQLSESIONESMODEL()
RETURN nil

FUNCTION SQLRECIBOSMODEL()
RETURN nil

FUNCTION SQLBALANZASMODEL()
RETURN nil

FUNCTION SQLUNIDADESMEDICIONGRUPOSMODEL()
RETURN nil

FUNCTION SQLUNIDADESMEDICIONGRUPOSLINEASMODEL()
RETURN nil

FUNCTION SESIONESCONTROLLER()
RETURN nil

FUNCTION UNIDADESMEDICIONGRUPOSCONTROLLER()
RETURN nil

FUNCTION RECIBOSCONTROLLER()
RETURN nil

FUNCTION BALANZASCONTROLLER()
RETURN nil

FUNCTION lGetUsuario() 
Return .t.

FUNCTION InitReindexa()
RETURN nil

FUNCTION AGENTESMODEL()
Return nil

FUNCTION FACTURASCLIENTESLINEASMODEL()
Return nil

FUNCTION ALBARANESPROVEEDORESLINEASMODEL()
Return nil

FUNCTION FACTURASCLIENTESCOBROSMODEL()
Return nil

FUNCTION ARTICULOSCODIGOSBARRAMODEL()
Return nil
...
FUNCTION SYNSALAVENTA()
Return nil

FUNCTION TFASTREPORTTERCEROS()
Return nil

FUNCTION VALIDATELINESTRANSACCIONESCOMERCIALESLINEAS()
Return nil

FUNCTION MATERIALESPRODUCIDOSLINEASMODEL()
Return nil

FUNCTION GENPEDPROVFROMMINIMO()
Return nil

FUNCTION EXPODOO()
Return nil

FUNCTION CLIENTESDIRECCIONESMODEL()
Return nil

FUNCTION ATIPICASMODEL()
Return nil

FUNCTION MOVIMIENTOSALMACENLINEASMODEL()
Return nil

FUNCTION CTEXTOMOVIMIENTO()
Return nil

FUNCTION FACTURASPROVEEDORESLINEASMODEL()
Return nil

FUNCTION TPREPAREDELIVERYNOTE()
Return nil

FUNCTION TREMMOVALM()
Return nil

FUNCTION TPREPAREORDER()
Return nil

FUNCTION TIPOSIVAMODEL()
Return nil

FUNCTION PEDIDOSPROVEEDORESLINEASMODEL()
Return nil

FUNCTION EDITMOVIMIENTOSALMACEN()
Return nil

FUNCTION ZOOMMOVIMIENTOSALMACEN()
Return nil

FUNCTION VISMOVIMIENTOSALMACEN()
Return nil

FUNCTION PRNMOVIMIENTOSALMACEN()
Return nil

FUNCTION ALBARANESPROVEEDORESMODEL()
Return nil

FUNCTION FACTURASPROVEEDORESMODEL()
Return nil

FUNCTION RECTIFICATIVASPROVEEDORESMODEL()
Return nil

FUNCTION PEDIDOSCLIENTESMODEL()
Return nil

FUNCTION RECTIFICATIVASCLIENTESMODEL()
Return nil

FUNCTION TICKETSCLIENTESMODEL()
Return nil
...
FUNCTION TDETMOVIMIENTOS()
Return nil

FUNCTION TDETSERIESMOVIMIENTOS()
Return nil
...
FUNCTION MOVIMIENTOSALMACENMODEL()
Return nil
...
Function GRUPOCLIENTESMODEL()
Return nil

Function PROVEEDORESMODEL()
Return nil

Function CLIENTESBANCOSMODEL()
Return nil

Function PROVEEDORESBANCOSMODEL()
Return nil

Function RUTASMODEL()
Return nil

Function FAMILIASMODEL()
Return nil

Function SQLODOOIDSMODEL()
Return nil

Function GETBOLDFONT()
Return nil

Function FORMASPAGOMODEL()
Return nil

Function ALMACENESMODEL()
Return nil

Function GETVALUEARTICULO()
Return nil

Function ESCANDALLOSARTICULOMODEL()
Return nil

Function RECTIFICATIVASPROVEEDORESLINEASMODEL()
return nil

Function RECTIFICATIVASCLIENTESLINEASMODEL()
return nil

Function TICKETSCLIENTESLINEASMODEL()
return nil

Function MATERIALESCONSUMIDOSLINEASMODEL()
return nil

Function TAUDITORIA()
return nil

Function INFORMEAUDITORIA()
return nil

Function TICKETSCLIENTESPAGOSMODEL()
return nil

Function AUDITORIAMODEL()
return nil

Function RECIBOSCLIENTESMODEL()
return nil

Function WEBSERVICE()
return nil

Function ASISTENCIASMODEL
return nil
...
Function IMPORTLATRESS
return nil

Function LISTAESCANDALLOSMODEL
return nil
