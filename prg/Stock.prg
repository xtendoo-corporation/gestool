...
CLASS TStock
   ...
   CLASSDATA cCodigoEmpresa

   CLASSDATA cLote
   CLASSDATA cCodigoPropiedad1
   CLASSDATA cValorPropiedad1
   CLASSDATA cCodigoPropiedad2
   CLASSDATA cValorPropiedad2
   ...
   METHOD InsertStockAlbaranProveedores()
   METHOD DeleteStockAlbaranProveedores()

   METHOD InsertStockFacturaProveedores()
   METHOD DeleteStockFacturaProveedores()

   METHOD InsertStockRectificativaProveedores()
   METHOD DeleteStockRectificativaProveedores()

   METHOD InsertStockPedidoClientes()
   METHOD InsertStockAlbaranClientes()
   METHOD InsertStockFacturaClientes()
   METHOD InsertStockRectificativaClientes()
   METHOD InsertStockTiketsClientes( lCombinado )
   METHOD InsertStockMaterialesProducidos()
   METHOD InsertStockMateriasPrimas()
...
METHOD nTotStockAct( cCodArt, cCodAlm, cValPr1, cValPr2, cLote, lKitArt, nKitStk, nCtlStk, cCodPr1, cCodPr2 ) CLASS TStock
...
METHOD aStockArticulo( cCodArt, cCodAlm, cLote, cCodPr1, cValPr1, cCodPr2, cValPr2, dFecIni, dFecFin, tHorIni, tHorFin, cCodEmp ) CLASS TStock
...
METHOD nStockArticulo( cCodArt, cCodAlm, cLote, cCodPr1, cValPr1, cCodPr2, cValPr2, dFecIni, dFecFin, tHorIni, tHorFin ) CLASS TStock
...
METHOD nStockAlmacen( cCodArt, cCodAlm, cLote, cCodPr1, cValPr1, cCodPr2, cValPr2, dFecIni, dFecFin, tHorIni, tHorFin ) CLASS TStock
...
Method Integra( sStocks ) CLASS TStock
   ...
   if ::lIntegra
      ...
      nPos              := aScan( ::aStocks, {|o|  alltrim( o:cCodigo ) == alltrim( sStocks:cCodigo )                    .and.;
                                                   ...
                                                   alltrim( o:cLote ) == alltrim( sStocks:cLote ) } ) //                        .and.;
...
METHOD aStockMovimientosAlmacen()
   ...
   oRowSet     := MovimientosAlmacenLineasRepository();
                           :getRowSetMovimientosForArticulo( { "codigo_articulo" => ::cCodigoArticulo,;
                                                               "almacen" => ::cCodigoAlmacen,;
                                                               "empresa" => ::cCodigoEmpresa,;
                                                               "lote" => ::cLote,;
                                                               "codigo_primera_propiedad" => ::cCodigoPropiedad1,;
                                                               "valor_primera_propiedad" => ::cValorPropiedad1,;
                                                               "codigo_segunda_propiedad" => ::cCodigoPropiedad2,;
                                                               "valor_segunda_propiedad" => ::cValorPropiedad2 } )
...
METHOD aStockAlbaranProveedor()
   ...
   if ( ::cAlbPrvL )->( dbSeek( ::cCodigoArticulo + ::cCodigoAlmacen ) )
      ...
      while ( ::cAlbPrvL )->cRef == ::cCodigoArticulo .and. ( ::cAlbPrvL )->cAlmLin == ::cCodigoAlmacen .and. !( ::cAlbPrvL )->( eof() )
         ...
         if ( ( empty( ::cCodigoPropiedad1 ) .or. alltrim( ::cCodigoPropiedad1 ) == alltrim( ( ::cAlbPrvL )->cCodPr1 ) ) .and.;
            ( empty( ::cValorPropiedad1 ) .or. alltrim( ::cValorPropiedad1 ) == alltrim( ( ::cAlbPrvL )->cValPr1 ) ) .and.;
            ( empty( ::cCodigoPropiedad2 ) .or. alltrim( ::cCodigoPropiedad2 ) == alltrim( ( ::cAlbPrvL )->cCodPr2 ) ) .and.;
            ( empty( ::cValorPropiedad2 ) .or. alltrim( ::cValorPropiedad2 ) == alltrim( ( ::cAlbPrvL )->cValPr2 ) ) .and.;
            ( empty( ::cLote   ) .or. alltrim( ::cLote   ) == alltrim( ( ::cAlbPrvL )->cLote ) ) )
...
METHOD aStockFacturaProveedor()
   ...
   if ( ::cFacPrvL )->( dbSeek( ::cCodigoArticulo + ::cCodigoAlmacen ) )
      ...
      while ( ::cFacPrvL )->cRef == ::cCodigoArticulo .and. ( ::cFacPrvL )->cAlmLin == ::cCodigoAlmacen .and. !( ::cFacPrvL )->( Eof() )
         ...
         if ( ( empty( ::cCodigoPropiedad1 ) .or. alltrim( ::cCodigoPropiedad1 ) == alltrim( ( ::cFacPrvL )->cCodPr1 ) ) .and.;
               ( empty( ::cValorPropiedad1 ) .or. alltrim( ::cValorPropiedad1 ) == alltrim( ( ::cFacPrvL )->cValPr1 ) ) .and.;
               ( empty( ::cCodigoPropiedad2 ) .or. alltrim( ::cCodigoPropiedad2 ) == alltrim( ( ::cFacPrvL )->cCodPr2 ) ) .and.;
               ( empty( ::cValorPropiedad2 ) .or. alltrim( ::cValorPropiedad2 ) == alltrim( ( ::cFacPrvL )->cValPr2 ) ) .and.;
               ( empty( ::cLote   ) .or. alltrim( ::cLote   ) == alltrim( ( ::cFacPrvL )->cLote ) ) )
...
METHOD aStockRectificativaProveedor()
   ...
   if ( ::cRctPrvL )->( dbSeek( ::cCodigoArticulo + ::cCodigoAlmacen ) )
      ...
      while ( ::cRctPrvL )->cRef == ::cCodigoArticulo  .and. ( ::cRctPrvL )->cAlmLin == ::cCodigoAlmacen .and. !( ::cRctPrvL )->( Eof() )
         ...
         if ( ( empty( ::cCodigoPropiedad1 ) .or. alltrim( ::cCodigoPropiedad1 ) == alltrim( ( ::cRctPrvL )->cCodPr1 ) ) .and.;
               ( empty( ::cValorPropiedad1 ) .or. alltrim( ::cValorPropiedad1 ) == alltrim( ( ::cRctPrvL )->cValPr1 ) ) .and.;
               ( empty( ::cCodigoPropiedad2 ) .or. alltrim( ::cCodigoPropiedad2 ) == alltrim( ( ::cRctPrvL )->cCodPr2 ) ) .and.;
               ( empty( ::cValorPropiedad2 ) .or. alltrim( ::cValorPropiedad2 ) == alltrim( ( ::cRctPrvL )->cValPr2 ) ) .and.;
               ( empty( ::cLote   ) .or. alltrim( ::cLote   ) == alltrim( ( ::cRctPrvL )->cLote ) ) )
...
METHOD aStockPedidoCliente()
   ...
   if ( ::cPedCliL )->( dbSeek( ::cCodigoArticulo + ::cCodigoAlmacen ) )
      ...
      while ( ::cPedCliL )->cRef == ::cCodigoArticulo .and. ( ::cPedCliL )->cAlmLin == ::cCodigoAlmacen .and.  !( ::cPedCliL )->( eof() )
         ...
         if ( ( empty( ::cCodigoPropiedad1 ) .or. alltrim( ::cCodigoPropiedad1 ) == alltrim( ( ::cPedCliL )->cCodPr1 ) ) .and.;
            ( empty( ::cValorPropiedad1 ) .or. alltrim( ::cValorPropiedad1 ) == alltrim( ( ::cPedCliL )->cValPr1 ) ) .and.;
            ( empty( ::cCodigoPropiedad2 ) .or. alltrim( ::cCodigoPropiedad2 ) == alltrim( ( ::cPedCliL )->cCodPr2 ) ) .and.;
            ( empty( ::cValorPropiedad2 ) .or. alltrim( ::cValorPropiedad2 ) == alltrim( ( ::cPedCliL )->cValPr2 ) ) .and.;
            ( empty( ::cLote   ) .or. alltrim( ::cLote   ) == alltrim( ( ::cPedCliL )->cLote ) ) )

            if ( ::cPedCliT )->( dbseek( ( ::cPedCliL )->cSerPed + str( ( ::cPedCliL )->nNumPed ) + ( ::cPedCliL )->cSufPed ) )

               if ( ( ::cPedCliT )->nEstado != 3 .and. !( ::cPedCliT )->lCancel ) // .and.;
                  //::validateDateTime( ( ::cPedCliT )->dFecPed, ( ::cPedCliT )->tFecPed )
...
METHOD aStockAlbaranCliente()
   ...
   if ( ::cAlbCliL )->( dbSeek( ::cCodigoArticulo + ::cCodigoAlmacen ) )
      ...
      while ( ::cAlbCliL )->cRef == ::cCodigoArticulo .and. ( ::cAlbCliL )->cAlmLin == ::cCodigoAlmacen .and. !( ::cAlbCliL )->( eof() )
         ...
         if ( ( empty( ::cCodigoPropiedad1 ) .or. alltrim( ::cCodigoPropiedad1 ) == alltrim( ( ::cAlbCliL )->cCodPr1 ) ) .and.;
            ( empty( ::cValorPropiedad1 ) .or. alltrim( ::cValorPropiedad1 ) == alltrim( ( ::cAlbCliL )->cValPr1 ) ) .and.;
            ( empty( ::cCodigoPropiedad2 ) .or. alltrim( ::cCodigoPropiedad2 ) == alltrim( ( ::cAlbCliL )->cCodPr2 ) ) .and.;
            ( empty( ::cValorPropiedad2 ) .or. alltrim( ::cValorPropiedad2 ) == alltrim( ( ::cAlbCliL )->cValPr2 ) ) .and.;
            ( empty( ::cLote   ) .or. alltrim( ::cLote   ) == alltrim( ( ::cAlbCliL )->cLote ) ) )
...
METHOD aStockFacturaCliente()
   ...
   if ( ::cFacCliL )->( dbSeek( ::cCodigoArticulo + ::cCodigoAlmacen ) )
      ...
      while ( ::cFacCliL )->cRef == ::cCodigoArticulo .and. ( ::cFacCliL )->cAlmLin == ::cCodigoAlmacen .and. !( ::cFacCliL )->( Eof() )
         ...
         if ( ( empty( ::cCodigoPropiedad1 ) .or. alltrim( ::cCodigoPropiedad1 ) == alltrim( ( ::cFacCliL )->cCodPr1 ) ) .and.;
            ( empty( ::cValorPropiedad1 ) .or. alltrim( ::cValorPropiedad1 ) == alltrim( ( ::cFacCliL )->cValPr1 ) ) .and.;
            ( empty( ::cCodigoPropiedad2 ) .or. alltrim( ::cCodigoPropiedad2 ) == alltrim( ( ::cFacCliL )->cCodPr2 ) ) .and.;
            ( empty( ::cValorPropiedad2 ) .or. alltrim( ::cValorPropiedad2 ) == alltrim( ( ::cFacCliL )->cValPr2 ) ) .and.;
            ( empty( ::cLote   ) .or. alltrim( ::cLote   ) == alltrim( ( ::cFacCliL )->cLote ) ) )
...
METHOD aStockRectificativaCliente()
   ...
   if ( ::cFacRecL )->( dbSeek( ::cCodigoArticulo + ::cCodigoAlmacen ) )
      ...
      while ( ::cFacRecL )->cRef == ::cCodigoArticulo .and. ( ::cFacRecL )->cAlmLin == ::cCodigoAlmacen .and. !( ::cFacRecL )->( Eof() )
         ...
         if ( ( empty( ::cCodigoPropiedad1 ) .or. alltrim( ::cCodigoPropiedad1 ) == alltrim( ( ::cFacRecL )->cCodPr1 ) ) .and.;
            ( empty( ::cValorPropiedad1 ) .or. alltrim( ::cValorPropiedad1 ) == alltrim( ( ::cFacRecL )->cValPr1 ) ) .and.;
            ( empty( ::cCodigoPropiedad2 ) .or. alltrim( ::cCodigoPropiedad2 ) == alltrim( ( ::cFacRecL )->cCodPr2 ) ) .and.;
            ( empty( ::cValorPropiedad2 ) .or. alltrim( ::cValorPropiedad2 ) == alltrim( ( ::cFacRecL )->cValPr2 ) ) .and.;
            ( empty( ::cLote   ) .or. alltrim( ::cLote   ) == alltrim( ( ::cFacRecL )->cLote ) ) )
...
METHOD aStockTicketsCliente()
   ...
   if ( ::cTikL )->( dbSeek( ::cCodigoArticulo + ::cCodigoAlmacen ) )
      ...
      while ( ::cTikL )->cCbaTil == ::cCodigoArticulo .and. ( ::cTikL )->cAlmLin == ::cCodigoAlmacen .and. !( ::cTikL )->( Eof() )
         ...
         if ( ( empty( ::cCodigoPropiedad1 ) .or. alltrim( ::cCodigoPropiedad1 ) == alltrim( ( ::cTikL )->cCodPr1 ) ) .and.;
            ( empty( ::cValorPropiedad1 ) .or. alltrim( ::cValorPropiedad1 ) == alltrim( ( ::cTikL )->cValPr1 ) ) .and.;
            ( empty( ::cCodigoPropiedad2 ) .or. alltrim( ::cCodigoPropiedad2 ) == alltrim( ( ::cTikL )->cCodPr2 ) ) .and.;
            ( empty( ::cValorPropiedad2 ) .or. alltrim( ::cValorPropiedad2 ) == alltrim( ( ::cTikL )->cValPr2 ) ) .and.;
            ( empty( ::cLote   ) .or. alltrim( ::cLote   ) == alltrim( ( ::cTikL )->cLote ) ) )
...
METHOD aStockProduccion()
   ...
   if ( ::cProducL )->( dbSeek( ::cCodigoArticulo + ::cCodigoAlmacen ) )
      ...
      while ( ::cProducL )->cCodArt == ::cCodigoArticulo .and. ( ::cProducL )->cAlmOrd == ::cCodigoAlmacen .and. !( ::cProducL )->( Eof() )
         ...
         if ( ( empty( ::cCodigoPropiedad1 ) .or. alltrim( ::cCodigoPropiedad1 ) == alltrim( ( ::cProducL )->cCodPr1 ) ) .and.;
               ( empty( ::cValorPropiedad1 ) .or. alltrim( ::cValorPropiedad1 ) == alltrim( ( ::cProducL )->cValPr1 ) ) .and.;
               ( empty( ::cCodigoPropiedad2 ) .or. alltrim( ::cCodigoPropiedad2 ) == alltrim( ( ::cProducL )->cCodPr2 ) ) .and.;
               ( empty( ::cValorPropiedad2 ) .or. alltrim( ::cValorPropiedad2 ) == alltrim( ( ::cProducL )->cValPr2 ) ) .and.;
               ( empty( ::cLote   ) .or. alltrim( ::cLote   ) == alltrim( ( ::cProducL )->cLote ) ) )
...
METHOD aStockMateriaPrima()
   ...
   if ( ::cProducM )->( dbSeek( ::cCodigoArticulo + ::cCodigoAlmacen ) )
      ...
      while ( ::cProducM )->cCodArt == ::cCodigoArticulo .and. ( ::cProducM )->cAlmOrd == ::cCodigoAlmacen .and. !( ::cProducM )->( eof() )
         ...
         if ( ( empty( ::cCodigoPropiedad1 ) .or. alltrim( ::cCodigoPropiedad1 ) == alltrim( ( ::cProducM )->cCodPr1 ) ) .and.;
               ( empty( ::cValorPropiedad1 ) .or. alltrim( ::cValorPropiedad1 ) == alltrim( ( ::cProducM )->cValPr1 ) ) .and.;
               ( empty( ::cCodigoPropiedad2 ) .or. alltrim( ::cCodigoPropiedad2 ) == alltrim( ( ::cProducM )->cCodPr2 ) ) .and.;
               ( empty( ::cValorPropiedad2 ) .or. alltrim( ::cValorPropiedad2 ) == alltrim( ( ::cProducM )->cValPr2 ) ) .and.;
               ( empty( ::cLote   ) .or. alltrim( ::cLote   ) == alltrim( ( ::cProducM )->cLote ) ) )
      ...
      while ( ::cPedPrvL )->cRef == ::cCodigoArticulo .and. ( ::cPedPrvL )->cAlmLin == ::cCodigoAlmacen .and. !( ::cPedPrvL )->( eof() )
         ...
         if ( ::cAlbPrvL )->( dbSeek( ( ::cPedPrvL )->cSerPed + Str( ( ::cPedPrvL )->nNumPed ) + ( ::cPedPrvL )->cSufPed + ::cCodigoArticulo ) )
            ...
            while ( ::cPedPrvL )->cSerPed + Str( ( ::cPedPrvL )->nNumPed ) + ( ::cPedPrvL )->cSufPed + ::cCodigoArticulo == ( ::cAlbPrvL )->cCodPed + ( ::cAlbPrvL )->cRef .and. !( ::cAlbPrvL )->( eof() )
               ...
               if ( ::cAlbPrvL )->cAlmLin == ::cCodigoAlmacen .and.;
                  ( ::cAlbPrvL )->cCodPr1 == ( ::cPedPrvL )->cCodPr1 .and.; 
                  ( ::cAlbPrvL )->cCodPr2 == ( ::cPedPrvL )->cCodPr2 .and.;
                  ( ::cAlbPrvL )->cValPr1 == ( ::cPedPrvL )->cValPr1 .and.;
                  ( ::cAlbPrvL )->cValPr2 == ( ::cPedPrvL )->cValPr2 .and.;
                  ( ::cAlbPrvL )->cLote == ( ::cPedPrvL )->cLote
...
METHOD InsertStockPendiente( nTotal, nTotalRecibido )
...
METHOD CreateTemporalFiles( cPath ) CLASS TStock
   ...
   FIELD NAME "cLote"      TYPE "C" LEN 64 DEC 0 COMMENT "Número de lote"                        OF ::oDbfStock
