...
METHOD DefineFiles( cPath, cDriver, lUniqueName, cFileName ) CLASS TDetMovimientos
   ...
   DEFINE TABLE oDbf FILE ( cFileName ) CLASS "HisMov" ALIAS ( cFileName ) PATH ( cPath ) VIA ( cDriver )
      ...
      FIELD NAME "cLote"      TYPE "C" LEN  64 DEC 0 COMMENT "Lote"                                OF oDbf
   ...
   while .t.
      ...
      if nResult == IDOK
         ...
         if empty( ::oBrwPrp:Cargo )
            ...
            //if ::accumulatesStoreMovement() /************Quitado que acumule para TEFESA**************/
            //   ::oDbfVir:Cancel()
            //else 
               ::oDbfVir:Insert()
               ::appendKit()
      ...
      MENUITEM    "&1. Rotor"
         ...
         MENU
            ...
            MENUITEM    "&3. Informe de stock";
               ...
               RESOURCE "Info16";
               ACTION   ( InfStock( ::oRefMov:VarGet() ) );
...
METHOD AfterLoaArt() CLASS TDetMovimientos
   ...
   if aSeekProp( @cCodArt, @cValPr1, @cValPr2, ::oParent:oArt:cAlias, ::oParent:oTblPro:cAlias ) // ::oArt:Seek( xVal ) .OR. ::oArt:Seek( Upper( xVal ) )
      ...
      if ( lChgCodArt )
         ...
         /*if !empty( ::oGetStockOrigen )
            StocksModel():lPutStockActual( ::oDbfVir:cRefMov, ::oParent:oDbf:cAlmOrg, ::oDbfVir:cCodPr1, ::oDbfVir:cCodPr2, ::oDbfVir:cValPr1, ::oDbfVir:cValPr2, ::oDbfVir:cLote, ::oGetStockOrigen )
         end if*/

         /*if !empty( ::oGetStockDestino )
            StocksModel():lPutStockActual( ::oDbfVir:cRefMov, ::oParent:oDbf:cAlmDes, ::oDbfVir:cCodPr1, ::oDbfVir:cCodPr2, ::oDbfVir:cValPr1, ::oDbfVir:cValPr2, ::oDbfVir:cLote, ::oGetStockDestino )
         end if*/
...
METHOD getPrecioCosto() CLASS TDetMovimientos
   ...
   /*do case
      ...
      case uFieldEmpresa( "nCosVta" ) > 2
         ...
         nPrecioCosto      := MaterialesProducidosLineasModel():getCosto(  ::oDbfVir:cRefMov, ::oDbfVir:cCodPr1, ::oDbfVir:cCodPr2, ::oDbfVir:cValPr1, ::oDbfVir:cValPr2, ::oDbfVir:cLote )
