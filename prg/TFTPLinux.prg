...
CLASS TSFTPCurl FROM TFTPCurl
   
   METHOD testConexion()

   METHOD UrlAllEncode( cStr )
...
METHOD testConexion() CLASS TSFTPCurl
...
METHOD UrlAllEncode( cStr ) CLASS TSFTPCurl
...
METHOD createFile( cFile, cDirectory, lMessage ) CLASS TSFTPCurl
   ...
   if ::createConexion()
      ...
      cSftpURL := "sftp://" + UrlAllEncode( ::cUser ) + ":" + ;
                              UrlAllEncode( ::cPassword ) + "@" + ; 
                              ::cServer + Chr( 47 ) + ;
                              UrlAllEncode( cDirectory ) + ;
                              cFileNoPath( cFile )

      curl_easy_reset( ::idCurl )
      curl_easy_setopt( ::idCurl, HB_CURLOPT_UPLOAD, 1 )
      curl_easy_setopt( ::idCurl, HB_CURLOPT_APPEND, 1 )
      curl_easy_setopt( ::idCurl, HB_CURLOPT_URL, cSftpURL)
      curl_easy_setopt( ::idCurl, HB_CURLOPT_PROTOCOLS, HB_CURLPROTO_SFTP)
      curl_easy_setopt( ::idCurl, HB_CURLOPT_PORT, ::nPort)
      curl_easy_setopt( ::idCurl, HB_CURLOPT_VERBOSE, 1 )
      curl_easy_setopt( ::idCurl, HB_CURLOPT_FAILONERROR, 1 )
      curl_easy_setopt( ::idCurl, HB_CURLOPT_ERRORBUFFER, cErrorB )
      curl_easy_setopt( ::idCurl, HB_CURLOPT_FTP_CREATE_MISSING_DIRS, 1 )
      curl_easy_setopt( ::idCurl, HB_CURLOPT_UL_FILE_SETUP, cFile)
      curl_easy_setopt( ::idCurl, HB_CURLOPT_INFILESIZE_LARGE, FileSize( cFile ) )
