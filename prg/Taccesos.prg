...
CLASS TAcceso
   ...
   METHOD SelectComboBoxAt( nSel )        INLINE ( if( !empty( ::oComboBox ), ( ::oComboBox:Select( nSel ) ), ) )
...
CLASS UsuarioFavoritosModel FROM ADSBaseModel

   METHOD getTableName()                     INLINE ::getDatosTableName( "UsrBtnBar" )
   ...
   METHOD lExiste( cUsuarioUuid, cFavorito )

END CLASS

//---------------------------------------------------------------------------//

METHOD set( cUsuarioUuid, cFavorito, lVisible ) CLASS UsuarioFavoritosModel
...
METHOD lExiste( cUsuarioUuid, cFavorito ) CLASS UsuarioFavoritosModel
...
METHOD get( cUsuarioUuid, cFavorito ) CLASS UsuarioFavoritosModel
...
METHOD getVisible( cUsuarioUuid, cFavorito, lDefault ) CLASS UsuarioFavoritosModel
