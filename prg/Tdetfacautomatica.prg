...
METHOD SetDlgMode( aGet, nMode )
   ...
   */
   ...
   if ( Empty( ::oDbfVir:nPreUnit ) .or. ( RolesModel():getRolCambiarPrecios( Auth():rolUuid() ) ) ) .and. nMode != ZOOM_MODE
      ...
      MENUITEM    "&1. Rotor  "
         ...
         MENU
            ...
            MENUITEM    "&2. Informe de artículo";
               ...
               RESOURCE "Info16";
               ACTION   ( if( RolesModel():getRolNoVerPreciosCosto( Auth():rolUuid() ), msgStop( "No tiene permiso para ver los precios de costo" ), InfArticulo( cCodArt ) ) );

            MENUITEM    "&3. Informe de stock";
               MESSAGE  "Abrir el informe del stock" ;
               RESOURCE "Info16";
               ACTION   ( InfStock( cCodArt ) );
