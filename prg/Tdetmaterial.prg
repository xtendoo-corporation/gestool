...
Method ActualizaSqlStock( cNumDoc ) CLASS TDetMaterial
   ...
   if ::oParent:oDetMaterial:oDbf:Seek( cNumDoc )
      ...
      while ::oParent:oDetMaterial:oDbf:cSerOrd + Str( ::oParent:oDetMaterial:oDbf:nNumOrd ) + ::oParent:oDetMaterial:oDbf:cSufOrd == cNumDoc .and. ;
            !::oParent:oDetMaterial:oDbf:Eof()

         //::oParent:oSqlStock:restaStock( hStockBufferDetalleMaterial( ::oParent:oDetMaterial:oDbf ) )
...
Method RollBackSqlStock( cNumDoc ) CLASS TDetMaterial
   ...
   if ::oParent:oDetMaterial:oDbf:Seek( cNumDoc )
      ...
      while ::oParent:oDetMaterial:oDbf:cSerOrd + Str( ::oParent:oDetMaterial:oDbf:nNumOrd ) + ::oParent:oDetMaterial:oDbf:cSufOrd == cNumDoc .and. ;
         ...
         //::oParent:oSqlStock:restaRollBackStock( hStockBufferDetalleMaterial( ::oParent:oDetMaterial:oDbf ) )
