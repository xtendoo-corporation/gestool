...
Function BrwTemporada( oGet, oGet2, oBmpTemporada, lAdd )
   ...
   DEFINE DIALOG oDlg RESOURCE "HELPENTRY" TITLE getConfigTraslation( "Temporadas de artículos" )
      ...
      oBrw:CreateFromResource( 105 )
		...
		REDEFINE BUTTON ;
         ID       500 ;
         OF       oDlg ;
         WHEN     ( nAnd( nLevelUsr, ACC_APPD ) != 0 .and. !IsReport() .and. lAdd ) ;
         ACTION   ( WinAppRec( oBrw, bEdit, dbfTemporada ) )

		REDEFINE BUTTON ;
         ID       501 ;
         OF       oDlg ;
         WHEN     ( nAnd( nLevelUsr, ACC_EDIT ) != 0 .and. !IsReport() .and. lAdd ) ;
