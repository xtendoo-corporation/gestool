...
CLASS TFacturaElectronica
   ...
   DATA     nPorcentajeRetencion          INIT  0
   DATA     nImporteRetencion             INIT  0
   ...
   ACCESS   TotalExecutableAmountDtoEstatal     INLINE ( Alltrim( Trans( ::nTotalExecutableAmount - ::nDtoEstatal,       DoubleTwoDecimalPicture ) ) )
   ACCESS   TotalGeneralSurcharges              INLINE ( Alltrim( Trans( ::nTotalGeneralSurcharges,      DoubleTwoDecimalPicture ) ) )
   ACCESS   DtoEstatal                          INLINE ( Alltrim( Trans( ::nDtoEstatal,                  DoubleTwoDecimalPicture ) ) )
   ACCESS   PorcentajeRetencion                 INLINE ( Alltrim( Trans( ::nPorcentajeRetencion,         DoubleFourDecimalPicture ) ) )
   ACCESS   ImporteRetencion                    INLINE ( Alltrim( Trans( ::nImporteRetencion,            DoubleTwoDecimalPicture ) ) )
   ...
   DATA     dFechaInicioOperacion
   DATA     dFechaFinOperacion

   ACCESS   FechaInicioOperacion       INLINE ( if( !Empty( ::dFechaInicioOperacion ), dToIso( ::dFechaInicioOperacion ), ) )
   ACCESS   FechaFinOperacion          INLINE ( if( !Empty( ::dFechaFinOperacion ), dToIso( ::dFechaFinOperacion ), ) )
