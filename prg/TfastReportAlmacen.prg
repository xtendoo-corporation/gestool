...
CLASS TFastReportAlmacen FROM TFastreportTerceros

   DATA  cType                            INIT "Almacenes"
...
METHOD Create( uParam ) CLASS TFastReportAlmacen
...
METHOD lResource() CLASS TFastReportAlmacen
...
METHOD OpenFiles() CLASS TFastReportAlmacen
...
METHOD CloseFiles() CLASS TFastReportAlmacen
...
METHOD AddFieldCamposExtra() CLASS TFastReportAlmacen
   ...
   if isArray( ::aExtraFields ) .and. Len( ::aExtraFields ) != 0
      ...
      for each cField in ::aExtraFields
         ...
         ::AddField( "fld" + cField[ "código" ],;
                     ...
                     Capitalize( cField[ "descripciÃ³n" ] ) )
...
METHOD StartDialog() CLASS TFastReportAlmacen
...
METHOD BuildTree( oTree, lLoadFile ) CLASS TFastReportAlmacen
...
METHOD DataReport() CLASS TFastReportAlmacen
   ...
   */
   ...
   /*
   RelaciÃ³n con la tabla de direcciones en funcion del tipo de informe
   */
...
METHOD AddVariable() CLASS TFastReportAlmacen
...
METHOD lGenerate() CLASS TFastReportAlmacen
...
Method lValidRegister( cCodigoCliente ) CLASS TFastReportAlmacen
...
METHOD AddClientes() CLASS TFastReportAlmacen
...
METHOD loadValuesExtraFields() CLASS TFastReportAlmacen
