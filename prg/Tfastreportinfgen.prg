...
CLASS TFastReportInfGen FROM TNewInfGen
   ...
   DATA  lInformesPersonalizados                INIT .f.
   ...
   METHOD LoadInformesBasicos()
   METHOD LoadInformesPersonalizados()
   ...
   METHOD getDesdeAlmacen()                              INLINE   ( alltrim( ::oGrupoAlmacen:Cargo:getDesde() ) )
   METHOD getHastaAlmacen()                              INLINE   ( alltrim( ::oGrupoAlmacen:Cargo:getHasta() ) )
...
METHOD CreateTreeImageList()
   ...
   ::oTreeImageList:AddMasked( TBitmap():Define( "gc_folder_open_money_16"),           Rgb( 255, 0, 255 ) ) // 27 Entregas a cuenta
...
METHOD Renombrar() CLASS TFastReportInfGen
