...
METHOD AppPre( lAcumula )
   ...
   if !lAcumula
      ...
      ::AddArticulo( ::oPreCliL:cRef, ::oDbfArt, ::oPreCliL, .t. )
...
METHOD AcuTikCli( cCodArt, nPrecio )
   ...
   if ::oDbf:Seek( ::oTikCliT:cAlmTik )
      ...
      ::oDbf:nImpArt    += nImpUTpv( ::oTikCliT:cAlias, ::oTikCliL:cAlias, ::nDecOut, ::nValDiv, nil, nPrecio )
      ::oDbf:nImpTot    += nImpLTpv( ::oTikCliT:cAlias, ::oTikCliL:cAlias, ::nDecOut, ::nDerOut, ::nValDiv, nil, nPrecio )
      ::oDbf:nIvaTot    += nIvaLTpv( ::oTikCliT:cAlias, ::oTikCliL:cAlias, ::nDecOut, ::nDerOut, ::nValDiv, nPrecio )
      ::oDbf:nTotFin    += nImpLTpv( ::oTikCliT:cAlias, ::oTikCliL:cAlias, ::nDecOut, ::nDerOut, ::nValDiv, nil, nPrecio )
      ::oDbf:nTotFin    += nIvaLTpv( ::oTikCliT:cAlias, ::oTikCliL:cAlias, ::nDecOut, ::nDerOut, ::nValDiv, nPrecio )
      ::oDbf:nPreMed    := ::oDbf:nImpTot / ::oDbf:nNumUni
...
METHOD AddRAlb()
   ...
   */
   ...
   ::oDbf:cCodArt := ::oAlbCliL:cRef
   ::oDbf:cNomArt := RetArticulo( ::oAlbCliL:cRef, ::oDbfArt )
   ::oDbf:cCodPr1 := ::oAlbCliL:cCodPr1
   ::oDbf:cNomPr1 := retProp( ::oAlbCliL:cCodPr1 )
   ::oDbf:cCodPr2 := ::oAlbCliL:cCodPr2
   ::oDbf:cNomPr2 := retProp( ::oAlbCliL:cCodPr2 )
...
METHOD AddRFac()
   ...
   */
   ...
   ::oDbf:cCodArt    := ::oFacCliL:cRef
   ::oDbf:cNomArt    := RetArticulo( ::oFacCliL:cRef, ::oDbfArt )
   ::oDbf:cCodPr1    := ::oFacCliL:cCodPr1
   ::oDbf:cNomPr1    := retProp( ::oFacCliL:cCodPr1 )
   ::oDbf:cCodPr2    := ::oFacCliL:cCodPr2
   ::oDbf:cNomPr2    := retProp( ::oFacCliL:cCodPr2 )
...
METHOD AddRFacRec()
   ...
   */
   ...
   ::oDbf:cCodArt    := ::oFacRecL:cRef
   ::oDbf:cNomArt    := RetArticulo( ::oFacRecL:cRef, ::oDbfArt )
   ::oDbf:cCodPr1    := ::oFacRecL:cCodPr1
   ::oDbf:cNomPr1    := retProp( ::oFacRecL:cCodPr1 )
   ::oDbf:cCodPr2    := ::oFacRecL:cCodPr2
   ::oDbf:cNomPr2    := retProp( ::oFacRecL:cCodPr2 )
...
METHOD NewGroup( lDesPrp )
   ...
   if lDesPrp
      ::AddGroup( {|| ::oDbf:cCodAlm + ::oDbf:cCodArt + ::oDbf:cCodPr1 + ::oDbf:cCodPr2 + ::oDbf:cValPr1 + ::oDbf:cValPr2 + ::oDbf:cLote },;
