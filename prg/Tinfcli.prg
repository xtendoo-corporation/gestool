...
METHOD AddAlb( lAcumula )
   ...
   if !lAcumula .or. !::oDbf:Seek( ::oAlbCliT:cCodCli )
      ...
      ::oDbf:nPntVer    := 0 //nPntUAlbCli( ::oAlbCliL:cAlias, ::nDecOut, ::nValDiv )
...
METHOD NewGroup( lDesPrp )
   ...
   if lDesPrp
      ::AddGroup( {|| ::oDbf:cCodCli + ::oDbf:cCodArt + ::oDbf:cCodPr1 + ::oDbf:cCodPr2 + ::oDbf:cValPr1 + ::oDbf:cValPr2 + ::oDbf:cLote },;
