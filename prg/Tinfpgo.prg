...
METHOD AddPre( lAcumula )
   ...
   if !lAcumula .or. !::oDbf:Seek( ::oPreCliT:cCodPgo )
...
METHOD AddPed( lAcumula )
   ...
   if !lAcumula .or. !::oDbf:Seek( ::oPedCliT:cCodPgo )
...
METHOD AddAlb( lAcumula )
   ...
   if !lAcumula .or. !::oDbf:Seek( ::oAlbCliT:cCodPago )
...
METHOD AddFac( lAcumula )
   ...
   if !lAcumula .or. !::oDbf:Seek( ::oFacCliT:cCodPago )
...
METHOD AddFacRec( lAcumula )
   ...
   if !lAcumula .or. !::oDbf:Seek( ::oFacRecT:cCodPago )
...
METHOD AddTik( cCodArt, nPrecio, lAcumula )
   ...
   if !lAcumula .or. !::oDbf:Seek( ::oTikCliT:cFpgTik )

      ::oDbf:Append()

      ::oDbf:cCodPgo       := ::oTikCliT:cFpgTik
      ::oDbf:cNomPgo       := oRetFld( ::oTikCliT:cFpgTik, ::oDbfFpg )
...
METHOD NewGroup( lDesPrp )
   ...
   if lDesPrp
      ::AddGroup( {|| ::oDbf:cCodPgo + ::oDbf:cCodArt + ::oDbf:cCodPr1 + ::oDbf:cCodPr2 + ::oDbf:cValPr1 + ::oDbf:cValPr2 + ::oDbf:cLote },;
