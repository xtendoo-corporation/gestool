...
METHOD lCheckConditions() CLASS TPrepareDocument
...
METHOD New( nView ) CLASS TPrepareDocument
...
METHOD Dialog() CLASS TPrepareDocument
...
METHOD StartDialog() CLASS TPrepareDocument
...
METHOD loadInitData() CLASS TPrepareDocument
...
METHOD validCodigoBarras() CLASS TPrepareDocument
...
METHOD setHashCodeBar( hHas128 ) CLASS TPrepareDocument
...
METHOD resetCodeBar() CLASS TPrepareDocument
...
METHOD SetCodigoArticulo( cCodBar ) CLASS TPrepareDocument
...
METHOD end() CLASS TPrepareDocument
...
METHOD processCodeBar() CLASS TPrepareDocument
...
METHOD AddNewLine() CLASS TPrepareDocument
...
METHOD DelOriginalLine() CLASS TPrepareDocument
...
METHOD nPosScanOriginalLines() CLASS TPrepareDocument
...
METHOD nPosScanFinalLines() CLASS TPrepareDocument
...
METHOD setLinesToDocument() CLASS TPrepareDocument
...
METHOD setPreparated( lAbaranar ) CLASS TPrepareDocument
...
METHOD printLabel() CLASS TPrepareDocument
...
METHOD saveBultos() CLASS TPrepareDocument
...
METHOD Print() CLASS TPrepareDocument
...
METHOD Info( nView, oWndBrw ) CLASS TPrepareDocument
...
METHOD DialogInfo() CLASS TPrepareDocument
...
METHOD lPrepareInfo( oWndBrw ) CLASS TPrepareDocument
...
METHOD aAddInfoLines( aField ) CLASS TPrepareDocument
...
METHOD addStockInfo() CLASS TPrepareDocument
...
METHOD addProducir() CLASS TPrepareDocument
...
METHOD addStockReal() CLASS TPrepareDocument
...
CLASS TPrepareOrder FROM TPrepareDocument
...
METHOD New( nView ) CLASS TPrepareOrder
