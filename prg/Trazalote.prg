...
METHOD OpenFiles()
   ...
   BEGIN SEQUENCE
      ...
      DEFINE TABLE ::oDbfTmp FILE ( ::cFileTrazaLote ) CLASS ( ::cFileTrazaLote ) ALIAS ( ::cFileTrazaLote ) PATH ( cPatTmp() ) VIA ( cLocalDriver() )
         ...
         FIELD NAME "cLote"      TYPE "C" LEN  64 DEC 0 OF ::oDbfTmp  
         FIELD NAME "dFecCad"    TYPE "D" LEN   8 DEC 0 OF ::oDbfTmp
         FIELD NAME "cDirCli"    TYPE "C" LEN 150 DEC 0 OF ::oDbfTmp
         FIELD NAME "cPobCli"    TYPE "C" LEN 150 DEC 0 OF ::oDbfTmp
         FIELD NAME "cPrvCli"    TYPE "C" LEN 150 DEC 0 OF ::oDbfTmp
         FIELD NAME "cCPsCli"    TYPE "C" LEN 150 DEC 0 OF ::oDbfTmp
         FIELD NAME "cDniCli"    TYPE "C" LEN 150 DEC 0 OF ::oDbfTmp
         FIELD NAME "cTlfCli"    TYPE "C" LEN 150 DEC 0 OF ::oDbfTmp
