      ...
      */
      ...
      if ::oFacCliT:DFECFAC >= ::dIniInf                                                    .AND.;
         ...
         */
         ...
         ::oDbf:NTOTDEB := nTotFacCli( ::oFacCliT:CSERIE + Str( ::oFacCliT:NNUMFAC ) + ::oFacCliT:CSUFFAC, ::oFacCliT:cAlias, ::oFacCliL:cAlias, ::oDbfIva:cAlias, ::oDbfDiv:cAlias, ::oFacCliP:cAlias )
         ::oDbf:NTOTHAB := 0
