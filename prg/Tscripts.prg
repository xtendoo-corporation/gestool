...
CLASS TScripts FROM TMant
   ...
   METHOD   CompilarEjecutarNotMsgScript( cFilePrg )
...
METHOD CompilarEjecutarNotMsgScript( cFicheroPrg, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6, uParam7, uParam8, uParam9, uParam10 )
...
METHOD runAutoExecute() CLASS TScripts
