...
CLASS TShell FROM TMdiChild
   ...
   METHOD AddFilter()                        INLINE ( if(   !empty( ::oActiveFilter ),;
                                                            ( ::oActiveFilter:AddFilter(), ::EnableComboFilter( ::oActiveFilter:FiltersName() ), ::changeFilter( ::oActiveFilter:cExpresionFilter ) ), ) )
   ...
   METHOD aplyFilter()                       
   METHOD changeFilter( cFilter )            INLINE   ( ::setFilter( ::oActiveFilter:cExpresionFilter ), ::ShowDeleteButtonFilter(), ::oBrw:Refresh() )
...
METHOD compareOrden( cSortOrder, cOrdAlias ) CLASS TShell
