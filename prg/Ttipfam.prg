...
CLASS TTipFam FROM TInfGen
   ...
   DATA  aCmbAnio       AS ARRAY       INIT  { "Todos", "2000", "2001", "2002", "2003", "2004", "2005", "2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030" }
...
METHOD lGenerate()
   ...
   while !::lBreak .and. !::oDbfCli:Eof()
      ...
      /*
      Buscamos el cliente en las cabeceras de albaranes no facturados - si lo encontramos . . .
      */
      ...
      if ::oAlbCliT:Seek( ::oDbfCli:Cod )
         ...
         while ::oDbfCli:Cod == ::oAlbCliT:cCodCli .and. !::oAlbCliT:eof()
            ...
            */
            ...
            if ( ::lAllRut .or. ( ::oAlbCliT:cCodRut >= ::cRutOrg .and. ::oAlbCliT:cCodRut <= ::cRutDes ) ) .and.;
               ( ::lAllCli .or. ( ::oAlbCliT:cCodCli >= ::cCliOrg .and. ::oAlbCliT:cCodCli <= ::cCliDes ) ) .and.;
               lChkSer( ::oAlbCliT:cSerAlb, ::aSer )                                                        .and.;
               ::oAlbCliT:nFacturado < 3
      ...
      /*
      Buscamos el cliente en las cabeceras de facturas - si lo encontramos . . .
      */
