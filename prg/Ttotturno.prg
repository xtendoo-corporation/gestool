...
CLASS TTotalTurno
   ...
   DATA  aTotTikCliCobrosNotCaja AS ARRAY    INIT {}
   ...
   DATA  aTotCobrosNotCaja       AS ARRAY    INIT {}
   ...
   DATA  aDatTikCliCobrosNotCaja   AS ARRAY    INIT {}
   ...
   Method addTotTikCliCobrosNotCaja( cCaja, cSerie, nImporte, cData, bEdit )  INLINE   ::addImporte( cCaja, cSerie, nImporte, ::aTotTikCliCobrosNotCaja, cData, ::aDatTikCliCobrosNotCaja, bEdit, ::hBmpDoc[ "TiketCliente" ] )
   ...
   Method nTotTikCliCobrosNotCaja( cCaja, cSerie )             INLINE   nImporte( cCaja, cSerie, ::aTotTikCliCobrosNotCaja )
...
Method nTotCaja( cCaja, cSerie )
   ...
   if !::lArqueoCiego()
      ...
      nTotCaja       += ::nTotTikCliCobrosNotCaja()
...
Method CreateTree( cCaja, cTurno )
   ...
   */
   ...
   /*
   Pagos en tickets de otras cajas---------------------------------------------
   */

   if ::nTotTikCliCobrosNotCaja() != 0

      TreeAddItem( "Total tickets otra caja" ):Cargo := { "Cobros tickets otra caja", ::nTotTikCliCobrosNotCaja() }

      if !Empty( ::aDatTikCliCobrosNotCaja )
         TreeBegin()
         for each aItem in ::aDatTikCliCobrosNotCaja
            TreeAddItem( AllTrim( aItem[ 3 ] ), "Detalles", , , , .f. ):Cargo := { aItem[ 3 ], aItem[ 4 ], aItem[ 5 ], aItem[ 6 ] }
         next
         TreeEnd()
      end if
