...
CLASS TTurno FROM TMasDet
   ...
   METHOD nTotAlbaranCliente()  INLINE ( nTotAlbCli( ::oAlbCliT:cSerAlb + Str( ::oAlbCliT:nNumAlb ) + ::oAlbCliT:cSufAlb, ::oAlbCliT:cAlias, ::oAlbCliL:cAlias, ::oIvaImp:cAlias, ::oDbfDiv:cAlias(), nil, cDivEmp(), .f. ) )
   ...
   METHOD nTotFacturaCliente()  INLINE ( nTotFacCli( ::oFacCliT:cSerie + Str( ::oFacCliT:nNumFac ) + ::oFacCliT:cSufFac, ::oFacCliT:cAlias, ::oFacCliL:cAlias, ::oIvaImp:cAlias, ::oDbfDiv:cAlias, ::oFacCliP:cAlias, nil, cDivEmp(), .f. ) )
   METHOD nCntFacturaCliente()  INLINE ( nTotFacCli( ::oFacCliT:cSerie + Str( ::oFacCliT:nNumFac ) + ::oFacCliT:cSufFac, ::oFacCliT:cAlias, ::oFacCliL:cAlias, ::oIvaImp:cAlias, ::oDbfDiv:cAlias, ::oFacCliP:cAlias, nil, cDivEmp(), .f., .f. ) )
   ...
   METHOD SaveContadoresToArticulos()
...
METHOD DefineFiles( cPath, cDriver )
   ...
   */
   ...
   DEFINE DATABASE ::oDbfDet FILE "TURNOL.DBF" CLASS "TurnoL" ALIAS "TurnoL" PATH ( cPath ) VIA ( cDriver ) COMMENT  "Lineas de contadores en turnos de venta"
      ...
      INDEX TO "Turnol.Cdx" TAG "cNumTur" ON "cNumTur + cSufTur + cCodCaj" FOR "!Deleted()"                    OF ::oDbfDet
...
METHOD lArqueoTurno( lZoom, lParcial ) CLASS TTurno
   ...
   if ::lArqueoTactil()
      ...
      REDEFINE CHECKBOX ::oEnvioInformacion VAR ::lEnvioInformacion ;
         ID       700 ;
         WHEN     !::lArqueoParcial .and. ::lChangeCheckEnvio ;
         OF       ::oFldTurno:aDialogs[ 4 ]

      REDEFINE CHECKBOX ::oImprimirEnvio VAR ::lImprimirEnvio ;
         ID       710 ;
         WHEN     ::lEnvioInformacion .and. ::lChangeCheckEnvio ;
         OF       ::oFldTurno:aDialogs[ 4 ]
   ...
   if !::lZoom
      ...
      if ::oArticulo:Seek( 2 )
         while ::oArticulo:nCtlStock == 2 .and. !::oArticulo:Eof()
            ...
            //if ::oDbfDet:Seek( ::GetFullTurno() + ::oArticulo:Codigo, "cNumTur" )
   ...
   */
   ...
   if ::oTikT:Seek( cTurno + cCaja )
      ...
      while ::oTikT:cTurTik + ::oTikT:cSufTik + ::oTikT:cNcjTik == cTurno + cCaja .and.  !::oTikT:eof()
         ...
         if !::oTikT:lDelete  //descartamos los eliminados
...
METHOD TotCobro( cTurno, cCaja )
   ...
   */
   ...
   /*
   Cobros de tickets en otra caja-------------------------------------------------
   */
...
METHOD VariableReport( oFastReport )
   ...
   */
   ...
   oFastReport:AddVariable(     "Cobros sesión",   "Total cobros en otra caja",                      "GetHbVar('nTotTikCobrosNotCajas')" )
   ...
   if ::GetItemCheckState( "Tickets" )
      ...
      if ::oTikT:Seek( cTurnoCaja )
         ...
         while ::oTikT:cTurTik + ::oTikT:cSufTik + ::oTikT:cNcjTik == cTurnoCaja .and. !::oTikT:eof()
            ...
            if ::oTikT:cTipTik == SAVTIK .and. !::oTikT:lDelete
   ...
   if ::GetItemCheckState( "Devoluciones de clientes" )
      ...
      if ::oTikT:Seek( cTurnoCaja )
         ...
         while ::oTikT:cTurTik + ::oTikT:cSufTik + ::oTikT:cNcjTik == cTurnoCaja .and. !::oTikT:eof()
            ...
            if ::oTikT:cTipTik == SAVDEV .and. !::oTikT:lDelete
   ...
   if ::GetItemCheckState( "Vales a clientes" )
      ...
      if ::oTikT:Seek( cTurnoCaja )
         ...
         while ::oTikT:cTurTik + ::oTikT:cSufTik + ::oTikT:cNcjTik == cTurnoCaja .and. !::oTikT:eof()
            ...
            if ::oTikT:cTipTik == SAVVAL .and. !::oTikT:lDelete
...
CLASS TurnoLineasModel FROM ADSBaseModel

   METHOD getTableName()                     INLINE ::getEmpresaTableName( "TURNOL" )

   METHOD exist( cNumTur, cSufTur, cCodCaj, cCodArt )

END CLASS

//---------------------------------------------------------------------------//

METHOD exist( cNumTur, cSufTur, cCodCaj, cCodArt ) CLASS TurnoLineasModel

   local cStm
   local cSql  := "SELECT * "                                     + ;
                     "FROM " + ::getTableName() + " "             + ;
                     "WHERE CNUMTUR = '" + cNumTur          + "'" + ;
                     " AND CSUFTUR = "  + quoted( cSufTur )       + ;
                     " AND CCODCAJ = "  + quoted( cCodCaj )       + ;
                     " AND CCODART = "  + quoted( cCodArt )
