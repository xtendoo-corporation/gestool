...
CLASS TComercioConfig
   ...
   METHOD getFromCurrentWebServices( key, default )
   METHOD getFromCurrentSourceWebServices( cSource, key, default )
...
METHOD getFromCurrentWebServices( key, default ) CLASS TComercioConfig
...
METHOD getFromCurrentSourceWebServices( cSource, key, default ) CLASS TComercioConfig
