...
CLASS TPrestaShopId FROM TMant
   ...
   METHOD setValueFeature( cClave, cWeb, idWeb )                              INLINE ::setValue( "17", cClave, cWeb, idWeb )
   METHOD getValueFeature( cClave, cWeb, defaultValue )                       INLINE ::getValue( "17", cClave, cWeb, defaultValue )

   METHOD setValueFeatureValue( cClave, cWeb, idWeb )                         INLINE ::setValue( "18", cClave, cWeb, idWeb )
   METHOD getValueFeatureValue( cClave, cWeb, defaultValue )                  INLINE ::getValue( "18", cClave, cWeb, defaultValue )
