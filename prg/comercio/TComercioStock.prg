...
METHOD addStockProductToUpdate( hProduct ) 
   ...
   for each hStock in aStockArticulo
      ...
      if ( hGet( hStock, "articulo" ) == idProduct )                                                           .and.;
         ( empty( idFirstProperty )       .or. ( hGet( hStock, "propiedad1" ) == idFirstProperty ) )   .and.;
         ( empty( valueFirstProperty )    .or. ( hGet( hStock, "valor1" ) == valueFirstProperty ) ) .and.;
         ( empty( idSecondProperty )      .or. ( hGet( hStock, "propiedad2" ) == idSecondProperty ) )  .and.;
         ( empty( valueSecondProperty )   .or. ( hGet( hStock, "valor2" ) == valueSecondProperty ) )

         // if hGet( hStock, "unidades" ) > 0
            ...
            if ( !empty( hGet( hStock, "valor1" ) ) .or. !empty( hGet( hStock, "valor2" ) ) )
               ...
               aadd( aStockProducts,   {  "idProduct"             => idProduct,;
                                          ...
                                          "idFirstProperty"       => hGet( hStock, "propiedad1" ),;
                                          "idSecondProperty"      => hGet( hStock, "propiedad2" ),;
                                          "valueFirstProperty"    => hGet( hStock, "valor1" ),;
                                          "valueSecondProperty"   => hGet( hStock, "valor2" ),;
