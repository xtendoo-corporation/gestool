...
CLASS MovimientosAlmacenLineasController FROM SQLBrowseController
   ...
   METHOD stampPrecioVenta()           INLINE ( ::oDialogView:oGetPrecioVenta:cText( hget( ::hArticulo, "pvtaiva1" ) ) )

   METHOD stampTipoIva()               INLINE ( ::oDialogView:oGetTipoIva:cText( nIva( , hget( ::hArticulo, "tipoiva" ) ) ) )
