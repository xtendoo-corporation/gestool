...
METHOD Activate() CLASS TransportistasView
   ...
   REDEFINE GET   ::oController:oModel:hBuffer[ "tara" ] ;
      ID          130 ;
   ...
   REDEFINE GET   ::oController:oModel:hBuffer[ "remolque" ] ;
      ID          150 ;
      WHEN        ( ::oController:isNotZoomMode() ) ;
      OF          ::oDialog
...
CLASS SQLTransportistasModel FROM SQLCompanyModel
   ...
   MESSAGE getDniWhereCodigo( codigo )       INLINE ( ::getField( "dni", "codigo", codigo ) )

   MESSAGE getUuidWhereCodigo( codigo )      INLINE ( ::getField( "uuid", "codigo", codigo ) )
...
METHOD getColumns() CLASS SQLTransportistasModel
   ...
   hset( ::hColumns, "tara",              {  "create"    => "DECIMAL(19,6)"                           ,;
                                             "default"   => {|| 0 } }                                 )

   hset( ::hColumns, "matricula",         {  "create"    => "VARCHAR( 150 )"                          ,;
                                             "default"   => {|| space( 150 ) } }                      )

   hset( ::hColumns, "remolque",          {  "create"    => "VARCHAR( 150 )"                          ,;
                                             "default"   => {|| space( 150 ) } }                      )
...
METHOD SeederToADS() CLASS SQLTransportistasModel
