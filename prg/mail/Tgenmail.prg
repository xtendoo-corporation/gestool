...
CLASS TGenMailing 
   ...
   METHOD setIncidenciaWorkArea( cWorkArea ) INLINE ( ::cIncidenciaWorkArea := cWorkArea )
   METHOD getIncidenciaWorkArea()            INLINE ( ::cIncidenciaWorkArea )
   ...
   METHOD CreateIndicencia()              VIRTUAL
