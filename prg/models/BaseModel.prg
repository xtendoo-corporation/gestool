...
CLASS ADSBaseModel
   ...
   METHOD getEmpresaTableNameFromEmpresa( cTableName, cCodEmpresa ) INLINE ( "Emp" + if( Empty( cCodEmpresa ), cCodEmp(), allTrim( cCodEmpresa ) ) + if( empty(cTableName), ::cTableName, cTableName ) )
