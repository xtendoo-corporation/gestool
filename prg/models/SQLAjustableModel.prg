...
CLASS SQLAjustableModel FROM SQLBaseModel
   ...
   METHOD setRolCobrarEnTactil( uAjusteValue, cAjustableUuid )          INLINE ( ::setLogic( 'cobrar_en_tactil', uAjusteValue, 'roles', cAjustableUuid ) )
   ...
   METHOD getRolCobrarEnTactil( cUuid )                                 INLINE ( ::getLogic( cUuid, 'roles', 'cobrar_en_tactil', .t. ) )   
