...
CLASS DeliveryNoteCustomer FROM DocumentsSales  
   ...
   METHOD genInvoiceCustomer()

   METHOD runScriptPreSaveAppend()

   METHOD getSqlSentenceAlbaranesClientes()

   METHOD runScriptPreDelete()
...
METHOD setViewSearchNavigator() CLASS DeliveryNoteCustomer
...
METHOD getSqlSentenceAlbaranesClientes() CLASS DeliveryNoteCustomer
...
METHOD insertLineDocument( oLine ) CLASS DeliveryNoteCustomer
...
METHOD getLastLineNumber() CLASS DeliveryNoteCustomer
...
METHOD genInvoiceCustomer() CLASS DeliveryNoteCustomer
...
METHOD runScriptPreSaveAppend() CLASS DeliveryNoteCustomer
...
METHOD runScriptPreDelete() CLASS DeliveryNoteCustomer
...
METHOD actualizaStock() CLASS DeliveryNoteCustomer

Return ( .t. )

//---------------------------------------------------------------------------//

METHOD rollBackStock() CLASS DeliveryNoteCustomer
