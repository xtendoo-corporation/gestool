...
CLASS DocumentsSales FROM Documents
   ...
   METHOD getSqlSentenceAlbaranesClientes()                 INLINE ( D():getSqlSentenceAlbaranesClientes() )
   ...
   METHOD getNumeroDocumento()                              INLINE ( ::getSerie() + alltrim( ::getStrNumero() ) + ::getSufijo() )
   ...
   METHOD deleteLinesCero()                                 VIRTUAL

   METHOD runGridSignature()

   METHOD setViewSearchNavigator()

   METHOD rollBackStock()                                   INLINE ( .t. )

   METHOD actualizaStock()                                  INLINE ( .t. )
...
METHOD setViewSearchNavigator() CLASS DocumentsSales
...
METHOD runGridSignature() CLASS DocumentsSales
