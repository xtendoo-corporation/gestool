...
CLASS LinesDocumentsSales FROM Editable
   ...
   METHOD setCodigoCliente( cCodigoCliente )                INLINE ( ::hSetDetail( "Cliente", cCodigoCliente ) )
   ...
   METHOD setAgenteFromMaster()
   METHOD setCodigoCliente( cCodigoCliente )                INLINE ( ::hSetDetail( "Cliente", cCodigoCliente ) )
   METHOD setComisionFromMaster()
   ...
   METHOD runGridStore()
   METHOD runGridLote()
   METHOD runGridImpuesto()

   METHOD setCodeBar( cCode )
   METHOD cargaArticulo()
   METHOD cargaAlmacen()
   METHOD cargaLote()
   METHOD cargaImpuesto()
...
METHOD setLineFromArticulo() CLASS LinesDocumentsSales
   ...
   if ( D():Articulos( ::getView() ) )->lLote
      ...
      /*::setFechaCaducidad( StocksModel():getFechaCaducidad( ::hGetDetail( "Articulo" ),;
                                                ::hGetDetail( "CodigoPropiedad1" ),;
                                                ::hGetDetail( "CodigoPropiedad2" ),;
...
METHOD setStockArticulo() 
   ...
   */
   ...
   ::oViewEditDetail:nGetStock   := StocksModel():nStockArticulo(  ::hGetDetail( "Articulo" ),;
                                                                     ::hGetDetail( "Almacen" ),;
                                                                     ::hGetDetail( "CodigoPropiedad1" ),;
                                                                     ::hGetDetail( "CodigoPropiedad2" ),;
                                                                     ::hGetDetail( "ValorPropiedad1" ),;
...
METHOD setCodeBar( cCode ) CLASS LinesDocumentsSales

   //if !isNil( cCode )
   //   MsgInfo( cCode, "SetCodeBar" )
   //end if
...
METHOD cargaImpuesto() CLASS LinesDocumentsSales
...
METHOD runGridImpuesto CLASS LinesDocumentsSales
...
METHOD setAgenteFromMaster() CLASS LinesDocumentsSales
...
METHOD setComisionFromMaster() CLASS LinesDocumentsSales
...
METHOD lValidPrecio( oPrecio ) CLASS LinesDocumentsSales
