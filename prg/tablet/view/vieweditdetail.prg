...
METHOD defineArticulo() CLASS ViewDetail
   ...
   ::oGetArticulo             := TGridGet():Build( {  "nRow"      => ::getRow(),;
                                                      ...
                                                      "bSetGet"   => {|u| ::oSender:setCodeBar( u ), ::SetGetValue( u, "Articulo" ) },;
                                                      "oWnd"      => ::oDlg,;
...
METHOD defineIva() CLASS ViewDetail
   ...
   TGridUrllink():Build(                           {  "nTop"      => ::getRow(),;
                                                      ...
                                                      "nClrOver"  => nGridColor(),;
                                                      "nClrVisit" => nGridColor(),;
                                                      "bAction"   => {|| ::oSender:runGridImpuesto() } } )

   ::oGetIva                  := TGridGet():Build( {  "nRow"      => ::getRow(),;
                                                      "nCol"      => {|| GridWidth( 2.5, ::oDlg ) },;
                                                      "bSetGet"   => {|u| ::SetGetValue( u, "PorcentajeImpuesto" ) },;
                                                      "oWnd"      => ::oDlg,;
                                                      "nWidth"    => {|| GridWidth( 3, ::oDlg ) },;
                                                      "nHeight"   => 23,;
                                                      "lPixels"   => .t.,;
                                                      "bValid"    => {|| ::oSender:CargaImpuesto() } } )
...
METHOD definePrecio() CLASS ViewDetail
   ...
   ::oGetPrecio   := TGridGet():Build( {  "nRow"      => ::getRow(),;
                                          ...
                                          "bValid"    => {|| if( ::oSender:lValidPrecio( ::oGetPrecio ), ::oSender:recalcularTotal(), .f. ) } } )
