...
CREATE CLASS TVF_Cabecera FROM TVF_Tags
...
METHOD New( oVerifactu, lRequired, cTag, oFather ) CLASS TVF_Cabecera
...
METHOD Init() CLASS TVF_Cabecera
...
METHOD BuildXml( oFather ) CLASS TVF_Cabecera
    ...
    If ::ObligadoEmision:HasData() .Or.;
       ...
       ::RemisionRequerimiento:HasData()
        ...
        oChild := oFather:NewChild( 'sumLR:' + ::__cTag,"")
...
METHOD Check() CLASS TVF_Cabecera
...
METHOD HasData() CLASS TVF_Cabecera
