...
CREATE CLASS TVF_ContraparteConsultaType FROM TVF_Tags
    ...
    EXPORTED:
        ...
        DATA __cTag      AS STRING  INIT 'ContraparteConsulta'
...
METHOD New( oVerifactu, lRequired, cTag, oFather ) CLASS TVF_ContraparteConsultaType
...
METHOD Init() CLASS TVF_ContraparteConsultaType
...
METHOD BuildXml( oFather ) CLASS TVF_ContraparteConsultaType
...
METHOD Check() CLASS TVF_ContraparteConsultaType
    ...
    If nChoices > 1
        ...
        ::__oVerifactu:__oReturn:Log := 'ContraparteConsultaType solo puede tener un dato de los siguientes elementos: NIF,IDOtro, ahora tiene ' + cChoicesActuales
...
METHOD HasData() CLASS TVF_ContraparteConsultaType
