...
CREATE CLASS TVF_IDFacturaARType FROM TVF_Tags
    ...
    EXPORTED:
        ...
        DATA __cTag      AS STRING  INIT 'IDFacturaAR'
...
METHOD New( oVerifactu, lRequired, cTag, oFather ) CLASS TVF_IDFacturaARType
...
METHOD Init() CLASS TVF_IDFacturaARType
...
METHOD BuildXml( oFather ) CLASS TVF_IDFacturaARType
...
METHOD Check() CLASS TVF_IDFacturaARType
...
METHOD HasData() CLASS TVF_IDFacturaARType
