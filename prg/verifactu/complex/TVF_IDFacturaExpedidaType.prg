...
CREATE CLASS TVF_IDFacturaExpedidaType FROM TVF_Tags
    ...
    EXPORTED:
        ...
        DATA __cTag      AS STRING  INIT 'IDFacturaExpedida'
...
METHOD New( oVerifactu, lRequired, cTag, oFather ) CLASS TVF_IDFacturaExpedidaType
...
METHOD Init() CLASS TVF_IDFacturaExpedidaType
...
METHOD BuildXml( oFather ) CLASS TVF_IDFacturaExpedidaType
...
METHOD Check() CLASS TVF_IDFacturaExpedidaType
...
METHOD HasData() CLASS TVF_IDFacturaExpedidaType
