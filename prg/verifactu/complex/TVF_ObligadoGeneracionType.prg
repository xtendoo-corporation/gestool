...
CREATE CLASS TVF_ObligadoGeneracionType FROM TVF_Tags
    ...
    EXPORTED:
        ...
        DATA __cTag      AS STRING  INIT 'ObligadoGeneracion'
...
METHOD New( oVerifactu, lRequired, cTag, oFather ) CLASS TVF_ObligadoGeneracionType
...
METHOD Init() CLASS TVF_ObligadoGeneracionType
...
METHOD BuildXml( oFather ) CLASS TVF_ObligadoGeneracionType
...
METHOD Check() CLASS TVF_ObligadoGeneracionType
...
METHOD HasData() CLASS TVF_ObligadoGeneracionType
