...
CREATE CLASS TVF_PersonaFisicaJuridicaESType FROM TVF_Tags
    ...
    EXPORTED:
        ...
        DATA __cTag      AS STRING  INIT 'PersonaFisicaJuridicaES'
...
METHOD New( oVerifactu, lRequired, cTag, oFather ) CLASS TVF_PersonaFisicaJuridicaESType
...
METHOD Init() CLASS TVF_PersonaFisicaJuridicaESType
...
METHOD BuildXml( oFather ) CLASS TVF_PersonaFisicaJuridicaESType
...
METHOD Check() CLASS TVF_PersonaFisicaJuridicaESType
...
METHOD HasData() CLASS TVF_PersonaFisicaJuridicaESType
