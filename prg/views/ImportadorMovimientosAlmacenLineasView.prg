...
CLASS ImportadorMovimientosAlmacenLineasView FROM SQLBaseView 
   ...
   DATA lStockConsolidacion         INIT .f.
...
METHOD Activate()
   ...
   DEFINE DIALOG oDialog RESOURCE "Importar_Almacen" 
      ...
      REDEFINE CHECKBOX ::lStockConsolidacion ;
         ID       390 ;
         OF       oDialog ;
      ...
      ::oMtrStock:nClrText             := rgb( 128,255,0 )
      ::oMtrStock:nClrBar              := rgb( 128,255,0 )
      ::oMtrStock:nClrBText            := rgb( 128,255,0 )
