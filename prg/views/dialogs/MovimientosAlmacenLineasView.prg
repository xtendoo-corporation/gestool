...
CLASS MovimientosAlmacenLineasView FROM SQLBaseView
   ...
   METHOD nTotalImporteVentaArticulo()
...
METHOD Activate()
   ...
   DEFINE DIALOG     ::oDialog ;
      ...
      REDEFINE GET   ::oGetTipoIva ;
         VAR         ::oController:oModel:hBuffer[ "tipo_iva" ] ;
         ID          240 ;
         IDSAY       241 ;
         WHEN        ( .f. ) ;
         PICTURE     "@E 999.99" ;
      ...
      REDEFINE GET   ::oGetPrecioVenta ;
         VAR         ::oController:oModel:hBuffer[ "precio_venta" ] ;
         ID          220 ;
         IDSAY       221 ;
         SPINNER ;
         WHEN        ( ::oController:isNotZoomMode() ) ;
      ...
      REDEFINE SAY   ::oSayTotalVenta ;
         PROMPT      ::nTotalImporteVentaArticulo() ;
         ID          230 ;
         FONT        getBoldFont() ;
         PICTURE     cPirDiv() ;
         OF          ::oDialog
      ...
      MENUITEM    "&1. Rotor"
         ...
         MENU
            ...
            MENUITEM    "&4. Informe de stock";
               ...
               RESOURCE "Info16";
               ACTION   ( InfStock( ::oController:oModel:hBuffer[ "codigo_articulo" ] ) );
